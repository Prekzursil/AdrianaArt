...
/** Golden WU header-toggle-storefront-edit-mode -- toggleStorefrontEditMode. */
describe('HeaderComponent toggleStorefrontEditMode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleStorefrontEditMode(); }).not.toThrow();
  });
});
