...
/** Golden WU header-on-theme-change -- onThemeChange. */
describe('HeaderComponent onThemeChange (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onThemeChange('system' as any)).not.toThrow();
  });
});
