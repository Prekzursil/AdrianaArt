...
/** Golden WU footer-cmp-to-footer-pages -- toFooterPages. */
describe('FooterComponent toFooterPages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toFooterPages(undefined as any, undefined as any); }).not.toThrow();
  });
});
