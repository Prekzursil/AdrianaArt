...
/** Golden WU admin-orders-list-order-tag-stats -- listOrderTagStats. */
describe('AdminOrdersService listOrderTagStats (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listOrderTagStats(); }).not.toThrow();
  });
});
