...
/** Golden WU seo-copy-fallback-blog-list-intro -- blogListIntro. */
describe('SeoCopyFallbackService blogListIntro (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(SeoCopyFallbackService.prototype) as SeoCopyFallbackService;
    ...
    expect(() => { (cmp as any).blogListIntro(undefined as any, undefined as any, undefined as any); }).not.toThrow();
  });
});
