...
/** Golden WU ops-svc-get-webhook-failure-stats -- getWebhookFailureStats. */
describe('OpsService getWebhookFailureStats (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getWebhookFailureStats(0); }).not.toThrow();
  });
});
