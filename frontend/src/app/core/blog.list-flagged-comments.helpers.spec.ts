...
/** Golden WU blog-list-flagged-comments -- listFlaggedComments. */
describe('BlogService listFlaggedComments (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listFlaggedComments(0); }).not.toThrow();
  });
});
