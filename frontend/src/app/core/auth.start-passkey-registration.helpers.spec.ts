...
/** Golden WU auth-start-passkey-registration -- startPasskeyRegistration. */
describe('AuthService startPasskeyRegistration (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startPasskeyRegistration(''); }).not.toThrow();
  });
});
