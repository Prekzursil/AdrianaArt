...
/** Golden WU admin-orders-update-addresses -- updateAddresses. */
describe('AdminOrdersService updateAddresses (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateAddresses('', undefined as any, false); }).not.toThrow();
  });
});
