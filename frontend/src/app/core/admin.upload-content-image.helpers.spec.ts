...
/** Golden WU admin-upload-content-image -- uploadContentImage. */
describe('AdminService uploadContentImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadContentImage('', undefined as any, ''); }).not.toThrow();
  });
});
