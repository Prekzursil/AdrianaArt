...
/** Golden WU ops-svc-get-webhook-detail -- getWebhookDetail. */
describe('OpsService getWebhookDetail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getWebhookDetail(undefined as any, ''); }).not.toThrow();
  });
});
