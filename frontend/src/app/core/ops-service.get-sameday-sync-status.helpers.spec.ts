...
/** Golden WU ops-service-get-sameday-sync-status -- getSamedaySyncStatus. */
describe('OpsService getSamedaySyncStatus (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.getSamedaySyncStatus(); }).not.toThrow();
  });
});
