...
/** Golden WU admin-upsert-product-image-translation -- upsertProductImageTranslation. */
describe('AdminService upsertProductImageTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminService.prototype) as AdminService;
    ...
    expect(() => { (cmp as any).upsertProductImageTranslation('', '', undefined as any, undefined as any, undefined as any); }).not.toThrow();
  });
});
