...
/** Golden WU admin-delete-category -- deleteCategory. */
describe('AdminService deleteCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteCategory('', undefined as any); }).not.toThrow();
  });
});
