...
/** Golden WU admin-shipping-performance -- shippingPerformance. */
describe('AdminService shippingPerformance (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingPerformance(0); }).not.toThrow();
  });
});
