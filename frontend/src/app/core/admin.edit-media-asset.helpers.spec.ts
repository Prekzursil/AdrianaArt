...
/** Golden WU admin-edit-media-asset -- editMediaAsset. */
describe('AdminService editMediaAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).editMediaAsset('', undefined as any); }).not.toThrow();
  });
});
