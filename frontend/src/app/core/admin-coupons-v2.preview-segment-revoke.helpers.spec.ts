...
/** Golden WU admin-coupons-v2-preview-segment-revoke -- previewSegmentRevoke. */
describe('AdminCouponsV2Service previewSegmentRevoke (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).previewSegmentRevoke('', undefined as any); }).not.toThrow();
  });
});
