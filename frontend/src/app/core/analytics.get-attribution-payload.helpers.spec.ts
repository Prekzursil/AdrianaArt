...
/** Golden WU analytics-get-attribution-payload -- getAttributionPayload. */
describe('AnalyticsService getAttributionPayload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getAttributionPayload(); }).not.toThrow();
  });
});
