...
/** Golden WU admin-get-alert-thresholds -- getAlertThresholds. */
describe('AdminService getAlertThresholds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getAlertThresholds(); }).not.toThrow();
  });
});
