...
/** Golden WU admin-orders-list-document-exports -- listDocumentExports. */
describe('AdminOrdersService listDocumentExports (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listDocumentExports(0); }).not.toThrow();
  });
});
