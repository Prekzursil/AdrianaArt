...
/** Golden WU admin-create-category -- createCategory. */
describe('AdminService createCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createCategory(undefined as any, undefined as any); }).not.toThrow();
  });
});
