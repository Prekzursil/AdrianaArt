...
/** Golden WU ops-download-newsletter-confirmed-subscribers-export -- downloadNewsletterConfirmedSubscribersExport. */
describe('OpsService downloadNewsletterConfirmedSubscribersExport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).downloadNewsletterConfirmedSubscribersExport(); }).not.toThrow();
  });
});
