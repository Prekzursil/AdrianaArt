...
/** Golden WU admin-get-media-retry-policy-presets -- getMediaRetryPolicyPresets. */
describe('AdminService getMediaRetryPolicyPresets (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getMediaRetryPolicyPresets(undefined as any); }).not.toThrow();
  });
});
