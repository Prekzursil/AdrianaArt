...
/** Golden WU admin-coupons-v2-list-assignments -- listAssignments. */
describe('AdminCouponsV2Service listAssignments (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listAssignments(''); }).not.toThrow();
  });
});
