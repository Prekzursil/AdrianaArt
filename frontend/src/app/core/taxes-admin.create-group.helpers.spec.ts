...
/** Golden WU taxes-admin-create-group -- createGroup. */
describe('TaxesAdminService createGroup (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createGroup(undefined as any); }).not.toThrow();
  });
});
