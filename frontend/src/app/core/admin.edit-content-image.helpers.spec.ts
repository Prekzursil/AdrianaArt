...
/** Golden WU admin-edit-content-image -- editContentImage. */
describe('AdminService editContentImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).editContentImage('', undefined as any); }).not.toThrow();
  });
});
