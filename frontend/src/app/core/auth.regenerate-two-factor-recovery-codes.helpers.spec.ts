...
/** Golden WU auth-regenerate-two-factor-recovery-codes -- regenerateTwoFactorRecoveryCodes. */
describe('AuthService regenerateTwoFactorRecoveryCodes (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).regenerateTwoFactorRecoveryCodes('', ''); }).not.toThrow();
  });
});
