...
/** Golden WU admin-update-content-image -- updateContentImage. */
describe('AdminService updateContentImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateContentImage('', undefined as any); }).not.toThrow();
  });
});
