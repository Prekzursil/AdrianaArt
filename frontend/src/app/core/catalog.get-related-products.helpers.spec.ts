...
/** Golden WU catalog-get-related-products -- getRelatedProducts. */
describe('CatalogService getRelatedProducts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getRelatedProducts('', undefined as any); }).not.toThrow();
  });
});
