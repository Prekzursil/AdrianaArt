...
/** Golden WU catalog-list-categories -- listCategories. */
describe('CatalogService listCategories (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listCategories(undefined as any, false); }).not.toThrow();
  });
});
