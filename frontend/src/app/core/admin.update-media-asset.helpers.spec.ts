...
/** Golden WU admin-update-media-asset -- updateMediaAsset. */
describe('AdminService updateMediaAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateMediaAsset('', undefined as any); }).not.toThrow();
  });
});
