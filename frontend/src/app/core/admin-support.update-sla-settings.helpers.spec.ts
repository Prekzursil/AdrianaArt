...
/** Golden WU admin-support-update-sla-settings -- updateSlaSettings. */
describe('AdminSupportService updateSlaSettings (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateSlaSettings(undefined as any); }).not.toThrow();
  });
});
