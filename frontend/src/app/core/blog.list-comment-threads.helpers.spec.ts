...
/** Golden WU blog-list-comment-threads -- listCommentThreads. */
describe('BlogService listCommentThreads (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listCommentThreads('', 0); }).not.toThrow();
  });
});
