...
/** Golden WU admin-list-content-redirects -- listContentRedirects. */
describe('AdminService listContentRedirects (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listContentRedirects(''); }).not.toThrow();
  });
});
