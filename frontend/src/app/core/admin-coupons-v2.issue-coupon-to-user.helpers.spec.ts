...
/** Golden WU admin-coupons-v2-issue-coupon-to-user -- issueCouponToUser. */
describe('AdminCouponsV2Service issueCouponToUser (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).issueCouponToUser(undefined as any); }).not.toThrow();
  });
});
