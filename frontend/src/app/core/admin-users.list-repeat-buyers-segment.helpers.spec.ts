...
/** Golden WU admin-users-list-repeat-buyers-segment -- listRepeatBuyersSegment. */
describe('AdminUsersService listRepeatBuyersSegment (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listRepeatBuyersSegment(''); }).not.toThrow();
  });
});
