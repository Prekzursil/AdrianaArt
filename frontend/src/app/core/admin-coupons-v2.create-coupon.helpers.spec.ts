...
/** Golden WU admin-coupons-v2-create-coupon -- createCoupon. */
describe('AdminCouponsV2Service createCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createCoupon(undefined as any); }).not.toThrow();
  });
});
