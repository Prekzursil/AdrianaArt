...
/** Golden WU blog-set-comment-subscription -- setCommentSubscription. */
describe('BlogService setCommentSubscription (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setCommentSubscription('', false); }).not.toThrow();
  });
});
