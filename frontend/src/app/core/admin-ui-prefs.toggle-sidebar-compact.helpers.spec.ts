...
/** Golden WU admin-ui-prefs-toggle-sidebar-compact -- toggleSidebarCompact. */
describe('AdminUiPrefsService toggleSidebarCompact (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminUiPrefsService.prototype) as AdminUiPrefsService;
    ...
    expect(() => { (cmp as any).toggleSidebarCompact(); }).not.toThrow();
  });
});
