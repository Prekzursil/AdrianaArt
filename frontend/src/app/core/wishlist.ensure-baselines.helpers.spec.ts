...
/** Golden WU wishlist-ensure-baselines -- ensureBaselines. */
describe('WishlistService ensureBaselines (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).ensureBaselines(undefined as any); }).not.toThrow();
  });
});
