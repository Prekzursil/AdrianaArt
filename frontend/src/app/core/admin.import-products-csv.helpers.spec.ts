...
/** Golden WU admin-import-products-csv -- importProductsCsv. */
describe('AdminService importProductsCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).importProductsCsv(undefined as any, undefined as any); }).not.toThrow();
  });
});
