...
/** Golden WU admin-update-content-image-tags -- updateContentImageTags. */
describe('AdminService updateContentImageTags (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateContentImageTags('', ''); }).not.toThrow();
  });
});
