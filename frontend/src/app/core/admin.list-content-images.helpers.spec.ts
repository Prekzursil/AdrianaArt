...
/** Golden WU admin-list-content-images -- listContentImages. */
describe('AdminService listContentImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listContentImages(undefined as any); }).not.toThrow();
  });
});
