...
/** Golden WU admin-coupons-v2-start-segment-assign-job -- startSegmentAssignJob. */
describe('AdminCouponsV2Service startSegmentAssignJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startSegmentAssignJob('', undefined as any); }).not.toThrow();
  });
});
