...
/** Golden WU admin-coupons-v2-list-all-bulk-jobs -- listAllBulkJobs. */
describe('AdminCouponsV2Service listAllBulkJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listAllBulkJobs(0); }).not.toThrow();
  });
});
