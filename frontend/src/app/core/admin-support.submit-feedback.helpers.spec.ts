...
/** Golden WU admin-support-submit-feedback -- submitFeedback. */
describe('AdminSupportService submitFeedback (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitFeedback(undefined as any); }).not.toThrow();
  });
});
