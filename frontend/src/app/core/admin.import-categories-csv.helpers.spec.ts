...
/** Golden WU admin-import-categories-csv -- importCategoriesCsv. */
describe('AdminService importCategoriesCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).importCategoriesCsv(undefined as any, undefined as any); }).not.toThrow();
  });
});
