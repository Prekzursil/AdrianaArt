...
/** Golden WU admin-coupons-v2-bulk-revoke-coupon -- bulkRevokeCoupon. */
describe('AdminCouponsV2Service bulkRevokeCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bulkRevokeCoupon('', undefined as any); }).not.toThrow();
  });
});
