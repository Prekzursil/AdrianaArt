...
/** Golden WU admin-create-media-collection -- createMediaCollection. */
describe('AdminService createMediaCollection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createMediaCollection(''); }).not.toThrow();
  });
});
