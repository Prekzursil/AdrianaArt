...
/** Golden WU admin-coupons-v2-revoke-coupon -- revokeCoupon. */
describe('AdminCouponsV2Service revokeCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).revokeCoupon('', undefined as any); }).not.toThrow();
  });
});
