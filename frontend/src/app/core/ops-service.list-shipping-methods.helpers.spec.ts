...
/** Golden WU ops-service-list-shipping-methods -- listShippingMethods. */
describe('OpsService listShippingMethods (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.listShippingMethods(); }).not.toThrow();
  });
});
