...
/** Golden WU admin-coupons-v2-generate-coupon-code -- generateCouponCode. */
describe('AdminCouponsV2Service generateCouponCode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).generateCouponCode(undefined as any); }).not.toThrow();
  });
});
