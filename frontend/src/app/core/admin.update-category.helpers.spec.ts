...
/** Golden WU admin-update-category -- updateCategory. */
describe('AdminService updateCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateCategory('', undefined as any, undefined as any); }).not.toThrow();
  });
});
