...
/** Golden WU admin-coupons-v2-svc-update-promotion -- updatePromotion. */
describe('AdminCouponsV2Service updatePromotion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updatePromotion('', undefined as any); }).not.toThrow();
  });
});
