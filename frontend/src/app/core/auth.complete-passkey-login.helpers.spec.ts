...
/** Golden WU auth-complete-passkey-login -- completePasskeyLogin. */
describe('AuthService completePasskeyLogin (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).completePasskeyLogin('', undefined as any, false); }).not.toThrow();
  });
});
