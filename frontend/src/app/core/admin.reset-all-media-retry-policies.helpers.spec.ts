...
/** Golden WU admin-reset-all-media-retry-policies -- resetAllMediaRetryPolicies. */
describe('AdminService resetAllMediaRetryPolicies (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetAllMediaRetryPolicies(); }).not.toThrow();
  });
});
