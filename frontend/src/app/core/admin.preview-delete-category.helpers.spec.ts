...
/** Golden WU admin-preview-delete-category -- previewDeleteCategory. */
describe('AdminService previewDeleteCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).previewDeleteCategory(''); }).not.toThrow();
  });
});
