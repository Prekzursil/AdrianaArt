...
/** Golden WU admin-returns-svc-list-by-order -- listByOrder. */
describe('AdminReturnsService listByOrder (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listByOrder('', false); }).not.toThrow();
  });
});
