...
/** Golden WU admin-coupons-v2-create-promotion -- createPromotion. */
describe('AdminCouponsV2Service createPromotion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createPromotion(undefined as any); }).not.toThrow();
  });
});
