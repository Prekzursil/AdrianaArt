...
/** Golden WU admin-support-delete-canned-response -- deleteCannedResponse. */
describe('AdminSupportService deleteCannedResponse (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteCannedResponse(''); }).not.toThrow();
  });
});
