...
/** Golden WU admin-update-product-relationships -- updateProductRelationships. */
describe('AdminService updateProductRelationships (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateProductRelationships('', undefined as any); }).not.toThrow();
  });
});
