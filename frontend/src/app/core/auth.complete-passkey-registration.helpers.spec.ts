...
/** Golden WU auth-complete-passkey-registration -- completePasskeyRegistration. */
describe('AuthService completePasskeyRegistration (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AuthService.prototype) as AuthService;
    ...
    expect(() => { (cmp as any).completePasskeyRegistration('', undefined as any, undefined as any); }).not.toThrow();
  });
});
