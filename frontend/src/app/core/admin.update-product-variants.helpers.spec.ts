...
/** Golden WU admin-update-product-variants -- updateProductVariants. */
describe('AdminService updateProductVariants (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateProductVariants('', undefined as any); }).not.toThrow();
  });
});
