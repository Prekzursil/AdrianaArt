...
/** Golden WU admin-import-content-redirects -- importContentRedirects. */
describe('AdminService importContentRedirects (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).importContentRedirects(undefined as any); }).not.toThrow();
  });
});
