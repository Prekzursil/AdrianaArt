...
/** Golden WU admin-get-content-image-usage -- getContentImageUsage. */
describe('AdminService getContentImageUsage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getContentImageUsage(''); }).not.toThrow();
  });
});
