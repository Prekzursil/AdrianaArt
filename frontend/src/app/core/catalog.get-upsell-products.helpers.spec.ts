...
/** Golden WU catalog-get-upsell-products -- getUpsellProducts. */
describe('CatalogService getUpsellProducts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getUpsellProducts('', undefined as any); }).not.toThrow();
  });
});
