...
/** Golden WU admin-upload-category-image -- uploadCategoryImage. */
describe('AdminService uploadCategoryImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadCategoryImage('', undefined as any, undefined as any, undefined as any); }).not.toThrow();
  });
});
