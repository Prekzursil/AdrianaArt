...
/** Golden WU admin-list-media-retry-policy-history -- listMediaRetryPolicyHistory. */
describe('AdminService listMediaRetryPolicyHistory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listMediaRetryPolicyHistory(0); }).not.toThrow();
  });
});
