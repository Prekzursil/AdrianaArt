...
/** Golden WU blog-hide-comment-admin -- hideCommentAdmin. */
describe('BlogService hideCommentAdmin (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).hideCommentAdmin('', undefined as any); }).not.toThrow();
  });
});
