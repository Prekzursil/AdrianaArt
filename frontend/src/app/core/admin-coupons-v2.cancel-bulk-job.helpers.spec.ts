...
/** Golden WU admin-coupons-v2-cancel-bulk-job -- cancelBulkJob. */
describe('AdminCouponsV2Service cancelBulkJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelBulkJob(''); }).not.toThrow();
  });
});
