...
/** Golden WU admin-coupons-v2-list-promotions -- listPromotions. */
describe('AdminCouponsV2Service listPromotions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listPromotions(); }).not.toThrow();
  });
});
