...
/** Golden WU admin-orders-upload-shipping-label -- uploadShippingLabel. */
describe('AdminOrdersService uploadShippingLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadShippingLabel('', undefined as any, false); }).not.toThrow();
  });
});
