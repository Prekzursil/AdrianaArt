...
/** Golden WU account-create-address -- createAddress. */
describe('AccountService createAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createAddress(undefined as any); }).not.toThrow();
  });
});
