...
/** Golden WU admin-coupons-v2-list-bulk-jobs -- listBulkJobs. */
describe('AdminCouponsV2Service listBulkJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listBulkJobs('', 0); }).not.toThrow();
  });
});
