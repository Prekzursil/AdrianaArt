...
/** Golden WU admin-favorites-save -- save. */
describe('AdminFavoritesService save (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminFavoritesService.prototype) as AdminFavoritesService;
    ...
    expect(() => { (cmp as any).save(undefined as any, undefined as any); }).not.toThrow();
  });
});
