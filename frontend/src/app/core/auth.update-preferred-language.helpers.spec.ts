...
/** Golden WU auth-update-preferred-language -- updatePreferredLanguage. */
describe('AuthService updatePreferredLanguage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updatePreferredLanguage(''); }).not.toThrow();
  });
});
