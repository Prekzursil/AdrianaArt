...
/** Golden WU admin-upload-media-asset -- uploadMediaAsset. */
describe('AdminService uploadMediaAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadMediaAsset(undefined as any, false); }).not.toThrow();
  });
});
