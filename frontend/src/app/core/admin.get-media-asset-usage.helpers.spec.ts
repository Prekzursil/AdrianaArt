...
/** Golden WU admin-get-media-asset-usage -- getMediaAssetUsage. */
describe('AdminService getMediaAssetUsage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getMediaAssetUsage(''); }).not.toThrow();
  });
});
