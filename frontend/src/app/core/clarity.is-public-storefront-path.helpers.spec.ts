...
/** Golden WU clarity-is-public-storefront-path -- isPublicStorefrontPath. */
describe('ClarityService isPublicStorefrontPath (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).isPublicStorefrontPath(''); }).not.toThrow();
  });
});
