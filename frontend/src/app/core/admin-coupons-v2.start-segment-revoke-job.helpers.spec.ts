...
/** Golden WU admin-coupons-v2-start-segment-revoke-job -- startSegmentRevokeJob. */
describe('AdminCouponsV2Service startSegmentRevokeJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminCouponsV2Service.prototype) as AdminCouponsV2Service;
    ...
    expect(() => { (cmp as any).startSegmentRevokeJob('', undefined as any); }).not.toThrow();
  });
});
