...
/** Golden WU account-update-address -- updateAddress. */
describe('AccountService updateAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateAddress('', undefined as any); }).not.toThrow();
  });
});
