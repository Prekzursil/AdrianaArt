...
/** Golden WU admin-coupons-v2-get-analytics -- getAnalytics. */
describe('AdminCouponsV2Service getAnalytics (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getAnalytics(undefined as any); }).not.toThrow();
  });
});
