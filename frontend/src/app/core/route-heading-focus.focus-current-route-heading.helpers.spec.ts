...
/** Golden WU route-heading-focus-focus-current-route-heading -- focusCurrentRouteHeading. */
describe('RouteHeadingFocusService focusCurrentRouteHeading (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).focusCurrentRouteHeading(undefined as any); }).not.toThrow();
  });
});
