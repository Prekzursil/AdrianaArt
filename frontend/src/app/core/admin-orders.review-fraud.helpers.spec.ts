...
/** Golden WU admin-orders-review-fraud -- reviewFraud. */
describe('AdminOrdersService reviewFraud (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).reviewFraud('', undefined as any, false); }).not.toThrow();
  });
});
