...
/** Golden WU ops-service-download-newsletter-confirmed-subscribers-export -- downloadNewsletterConfirmedSubscribersExport. */
describe('OpsService downloadNewsletterConfirmedSubscribersExport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(OpsService.prototype) as OpsService;
    ...
    expect(() => { cmp.downloadNewsletterConfirmedSubscribersExport(); }).not.toThrow();
  });
});
