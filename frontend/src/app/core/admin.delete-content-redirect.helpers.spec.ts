...
/** Golden WU admin-delete-content-redirect -- deleteContentRedirect. */
describe('AdminService deleteContentRedirect (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteContentRedirect(''); }).not.toThrow();
  });
});
