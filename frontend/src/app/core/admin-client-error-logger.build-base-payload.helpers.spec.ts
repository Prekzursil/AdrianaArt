...
/** Golden WU admin-client-error-logger-build-base-payload -- buildBasePayload. */
describe('AdminClientErrorLoggerService buildBasePayload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminClientErrorLoggerService.prototype) as AdminClientErrorLoggerService;
    ...
    expect(() => { (cmp as any).buildBasePayload(undefined as any, '', undefined as any, undefined as any); }).not.toThrow();
  });
});
