...
/** Golden WU account-create-return-request -- createReturnRequest. */
describe('AccountService createReturnRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createReturnRequest(undefined as any); }).not.toThrow();
  });
});
