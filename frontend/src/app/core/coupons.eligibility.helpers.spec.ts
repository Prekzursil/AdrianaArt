...
/** Golden WU coupons-eligibility -- eligibility. */
describe('CouponsService eligibility (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(CouponsService.prototype) as CouponsService;
    ...
    expect(() => { (cmp as any).eligibility(undefined as any); }).not.toThrow();
  });
});
