...
/** Golden WU admin-coupons-v2-assign-coupon -- assignCoupon. */
describe('AdminCouponsV2Service assignCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).assignCoupon('', undefined as any); }).not.toThrow();
  });
});
