...
/** Golden WU admin-channel-attribution -- channelAttribution. */
describe('AdminService channelAttribution (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).channelAttribution(''); }).not.toThrow();
  });
});
