...
/** Golden WU admin-update-content-image-focal-point -- updateContentImageFocalPoint. */
describe('AdminService updateContentImageFocalPoint (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateContentImageFocalPoint('', 0, 0); }).not.toThrow();
  });
});
