...
/** Golden WU toast-push -- push. */
describe('ToastService push (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ToastService.prototype) as ToastService;
    ...
    expect(() => { (cmp as any).push(undefined as any, undefined as any); }).not.toThrow();
  });
});
