...
/** Golden WU api-post-blob -- postBlob. */
describe('ApiService postBlob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ApiService.prototype) as ApiService;
    ...
    expect(() => { (cmp as any).postBlob('', undefined as any, undefined as any, ''); }).not.toThrow();
  });
});
