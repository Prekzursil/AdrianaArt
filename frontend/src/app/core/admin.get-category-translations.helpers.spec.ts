...
/** Golden WU admin-get-category-translations -- getCategoryTranslations. */
describe('AdminService getCategoryTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getCategoryTranslations(''); }).not.toThrow();
  });
});
