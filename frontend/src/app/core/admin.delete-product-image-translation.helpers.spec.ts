...
/** Golden WU admin-delete-product-image-translation -- deleteProductImageTranslation. */
describe('AdminService deleteProductImageTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteProductImageTranslation('', '', undefined as any, undefined as any); }).not.toThrow();
  });
});
