...
/** Golden WU auth-bootstrap-impersonation -- bootstrapImpersonation. */
describe('AuthService bootstrapImpersonation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bootstrapImpersonation(); }).not.toThrow();
  });
});
