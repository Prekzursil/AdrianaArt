...
/** Golden WU admin-delete-category-translation -- deleteCategoryTranslation. */
describe('AdminService deleteCategoryTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteCategoryTranslation('', undefined as any, undefined as any); }).not.toThrow();
  });
});
