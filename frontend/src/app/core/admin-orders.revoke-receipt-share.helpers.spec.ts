...
/** Golden WU admin-orders-revoke-receipt-share -- revokeReceiptShare. */
describe('AdminOrdersService revokeReceiptShare (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).revokeReceiptShare(''); }).not.toThrow();
  });
});
