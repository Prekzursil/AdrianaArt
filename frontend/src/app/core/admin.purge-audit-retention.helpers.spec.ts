...
/** Golden WU admin-purge-audit-retention -- purgeAuditRetention. */
describe('AdminService purgeAuditRetention (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).purgeAuditRetention(''); }).not.toThrow();
  });
});
