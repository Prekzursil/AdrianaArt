...
/** Golden WU admin-orders-create-shipment -- createShipment. */
describe('AdminOrdersService createShipment (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).createShipment('', undefined as any, false); }).not.toThrow();
  });
});
