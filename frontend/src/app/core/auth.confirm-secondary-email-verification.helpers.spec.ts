...
/** Golden WU auth-confirm-secondary-email-verification -- confirmSecondaryEmailVerification. */
describe('AuthService confirmSecondaryEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).confirmSecondaryEmailVerification(''); }).not.toThrow();
  });
});
