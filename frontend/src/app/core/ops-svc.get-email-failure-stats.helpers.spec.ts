...
/** Golden WU ops-svc-get-email-failure-stats -- getEmailFailureStats. */
describe('OpsService getEmailFailureStats (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getEmailFailureStats(0); }).not.toThrow();
  });
});
