...
/** Golden WU admin-validate-structured-data -- validateStructuredData. */
describe('AdminService validateStructuredData (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).validateStructuredData(); }).not.toThrow();
  });
});
