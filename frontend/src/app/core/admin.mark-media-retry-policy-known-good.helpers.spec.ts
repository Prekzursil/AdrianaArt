...
/** Golden WU admin-mark-media-retry-policy-known-good -- markMediaRetryPolicyKnownGood. */
describe('AdminService markMediaRetryPolicyKnownGood (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).markMediaRetryPolicyKnownGood(undefined as any, ''); }).not.toThrow();
  });
});
