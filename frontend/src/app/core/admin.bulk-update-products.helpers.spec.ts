...
/** Golden WU admin-bulk-update-products -- bulkUpdateProducts. */
describe('AdminService bulkUpdateProducts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bulkUpdateProducts(undefined as any, undefined as any); }).not.toThrow();
  });
});
