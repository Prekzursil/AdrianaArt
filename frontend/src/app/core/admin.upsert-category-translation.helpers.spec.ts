...
/** Golden WU admin-upsert-category-translation -- upsertCategoryTranslation. */
describe('AdminService upsertCategoryTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).upsertCategoryTranslation('', undefined as any, undefined as any, undefined as any); }).not.toThrow();
  });
});
