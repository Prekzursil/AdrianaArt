...
/** Golden WU admin-list-stock-adjustments -- listStockAdjustments. */
describe('AdminService listStockAdjustments (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listStockAdjustments(''); }).not.toThrow();
  });
});
