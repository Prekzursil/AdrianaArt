...
/** Golden WU auth-clear-impersonation -- clearImpersonation. */
describe('AuthService clearImpersonation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).clearImpersonation(); }).not.toThrow();
  });
});
