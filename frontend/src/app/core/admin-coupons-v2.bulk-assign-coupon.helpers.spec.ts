...
/** Golden WU admin-coupons-v2-bulk-assign-coupon -- bulkAssignCoupon. */
describe('AdminCouponsV2Service bulkAssignCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bulkAssignCoupon('', ''); }).not.toThrow();
  });
});
