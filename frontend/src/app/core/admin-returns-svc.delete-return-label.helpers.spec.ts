...
/** Golden WU admin-returns-svc-delete-return-label -- deleteReturnLabel. */
describe('AdminReturnsService deleteReturnLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteReturnLabel(''); }).not.toThrow();
  });
});
