...
/** Golden WU admin-coupons-v2-preview-segment-assign -- previewSegmentAssign. */
describe('AdminCouponsV2Service previewSegmentAssign (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).previewSegmentAssign('', undefined as any); }).not.toThrow();
  });
});
