...
/** Golden WU admin-support-get-sla-settings -- getSlaSettings. */
describe('AdminSupportService getSlaSettings (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getSlaSettings(); }).not.toThrow();
  });
});
