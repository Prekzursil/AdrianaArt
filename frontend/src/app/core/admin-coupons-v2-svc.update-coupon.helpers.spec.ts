...
/** Golden WU admin-coupons-v2-svc-update-coupon -- updateCoupon. */
describe('AdminCouponsV2Service updateCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateCoupon('', undefined as any); }).not.toThrow();
  });
});
