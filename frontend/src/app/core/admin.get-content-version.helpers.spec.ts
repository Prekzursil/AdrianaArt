...
/** Golden WU admin-get-content-version -- getContentVersion. */
describe('AdminService getContentVersion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getContentVersion('', 0); }).not.toThrow();
  });
});
