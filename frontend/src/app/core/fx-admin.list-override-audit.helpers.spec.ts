...
/** Golden WU fx-admin-list-override-audit -- listOverrideAudit. */
describe('FxAdminService listOverrideAudit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).listOverrideAudit(undefined as any); }).not.toThrow();
  });
});
