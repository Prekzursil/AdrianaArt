...
/** Golden WU auth-update-notification-preferences -- updateNotificationPreferences. */
describe('AuthService updateNotificationPreferences (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateNotificationPreferences(undefined as any); }).not.toThrow();
  });
});
