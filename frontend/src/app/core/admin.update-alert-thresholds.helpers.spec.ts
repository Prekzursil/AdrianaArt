...
/** Golden WU admin-update-alert-thresholds -- updateAlertThresholds. */
describe('AdminService updateAlertThresholds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateAlertThresholds(undefined as any); }).not.toThrow();
  });
});
