...
/** Golden WU admin-update-media-job-triage -- updateMediaJobTriage. */
describe('AdminService updateMediaJobTriage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateMediaJobTriage('', undefined as any); }).not.toThrow();
  });
});
