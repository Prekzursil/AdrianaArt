...
/** Golden WU admin-update-content-translation-status -- updateContentTranslationStatus. */
describe('AdminService updateContentTranslationStatus (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateContentTranslationStatus('', undefined as any); }).not.toThrow();
  });
});
