...
/** Golden WU admin-rollback-media-retry-policy -- rollbackMediaRetryPolicy. */
describe('AdminService rollbackMediaRetryPolicy (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).rollbackMediaRetryPolicy(undefined as any, undefined as any); }).not.toThrow();
  });
});
