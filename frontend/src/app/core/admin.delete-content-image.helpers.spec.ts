...
/** Golden WU admin-delete-content-image -- deleteContentImage. */
describe('AdminService deleteContentImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteContentImage('', false); }).not.toThrow();
  });
});
