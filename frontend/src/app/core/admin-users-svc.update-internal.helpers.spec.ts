...
/** Golden WU admin-users-svc-update-internal -- updateInternal. */
describe('AdminUsersService updateInternal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateInternal('', undefined as any); }).not.toThrow();
  });
});
