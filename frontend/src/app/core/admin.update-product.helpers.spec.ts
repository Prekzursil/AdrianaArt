...
/** Golden WU admin-update-product -- updateProduct. */
describe('AdminService updateProduct (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateProduct('', undefined as any, undefined as any); }).not.toThrow();
  });
});
