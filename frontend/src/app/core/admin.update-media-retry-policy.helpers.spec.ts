...
/** Golden WU admin-update-media-retry-policy -- updateMediaRetryPolicy. */
describe('AdminService updateMediaRetryPolicy (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateMediaRetryPolicy(undefined as any, undefined as any); }).not.toThrow();
  });
});
