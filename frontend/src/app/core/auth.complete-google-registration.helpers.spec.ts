...
/** Golden WU auth-complete-google-registration -- completeGoogleRegistration. */
describe('AuthService completeGoogleRegistration (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).completeGoogleRegistration('', undefined as any); }).not.toThrow();
  });
});
