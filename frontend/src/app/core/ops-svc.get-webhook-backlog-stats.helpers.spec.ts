...
/** Golden WU ops-svc-get-webhook-backlog-stats -- getWebhookBacklogStats. */
describe('OpsService getWebhookBacklogStats (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getWebhookBacklogStats(0); }).not.toThrow();
  });
});
