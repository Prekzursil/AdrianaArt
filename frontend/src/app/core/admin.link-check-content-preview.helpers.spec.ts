...
/** Golden WU admin-link-check-content-preview -- linkCheckContentPreview. */
describe('AdminService linkCheckContentPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).linkCheckContentPreview(undefined as any); }).not.toThrow();
  });
});
