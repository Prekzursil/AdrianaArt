...
/** Golden WU newsletter-confirm-ng-on-init -- ngOnInit. */
describe('NewsletterConfirmComponent ngOnInit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(NewsletterConfirmComponent.prototype) as NewsletterConfirmComponent;
