...
/** Golden WU change-password-on-submit -- onSubmit. */
describe('ChangePasswordComponent onSubmit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ChangePasswordComponent.prototype) as ChangePasswordComponent;
    ...
    expect(() => (cmp as any).onSubmit({ valid: false, value: {} } as any)).not.toThrow();
  });
});
