...
/** Golden WU account-copy-two-factor-secret -- copyTwoFactorSecret. */
describe('AccountState copyTwoFactorSecret (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).copyTwoFactorSecret(); }).not.toThrow();
  });
});
