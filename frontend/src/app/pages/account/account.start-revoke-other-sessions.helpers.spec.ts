...
/** Golden WU account-start-revoke-other-sessions -- startRevokeOtherSessions. */
describe('AccountState startRevokeOtherSessions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startRevokeOtherSessions(); }).not.toThrow();
  });
});
