...
/** Golden WU account-state-confirm-secondary-email-verification -- confirmSecondaryEmailVerification. */
describe('AccountState confirmSecondaryEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.confirmSecondaryEmailVerification(); }).not.toThrow();
  });
});
