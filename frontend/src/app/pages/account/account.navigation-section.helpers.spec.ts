...
/** Golden WU account-navigation-section -- navigationSection. */
describe('AccountState navigationSection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).navigationSection(); }).not.toThrow();
  });
});
