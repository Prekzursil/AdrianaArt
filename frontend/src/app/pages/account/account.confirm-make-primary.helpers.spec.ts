...
/** Golden WU account-confirm-make-primary -- confirmMakePrimary. */
describe('AccountState confirmMakePrimary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).confirmMakePrimary(); }).not.toThrow();
  });
});
