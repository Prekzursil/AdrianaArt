...
/** Golden WU account-start-delete-secondary-email -- startDeleteSecondaryEmail. */
describe('AccountState startDeleteSecondaryEmail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startDeleteSecondaryEmail(''); }).not.toThrow();
  });
});
