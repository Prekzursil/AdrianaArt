...
/** Golden WU account-discard-notification-changes -- discardNotificationChanges. */
describe('AccountState discardNotificationChanges (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).discardNotificationChanges(); }).not.toThrow();
  });
});
