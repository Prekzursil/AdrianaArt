...
/** Golden WU account-same-notification-snapshot -- sameNotificationSnapshot. */
describe('AccountState sameNotificationSnapshot (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).sameNotificationSnapshot(undefined as any, undefined as any); }).not.toThrow();
  });
});
