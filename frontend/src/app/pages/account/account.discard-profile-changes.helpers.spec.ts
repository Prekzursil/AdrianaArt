...
/** Golden WU account-discard-profile-changes -- discardProfileChanges. */
describe('AccountState discardProfileChanges (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).discardProfileChanges(); }).not.toThrow();
  });
});
