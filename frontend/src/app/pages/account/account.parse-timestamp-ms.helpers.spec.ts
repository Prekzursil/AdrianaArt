...
/** Golden WU account-parse-timestamp-ms -- parseTimestampMs. */
describe('AccountState parseTimestampMs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseTimestampMs(undefined as any); }).not.toThrow();
  });
});
