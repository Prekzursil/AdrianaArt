...
/** Golden WU account-close-return-request -- closeReturnRequest. */
describe('AccountState closeReturnRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).closeReturnRequest(); }).not.toThrow();
  });
});
