...
/** Golden WU account-phone-national-preview -- phoneNationalPreview. */
describe('AccountState phoneNationalPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).phoneNationalPreview(); }).not.toThrow();
  });
});
