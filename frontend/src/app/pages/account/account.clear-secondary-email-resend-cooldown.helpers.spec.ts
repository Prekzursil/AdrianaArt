...
/** Golden WU account-clear-secondary-email-resend-cooldown -- clearSecondaryEmailResendCooldown. */
describe('AccountState clearSecondaryEmailResendCooldown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).clearSecondaryEmailResendCooldown(''); }).not.toThrow();
  });
});
