...
/** Golden WU account-confirm-revoke-other-sessions -- confirmRevokeOtherSessions. */
describe('AccountState confirmRevokeOtherSessions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).confirmRevokeOtherSessions(); }).not.toThrow();
  });
});
