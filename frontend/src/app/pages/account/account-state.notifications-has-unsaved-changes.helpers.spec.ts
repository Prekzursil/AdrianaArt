...
/** Golden WU account-state-notifications-has-unsaved-changes -- notificationsHasUnsavedChanges. */
describe('AccountState notificationsHasUnsavedChanges (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.notificationsHasUnsavedChanges(); }).not.toThrow();
  });
});
