...
/** Golden WU account-update-order-in-list -- updateOrderInList. */
describe('AccountState updateOrderInList (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateOrderInList(undefined as any); }).not.toThrow();
  });
});
