...
/** Golden WU account-prev-my-comments-page -- prevMyCommentsPage. */
describe('AccountState prevMyCommentsPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).prevMyCommentsPage(); }).not.toThrow();
  });
});
