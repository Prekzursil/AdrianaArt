...
/** Golden WU account-set-default-shipping -- setDefaultShipping. */
describe('AccountState setDefaultShipping (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setDefaultShipping(undefined as any); }).not.toThrow();
  });
});
