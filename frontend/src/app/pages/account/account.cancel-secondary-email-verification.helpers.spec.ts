...
/** Golden WU account-cancel-secondary-email-verification -- cancelSecondaryEmailVerification. */
describe('AccountState cancelSecondaryEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelSecondaryEmailVerification(); }).not.toThrow();
  });
});
