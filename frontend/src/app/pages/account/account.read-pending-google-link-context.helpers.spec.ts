...
/** Golden WU account-read-pending-google-link-context -- readPendingGoogleLinkContext. */
describe('AccountState readPendingGoogleLinkContext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).readPendingGoogleLinkContext(); }).not.toThrow();
  });
});
