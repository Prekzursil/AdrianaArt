...
/** Golden WU account-clear-pending-google-link-context -- clearPendingGoogleLinkContext. */
describe('AccountState clearPendingGoogleLinkContext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).clearPendingGoogleLinkContext(); }).not.toThrow();
  });
});
