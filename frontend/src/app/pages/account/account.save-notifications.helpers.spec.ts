...
/** Golden WU account-save-notifications -- saveNotifications. */
describe('AccountState saveNotifications (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveNotifications(); }).not.toThrow();
  });
});
