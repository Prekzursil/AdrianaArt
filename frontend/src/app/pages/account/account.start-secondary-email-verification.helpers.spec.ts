...
/** Golden WU account-start-secondary-email-verification -- startSecondaryEmailVerification. */
describe('AccountState startSecondaryEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startSecondaryEmailVerification(''); }).not.toThrow();
  });
});
