...
/** Golden WU account-notifications-inbox-restore -- restore. */
describe('AccountNotificationsInboxComponent restore (golden WU)', () => {
...
http: { get: jasmine.createSpy('hg'), post: jasmine.createSpy('hp') },
    ...
    expect(() => (cmp as any).restore(null as any)).not.toThrow();
  });
});
