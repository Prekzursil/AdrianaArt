...
/** Golden WU account-open-address-form -- openAddressForm. */
describe('AccountState openAddressForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openAddressForm(undefined as any); }).not.toThrow();
  });
});
