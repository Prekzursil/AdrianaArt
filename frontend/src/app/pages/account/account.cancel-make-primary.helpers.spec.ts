...
/** Golden WU account-cancel-make-primary -- cancelMakePrimary. */
describe('AccountState cancelMakePrimary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelMakePrimary(); }).not.toThrow();
  });
});
