...
/** Golden WU account-copy-two-factor-setup-url -- copyTwoFactorSetupUrl. */
describe('AccountState copyTwoFactorSetupUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).copyTwoFactorSetupUrl(); }).not.toThrow();
  });
});
