...
/** Golden WU account-public-identity-preview-label -- publicIdentityPreviewLabel. */
describe('AccountState publicIdentityPreviewLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).publicIdentityPreviewLabel(); }).not.toThrow();
  });
});
