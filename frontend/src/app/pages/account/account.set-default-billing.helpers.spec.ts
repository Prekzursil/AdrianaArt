...
/** Golden WU account-set-default-billing -- setDefaultBilling. */
describe('AccountState setDefaultBilling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setDefaultBilling(undefined as any); }).not.toThrow();
  });
});
