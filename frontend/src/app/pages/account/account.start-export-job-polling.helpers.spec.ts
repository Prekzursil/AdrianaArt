...
/** Golden WU account-start-export-job-polling -- startExportJobPolling. */
describe('AccountState startExportJobPolling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startExportJobPolling(''); }).not.toThrow();
  });
});
