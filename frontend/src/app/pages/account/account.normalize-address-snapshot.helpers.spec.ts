...
/** Golden WU account-normalize-address-snapshot -- normalizeAddressSnapshot. */
describe('AccountState normalizeAddressSnapshot (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).normalizeAddressSnapshot(undefined as any); }).not.toThrow();
  });
});
