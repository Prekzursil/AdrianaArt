...
/** Golden WU account-state-primary-verification-resend-remaining-seconds -- primaryVerificationResendRemainingSeconds. */
describe('AccountState primaryVerificationResendRemainingSeconds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.primaryVerificationResendRemainingSeconds(); }).not.toThrow();
  });
});
