...
/** Golden WU account-submit-return-request -- submitReturnRequest. */
describe('AccountState submitReturnRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitReturnRequest(undefined as any); }).not.toThrow();
  });
});
