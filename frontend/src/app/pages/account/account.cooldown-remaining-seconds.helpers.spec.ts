...
/** Golden WU account-cooldown-remaining-seconds -- cooldownRemainingSeconds. */
describe('AccountState cooldownRemainingSeconds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cooldownRemainingSeconds(undefined as any); }).not.toThrow();
  });
});
