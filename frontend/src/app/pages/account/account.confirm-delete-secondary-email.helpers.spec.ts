...
/** Golden WU account-confirm-delete-secondary-email -- confirmDeleteSecondaryEmail. */
describe('AccountState confirmDeleteSecondaryEmail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).confirmDeleteSecondaryEmail(); }).not.toThrow();
  });
});
