...
/** Golden WU account-copy-two-factor-recovery-codes -- copyTwoFactorRecoveryCodes. */
describe('AccountState copyTwoFactorRecoveryCodes (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).copyTwoFactorRecoveryCodes(); }).not.toThrow();
  });
});
