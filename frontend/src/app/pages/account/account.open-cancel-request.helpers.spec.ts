...
/** Golden WU account-open-cancel-request -- openCancelRequest. */
describe('AccountState openCancelRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openCancelRequest(undefined as any); }).not.toThrow();
  });
});
