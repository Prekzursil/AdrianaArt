...
/** Golden WU account-cancel-revoke-other-sessions -- cancelRevokeOtherSessions. */
describe('AccountState cancelRevokeOtherSessions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelRevokeOtherSessions(); }).not.toThrow();
  });
});
