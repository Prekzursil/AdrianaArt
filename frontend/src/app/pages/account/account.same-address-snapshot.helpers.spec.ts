...
/** Golden WU account-same-address-snapshot -- sameAddressSnapshot. */
describe('AccountState sameAddressSnapshot (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).sameAddressSnapshot(undefined as any, undefined as any); }).not.toThrow();
  });
});
