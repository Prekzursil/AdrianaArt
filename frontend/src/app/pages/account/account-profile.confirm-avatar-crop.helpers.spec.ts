...
/** Golden WU account-profile-confirm-avatar-crop -- confirmAvatarCrop. */
describe('AccountProfileComponent confirmAvatarCrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).confirmAvatarCrop()).not.toThrow();
  });
});
