...
/** Golden WU account-cancel-delete-secondary-email -- cancelDeleteSecondaryEmail. */
describe('AccountState cancelDeleteSecondaryEmail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelDeleteSecondaryEmail(); }).not.toThrow();
  });
});
