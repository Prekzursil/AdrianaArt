...
/** Golden WU account-update-two-factor-setup-qr -- updateTwoFactorSetupQr. */
describe('AccountState updateTwoFactorSetupQr (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateTwoFactorSetupQr(); }).not.toThrow();
  });
});
