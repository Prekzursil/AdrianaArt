...
/** Golden WU account-duplicate-address -- duplicateAddress. */
describe('AccountState duplicateAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).duplicateAddress(undefined as any); }).not.toThrow();
  });
});
