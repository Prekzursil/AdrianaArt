...
/** Golden WU account-copy-receipt-link -- copyReceiptLink. */
describe('AccountState copyReceiptLink (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).copyReceiptLink(undefined as any); }).not.toThrow();
  });
});
