...
/** Golden WU account-submit-cancel-request -- submitCancelRequest. */
describe('AccountState submitCancelRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitCancelRequest(undefined as any); }).not.toThrow();
  });
});
