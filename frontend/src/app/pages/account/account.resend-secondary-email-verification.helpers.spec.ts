...
/** Golden WU account-resend-secondary-email-verification -- resendSecondaryEmailVerification. */
describe('AccountState resendSecondaryEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resendSecondaryEmailVerification(''); }).not.toThrow();
  });
});
