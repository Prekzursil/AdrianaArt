...
/** Golden WU page-strip-legal-index-table -- stripLegalIndexTable. */
describe('CmsPageComponent stripLegalIndexTable (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).stripLegalIndexTable(''); }).not.toThrow();
  });
});
