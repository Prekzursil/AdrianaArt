...
/** Golden WU blog-post-set-meta-tags -- setMetaTags. */
describe('BlogPostComponent setMetaTags (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setMetaTags(undefined as any); }).not.toThrow();
  });
});
