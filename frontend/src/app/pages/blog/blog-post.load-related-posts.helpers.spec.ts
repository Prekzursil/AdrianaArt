...
/** Golden WU blog-post-load-related-posts -- loadRelatedPosts. */
describe('BlogPostComponent loadRelatedPosts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadRelatedPosts('', undefined as any); }).not.toThrow();
  });
});
