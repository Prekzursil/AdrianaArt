...
/** Golden WU blog-post-handle-article-click -- handleArticleClick. */
describe('BlogPostComponent handleArticleClick (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).handleArticleClick(null as any)).not.toThrow();
  });
});
