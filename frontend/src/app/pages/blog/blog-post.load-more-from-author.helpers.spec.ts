...
/** Golden WU blog-post-load-more-from-author -- loadMoreFromAuthor. */
describe('BlogPostComponent loadMoreFromAuthor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadMoreFromAuthor('', undefined as any); }).not.toThrow();
  });
});
