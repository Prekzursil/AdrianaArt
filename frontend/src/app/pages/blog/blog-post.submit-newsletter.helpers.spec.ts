...
/** Golden WU blog-post-submit-newsletter -- submitNewsletter. */
describe('BlogPostComponent submitNewsletter (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.submitNewsletter({} as any); }).not.toThrow();
  });
});
