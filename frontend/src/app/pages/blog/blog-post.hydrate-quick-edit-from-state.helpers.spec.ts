...
/** Golden WU blog-post-hydrate-quick-edit-from-state -- hydrateQuickEditFromState. */
describe('BlogPostComponent hydrateQuickEditFromState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).hydrateQuickEditFromState(); }).not.toThrow();
  });
});
