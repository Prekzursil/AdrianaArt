...
/** Golden WU blog-list-load-from-route -- loadFromRoute. */
describe('BlogListComponent loadFromRoute (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadFromRoute(undefined as any, undefined as any); }).not.toThrow();
  });
});
