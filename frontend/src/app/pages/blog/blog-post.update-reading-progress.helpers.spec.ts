...
/** Golden WU blog-post-update-reading-progress -- updateReadingProgress. */
describe('BlogPostComponent updateReadingProgress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateReadingProgress(); }).not.toThrow();
  });
});
