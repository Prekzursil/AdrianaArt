...
/** Golden WU blog-post-apply-embed-data -- applyEmbedData. */
describe('BlogPostComponent applyEmbedData (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applyEmbedData('', undefined as any); }).not.toThrow();
  });
});
