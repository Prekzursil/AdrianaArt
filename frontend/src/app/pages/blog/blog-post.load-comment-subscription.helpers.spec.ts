...
/** Golden WU blog-post-load-comment-subscription -- loadCommentSubscription. */
describe('BlogPostComponent loadCommentSubscription (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.loadCommentSubscription(); }).not.toThrow();
  });
});
