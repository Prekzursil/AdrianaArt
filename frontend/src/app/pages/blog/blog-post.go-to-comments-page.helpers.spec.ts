...
/** Golden WU blog-post-go-to-comments-page -- goToCommentsPage. */
describe('BlogPostComponent goToCommentsPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.goToCommentsPage(0); }).not.toThrow();
  });
});
