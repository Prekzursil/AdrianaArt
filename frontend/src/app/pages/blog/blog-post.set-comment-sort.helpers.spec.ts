...
/** Golden WU blog-post-set-comment-sort -- setCommentSort. */
describe('BlogPostComponent setCommentSort (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.setCommentSort(null as any); }).not.toThrow();
  });
});
