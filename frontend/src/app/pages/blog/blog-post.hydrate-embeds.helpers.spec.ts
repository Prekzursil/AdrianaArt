...
/** Golden WU blog-post-hydrate-embeds -- hydrateEmbeds. */
describe('BlogPostComponent hydrateEmbeds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).hydrateEmbeds(undefined as any, 0, ''); }).not.toThrow();
  });
});
