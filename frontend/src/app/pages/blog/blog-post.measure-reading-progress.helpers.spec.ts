...
/** Golden WU blog-post-measure-reading-progress -- measureReadingProgress. */
describe('BlogPostComponent measureReadingProgress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).measureReadingProgress(); }).not.toThrow();
  });
});
