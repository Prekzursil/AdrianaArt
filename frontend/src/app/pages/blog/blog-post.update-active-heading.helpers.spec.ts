...
/** Golden WU blog-post-update-active-heading -- updateActiveHeading. */
describe('BlogPostComponent updateActiveHeading (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateActiveHeading(); }).not.toThrow();
  });
});
