...
/** Golden WU blog-post-measure-reading-progress-soon -- measureReadingProgressSoon. */
describe('BlogPostComponent measureReadingProgressSoon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).measureReadingProgressSoon(); }).not.toThrow();
  });
});
