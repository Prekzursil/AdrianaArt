...
/** Golden WU cart-cmp-refresh-promo-quote -- refreshPromoQuote. */
describe('CartComponent refreshPromoQuote (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshPromoQuote(''); }).not.toThrow();
  });
});
