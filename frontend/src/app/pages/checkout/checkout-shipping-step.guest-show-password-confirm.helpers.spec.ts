...
/** Golden WU checkout-shipping-step-guest-show-password-confirm -- guestShowPasswordConfirm. */
describe('CheckoutShippingStepComponent guestShowPasswordConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestShowPasswordConfirm(); }).not.toThrow();
  });
});
