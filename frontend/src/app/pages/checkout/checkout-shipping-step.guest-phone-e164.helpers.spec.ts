...
/** Golden WU checkout-shipping-step-guest-phone-e164 -- guestPhoneE164. */
describe('CheckoutShippingStepComponent guestPhoneE164 (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).guestPhoneE164()).not.toThrow();
  });
});
