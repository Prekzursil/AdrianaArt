...
/** Golden WU checkout-shipping-step-guest-email-error -- guestEmailError. */
describe('CheckoutShippingStepComponent guestEmailError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestEmailError(); }).not.toThrow();
  });
});
