...
/** Golden WU checkout-shipping-step-phone-countries -- phoneCountries. */
describe('CheckoutShippingStepComponent phoneCountries (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).phoneCountries(); }).not.toThrow();
  });
});
