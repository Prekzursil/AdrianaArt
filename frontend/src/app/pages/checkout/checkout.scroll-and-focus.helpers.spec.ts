...
/** Golden WU checkout-scroll-and-focus -- scrollAndFocus. */
describe('CheckoutComponent scrollAndFocus (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).scrollAndFocus({ focus: () => {}, scrollIntoView: () => {} } as any)).not.toThrow();
  });
});
