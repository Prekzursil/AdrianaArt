...
/** Golden WU checkout-load-auto-apply-best-coupon-preference -- loadAutoApplyBestCouponPreference. */
describe('CheckoutComponent loadAutoApplyBestCouponPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadAutoApplyBestCouponPreference()).not.toThrow();
  });
});
