...
/** Golden WU checkout-shipping-step-guest-show-password -- guestShowPassword. */
describe('CheckoutShippingStepComponent guestShowPassword (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestShowPassword(); }).not.toThrow();
  });
});
