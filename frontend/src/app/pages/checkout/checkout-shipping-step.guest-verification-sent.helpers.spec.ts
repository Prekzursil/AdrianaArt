...
/** Golden WU checkout-shipping-step-guest-verification-sent -- guestVerificationSent. */
describe('CheckoutShippingStepComponent guestVerificationSent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestVerificationSent(); }).not.toThrow();
  });
});
