...
/** Golden WU checkout-show-payment-not-ready -- showPaymentNotReady. */
describe('CheckoutComponent showPaymentNotReady (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).showPaymentNotReady()).not.toThrow();
  });
});
