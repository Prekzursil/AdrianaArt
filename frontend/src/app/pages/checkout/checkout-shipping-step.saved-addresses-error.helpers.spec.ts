...
/** Golden WU checkout-shipping-step-saved-addresses-error -- savedAddressesError. */
describe('CheckoutShippingStepComponent savedAddressesError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).savedAddressesError(); }).not.toThrow();
  });
});
