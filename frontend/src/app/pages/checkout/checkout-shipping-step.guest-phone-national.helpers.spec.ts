...
/** Golden WU checkout-shipping-step-guest-phone-national -- guestPhoneNational. */
describe('CheckoutShippingStepComponent guestPhoneNational (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestPhoneNational(); }).not.toThrow();
  });
});
