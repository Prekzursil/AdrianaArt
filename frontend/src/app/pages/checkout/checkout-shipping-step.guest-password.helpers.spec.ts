...
/** Golden WU checkout-shipping-step-guest-password -- guestPassword. */
describe('CheckoutShippingStepComponent guestPassword (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestPassword(); }).not.toThrow();
  });
});
