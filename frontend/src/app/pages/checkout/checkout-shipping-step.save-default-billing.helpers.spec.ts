...
/** Golden WU checkout-shipping-step-save-default-billing -- saveDefaultBilling. */
describe('CheckoutShippingStepComponent saveDefaultBilling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveDefaultBilling(); }).not.toThrow();
  });
});
