...
/** Golden WU checkout-track-checkout-abandon -- trackCheckoutAbandon. */
describe('CheckoutComponent trackCheckoutAbandon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).trackCheckoutAbandon()).not.toThrow();
  });
});
