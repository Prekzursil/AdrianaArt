...
/** Golden WU checkout-shipping-step-copy-shipping-to-billing -- copyShippingToBilling. */
describe('CheckoutShippingStepComponent copyShippingToBilling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).copyShippingToBilling()).not.toThrow();
  });
});
