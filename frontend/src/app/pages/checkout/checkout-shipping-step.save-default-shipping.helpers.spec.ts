...
/** Golden WU checkout-shipping-step-save-default-shipping -- saveDefaultShipping. */
describe('CheckoutShippingStepComponent saveDefaultShipping (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveDefaultShipping(); }).not.toThrow();
  });
});
