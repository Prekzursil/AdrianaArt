...
/** Golden WU checkout-shipping-step-guest-sending-code -- guestSendingCode. */
describe('CheckoutShippingStepComponent guestSendingCode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestSendingCode(); }).not.toThrow();
  });
});
