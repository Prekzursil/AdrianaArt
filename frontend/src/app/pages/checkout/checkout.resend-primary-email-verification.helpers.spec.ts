...
/** Golden WU checkout-resend-primary-email-verification -- resendPrimaryEmailVerification. */
describe('CheckoutComponent resendPrimaryEmailVerification (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).resendPrimaryEmailVerification()).not.toThrow();
  });
});
