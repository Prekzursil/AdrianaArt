...
/** Golden WU checkout-shipping-step-delivery-error -- deliveryError. */
describe('CheckoutShippingStepComponent deliveryError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deliveryError(); }).not.toThrow();
  });
});
