...
/** Golden WU checkout-shipping-step-format-saved-address -- formatSavedAddress. */
describe('CheckoutShippingStepComponent formatSavedAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).formatSavedAddress(undefined as any); }).not.toThrow();
  });
});
