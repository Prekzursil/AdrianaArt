...
/** Golden WU checkout-shipping-step-quote-shipping -- quoteShipping. */
describe('CheckoutShippingStepComponent quoteShipping (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).quoteShipping()).not.toThrow();
  });
});
