...
/** Golden WU checkout-shipping-step-courier-estimate-params -- courierEstimateParams. */
describe('CheckoutShippingStepComponent courierEstimateParams (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.courierEstimateParams(null as any); }).not.toThrow();
  });
});
