...
/** Golden WU checkout-shipping-step-saved-addresses -- savedAddresses. */
describe('CheckoutShippingStepComponent savedAddresses (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).savedAddresses(); }).not.toThrow();
  });
});
