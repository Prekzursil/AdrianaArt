...
/** Golden WU checkout-shipping-step-billing-same-as-shipping -- billingSameAsShipping. */
describe('CheckoutShippingStepComponent billingSameAsShipping (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).billingSameAsShipping(); }).not.toThrow();
  });
});
