...
/** Golden WU checkout-handle-checkout-request-error -- handleCheckoutRequestError. */
describe('CheckoutComponent handleCheckoutRequestError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).handleCheckoutRequestError(null as any)).not.toThrow();
  });
});
