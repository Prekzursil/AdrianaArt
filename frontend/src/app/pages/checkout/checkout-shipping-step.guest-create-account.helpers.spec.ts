...
/** Golden WU checkout-shipping-step-guest-create-account -- guestCreateAccount. */
describe('CheckoutShippingStepComponent guestCreateAccount (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestCreateAccount(); }).not.toThrow();
  });
});
