...
/** Golden WU checkout-update-guest-resend-cooldown -- updateGuestResendCooldown. */
describe('CheckoutComponent updateGuestResendCooldown (golden WU)', () => {
...
http: { get: jasmine.createSpy('hg'), post: jasmine.createSpy('hp') },
    ...
    expect(() => (cmp as any).updateGuestResendCooldown()).not.toThrow();
  });
});
