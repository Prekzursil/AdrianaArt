...
/** Golden WU checkout-shipping-step-guest-phone-country -- guestPhoneCountry. */
describe('CheckoutShippingStepComponent guestPhoneCountry (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestPhoneCountry(); }).not.toThrow();
  });
});
