...
/** Golden WU checkout-shipping-step-shipping-country-input -- shippingCountryInput. */
describe('CheckoutShippingStepComponent shippingCountryInput (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingCountryInput(); }).not.toThrow();
  });
});
