...
/** Golden WU success-track-checkout-success -- trackCheckoutSuccess. */
describe('SuccessComponent trackCheckoutSuccess (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).trackCheckoutSuccess()).not.toThrow();
  });
});
