...
/** Golden WU checkout-shipping-step-request-guest-email-verification -- requestGuestEmailVerification. */
describe('CheckoutShippingStepComponent requestGuestEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.requestGuestEmailVerification(); }).not.toThrow();
  });
});
