...
/** Golden WU checkout-track-checkout-start -- trackCheckoutStart. */
describe('CheckoutComponent trackCheckoutStart (golden WU)', () => {
...
http: { get: jasmine.createSpy('hg'), post: jasmine.createSpy('hp') },
    ...
    expect(() => (cmp as any).trackCheckoutStart()).not.toThrow();
  });
});
