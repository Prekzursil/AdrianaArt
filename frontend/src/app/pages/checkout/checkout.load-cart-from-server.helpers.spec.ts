...
/** Golden WU checkout-load-cart-from-server -- loadCartFromServer. */
describe('CheckoutComponent loadCartFromServer (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadCartFromServer()).not.toThrow();
  });
});
