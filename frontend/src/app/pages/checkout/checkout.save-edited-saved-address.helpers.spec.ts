...
/** Golden WU checkout-save-edited-saved-address -- saveEditedSavedAddress. */
describe('CheckoutComponent saveEditedSavedAddress (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).saveEditedSavedAddress({} as any)).not.toThrow();
  });
});
