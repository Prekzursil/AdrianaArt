...
/** Golden WU netopia-cancel-confirm-payment -- confirmPayment. */
describe('NetopiaCancelComponent confirmPayment (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(NetopiaCancelComponent.prototype) as NetopiaCancelComponent;
