...
/** Golden WU checkout-shipping-step-delivery-type -- deliveryType. */
describe('CheckoutShippingStepComponent deliveryType (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deliveryType(); }).not.toThrow();
  });
});
