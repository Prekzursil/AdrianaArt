...
/** Golden WU checkout-show-payment-not-ready-error -- showPaymentNotReadyError. */
describe('CheckoutComponent showPaymentNotReadyError (golden WU)', () => {
...
http: { get: jasmine.createSpy('hg'), post: jasmine.createSpy('hp') },
    ...
    expect(() => (cmp as any).showPaymentNotReadyError()).not.toThrow();
  });
});
