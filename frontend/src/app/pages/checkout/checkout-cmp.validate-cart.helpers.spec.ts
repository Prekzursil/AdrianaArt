...
/** Golden WU checkout-cmp-validate-cart -- validateCart. */
describe('CheckoutComponent validateCart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).validateCart(undefined as any); }).not.toThrow();
  });
});
