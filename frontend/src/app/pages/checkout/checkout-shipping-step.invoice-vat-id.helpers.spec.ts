...
/** Golden WU checkout-shipping-step-invoice-vat-id -- invoiceVatId. */
describe('CheckoutShippingStepComponent invoiceVatId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).invoiceVatId(); }).not.toThrow();
  });
});
