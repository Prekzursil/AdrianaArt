...
/** Golden WU checkout-pick-best-coupon-offer -- pickBestCouponOffer. */
describe('CheckoutComponent pickBestCouponOffer (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).pickBestCouponOffer(null as any)).not.toThrow();
  });
});
