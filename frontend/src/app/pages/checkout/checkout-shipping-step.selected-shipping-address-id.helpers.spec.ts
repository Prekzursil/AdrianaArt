...
/** Golden WU checkout-shipping-step-selected-shipping-address-id -- selectedShippingAddressId. */
describe('CheckoutShippingStepComponent selectedShippingAddressId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectedShippingAddressId(); }).not.toThrow();
  });
});
