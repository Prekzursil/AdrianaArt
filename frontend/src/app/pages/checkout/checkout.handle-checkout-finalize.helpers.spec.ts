...
/** Golden WU checkout-handle-checkout-finalize -- handleCheckoutFinalize. */
describe('CheckoutComponent handleCheckoutFinalize (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).handleCheckoutFinalize(false)).not.toThrow();
  });
});
