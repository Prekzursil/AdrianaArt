...
/** Golden WU checkout-focus-first-invalid-field -- focusFirstInvalidField. */
describe('CheckoutComponent focusFirstInvalidField (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).focusFirstInvalidField()).not.toThrow();
  });
});
