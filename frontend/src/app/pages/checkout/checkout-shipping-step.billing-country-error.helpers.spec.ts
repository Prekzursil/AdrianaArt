...
/** Golden WU checkout-shipping-step-billing-country-error -- billingCountryError. */
describe('CheckoutShippingStepComponent billingCountryError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).billingCountryError(); }).not.toThrow();
  });
});
