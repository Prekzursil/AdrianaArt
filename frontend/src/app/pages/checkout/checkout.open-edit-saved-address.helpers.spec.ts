...
/** Golden WU checkout-open-edit-saved-address -- openEditSavedAddress. */
describe('CheckoutComponent openEditSavedAddress (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).openEditSavedAddress('shipping')).not.toThrow();
  });
});
