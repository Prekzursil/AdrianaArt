...
/** Golden WU checkout-shipping-step-step1-complete -- step1Complete. */
describe('CheckoutShippingStepComponent step1Complete (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).step1Complete()).not.toThrow();
  });
});
