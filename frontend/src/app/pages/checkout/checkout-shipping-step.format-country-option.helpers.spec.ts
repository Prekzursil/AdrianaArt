...
/** Golden WU checkout-shipping-step-format-country-option -- formatCountryOption. */
describe('CheckoutShippingStepComponent formatCountryOption (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).formatCountryOption(undefined as any); }).not.toThrow();
  });
});
