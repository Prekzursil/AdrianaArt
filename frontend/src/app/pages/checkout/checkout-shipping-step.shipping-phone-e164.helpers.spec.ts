...
/** Golden WU checkout-shipping-step-shipping-phone-e164 -- shippingPhoneE164. */
describe('CheckoutShippingStepComponent shippingPhoneE164 (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).shippingPhoneE164()).not.toThrow();
  });
});
