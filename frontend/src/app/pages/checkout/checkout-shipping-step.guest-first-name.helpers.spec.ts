...
/** Golden WU checkout-shipping-step-guest-first-name -- guestFirstName. */
describe('CheckoutShippingStepComponent guestFirstName (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestFirstName(); }).not.toThrow();
  });
});
