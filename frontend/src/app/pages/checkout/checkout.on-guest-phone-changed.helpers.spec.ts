...
/** Golden WU checkout-on-guest-phone-changed -- onGuestPhoneChanged. */
describe('CheckoutComponent onGuestPhoneChanged (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onGuestPhoneChanged()).not.toThrow();
  });
});
