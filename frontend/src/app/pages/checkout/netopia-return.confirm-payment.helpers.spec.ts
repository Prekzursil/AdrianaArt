...
/** Golden WU netopia-return-confirm-payment -- confirmPayment. */
describe('NetopiaReturnComponent confirmPayment (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).confirmPayment()).not.toThrow();
  });
});
