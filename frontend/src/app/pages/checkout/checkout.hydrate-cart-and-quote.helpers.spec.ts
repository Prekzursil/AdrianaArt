...
/** Golden WU checkout-hydrate-cart-and-quote -- hydrateCartAndQuote. */
describe('CheckoutComponent hydrateCartAndQuote (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).hydrateCartAndQuote(null as any)).not.toThrow();
  });
});
