...
/** Golden WU checkout-shipping-step-toggle-guest-password -- toggleGuestPassword. */
describe('CheckoutShippingStepComponent toggleGuestPassword (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).toggleGuestPassword()).not.toThrow();
  });
});
