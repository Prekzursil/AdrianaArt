...
/** Golden WU checkout-shipping-step-scroll-to-step -- scrollToStep. */
describe('CheckoutShippingStepComponent scrollToStep (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).scrollToStep(''); }).not.toThrow();
  });
});
