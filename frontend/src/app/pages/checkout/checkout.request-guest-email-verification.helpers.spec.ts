...
/** Golden WU checkout-request-guest-email-verification -- requestGuestEmailVerification. */
describe('CheckoutComponent requestGuestEmailVerification (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).requestGuestEmailVerification()).not.toThrow();
  });
});
