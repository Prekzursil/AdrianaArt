...
/** Golden WU checkout-shipping-step-guest-password-confirm -- guestPasswordConfirm. */
describe('CheckoutShippingStepComponent guestPasswordConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestPasswordConfirm(); }).not.toThrow();
  });
});
