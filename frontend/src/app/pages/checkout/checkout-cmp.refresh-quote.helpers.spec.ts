...
/** Golden WU checkout-cmp-refresh-quote -- refreshQuote. */
describe('CheckoutComponent refreshQuote (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshQuote(undefined as any); }).not.toThrow();
  });
});
