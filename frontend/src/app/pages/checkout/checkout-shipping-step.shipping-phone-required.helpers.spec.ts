...
/** Golden WU checkout-shipping-step-shipping-phone-required -- shippingPhoneRequired. */
describe('CheckoutShippingStepComponent shippingPhoneRequired (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingPhoneRequired(); }).not.toThrow();
  });
});
