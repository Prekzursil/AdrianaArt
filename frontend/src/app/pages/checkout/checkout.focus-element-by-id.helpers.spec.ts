...
/** Golden WU checkout-focus-element-by-id -- focusElementById. */
describe('CheckoutComponent focusElementById (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).focusElementById('')).not.toThrow();
  });
});
