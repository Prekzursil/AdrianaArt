...
/** Golden WU stripe-mock-complete -- complete. */
describe('StripeMockComponent complete (golden WU)', () => {
  it('returns early on guard', () => {
    const cmp = Object.create(StripeMockComponent.prototype) as StripeMockComponent;
