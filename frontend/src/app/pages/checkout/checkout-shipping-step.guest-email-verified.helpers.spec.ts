...
/** Golden WU checkout-shipping-step-guest-email-verified -- guestEmailVerified. */
describe('CheckoutShippingStepComponent guestEmailVerified (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestEmailVerified(); }).not.toThrow();
  });
});
