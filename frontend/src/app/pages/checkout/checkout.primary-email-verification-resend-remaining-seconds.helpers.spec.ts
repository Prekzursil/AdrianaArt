...
/** Golden WU checkout-primary-email-verification-resend-remaining-seconds -- primaryEmailVerificationResendRemainingSeconds. */
describe('CheckoutComponent primaryEmailVerificationResendRemainingSeconds (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).primaryEmailVerificationResendRemainingSeconds()).not.toThrow();
  });
});
