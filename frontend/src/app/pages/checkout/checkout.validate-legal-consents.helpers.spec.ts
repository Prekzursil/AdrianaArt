...
/** Golden WU checkout-validate-legal-consents -- validateLegalConsents. */
describe('CheckoutComponent validateLegalConsents (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).validateLegalConsents()).not.toThrow();
  });
});
