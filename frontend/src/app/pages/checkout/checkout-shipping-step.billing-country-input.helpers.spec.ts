...
/** Golden WU checkout-shipping-step-billing-country-input -- billingCountryInput. */
describe('CheckoutShippingStepComponent billingCountryInput (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).billingCountryInput(); }).not.toThrow();
  });
});
