...
/** Golden WU checkout-shipping-step-selected-billing-address-id -- selectedBillingAddressId. */
describe('CheckoutShippingStepComponent selectedBillingAddressId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectedBillingAddressId(); }).not.toThrow();
  });
});
