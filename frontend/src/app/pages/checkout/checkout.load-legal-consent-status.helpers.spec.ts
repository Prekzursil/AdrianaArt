...
/** Golden WU checkout-load-legal-consent-status -- loadLegalConsentStatus. */
describe('CheckoutComponent loadLegalConsentStatus (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadLegalConsentStatus()).not.toThrow();
  });
});
