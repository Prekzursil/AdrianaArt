...
/** Golden WU checkout-shipping-step-shipping-phone-national -- shippingPhoneNational. */
describe('CheckoutShippingStepComponent shippingPhoneNational (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingPhoneNational(); }).not.toThrow();
  });
});
