...
/** Golden WU checkout-maybe-auto-apply-best-coupon -- maybeAutoApplyBestCoupon. */
describe('CheckoutComponent maybeAutoApplyBestCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).maybeAutoApplyBestCoupon()).not.toThrow();
  });
});
