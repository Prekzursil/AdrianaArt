...
/** Golden WU checkout-load-coupons-eligibility -- loadCouponsEligibility. */
describe('CheckoutComponent loadCouponsEligibility (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadCouponsEligibility()).not.toThrow();
  });
});
