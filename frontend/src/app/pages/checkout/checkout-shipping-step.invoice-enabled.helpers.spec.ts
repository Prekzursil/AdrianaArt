...
/** Golden WU checkout-shipping-step-invoice-enabled -- invoiceEnabled. */
describe('CheckoutShippingStepComponent invoiceEnabled (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).invoiceEnabled(); }).not.toThrow();
  });
});
