...
/** Golden WU checkout-shipping-step-delivery-locker-allowed -- deliveryLockerAllowed. */
describe('CheckoutShippingStepComponent deliveryLockerAllowed (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deliveryLockerAllowed(); }).not.toThrow();
  });
});
