...
/** Golden WU checkout-shipping-step-normalize-shipping-country -- normalizeShippingCountry. */
describe('CheckoutShippingStepComponent normalizeShippingCountry (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).normalizeShippingCountry()).not.toThrow();
  });
});
