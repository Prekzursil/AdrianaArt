...
/** Golden WU checkout-shipping-step-saved-addresses-loading -- savedAddressesLoading. */
describe('CheckoutShippingStepComponent savedAddressesLoading (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).savedAddressesLoading(); }).not.toThrow();
  });
});
