...
/** Golden WU checkout-normalize-checkout-countries -- normalizeCheckoutCountries. */
describe('CheckoutComponent normalizeCheckoutCountries (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).normalizeCheckoutCountries()).not.toThrow();
  });
});
