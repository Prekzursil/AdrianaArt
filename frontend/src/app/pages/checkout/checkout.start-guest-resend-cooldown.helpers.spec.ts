...
/** Golden WU checkout-start-guest-resend-cooldown -- startGuestResendCooldown. */
describe('CheckoutComponent startGuestResendCooldown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startGuestResendCooldown(0); }).not.toThrow();
  });
});
