...
/** Golden WU checkout-shipping-step-invoice-company -- invoiceCompany. */
describe('CheckoutShippingStepComponent invoiceCompany (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).invoiceCompany(); }).not.toThrow();
  });
});
