...
/** Golden WU checkout-find-first-invalid-field -- findFirstInvalidField. */
describe('CheckoutComponent findFirstInvalidField (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).findFirstInvalidField(null as any)).not.toThrow();
  });
});
