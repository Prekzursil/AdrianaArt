...
/** Golden WU checkout-on-checkout-consent-attempt -- onCheckoutConsentAttempt. */
describe('CheckoutComponent onCheckoutConsentAttempt (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onCheckoutConsentAttempt({} as any, null as any)).not.toThrow();
  });
});
