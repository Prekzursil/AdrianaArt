...
/** Golden WU checkout-shipping-step-guest-verification-token -- guestVerificationToken. */
describe('CheckoutShippingStepComponent guestVerificationToken (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestVerificationToken(); }).not.toThrow();
  });
});
