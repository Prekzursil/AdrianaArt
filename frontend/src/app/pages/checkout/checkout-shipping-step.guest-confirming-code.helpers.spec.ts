...
/** Golden WU checkout-shipping-step-guest-confirming-code -- guestConfirmingCode. */
describe('CheckoutShippingStepComponent guestConfirmingCode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestConfirmingCode(); }).not.toThrow();
  });
});
