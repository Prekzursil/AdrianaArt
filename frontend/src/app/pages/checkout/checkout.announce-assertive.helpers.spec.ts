...
/** Golden WU checkout-announce-assertive -- announceAssertive. */
describe('CheckoutComponent announceAssertive (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).announceAssertive('x')).not.toThrow();
  });
});
