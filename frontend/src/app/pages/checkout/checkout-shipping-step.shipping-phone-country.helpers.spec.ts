...
/** Golden WU checkout-shipping-step-shipping-phone-country -- shippingPhoneCountry. */
describe('CheckoutShippingStepComponent shippingPhoneCountry (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingPhoneCountry(); }).not.toThrow();
  });
});
