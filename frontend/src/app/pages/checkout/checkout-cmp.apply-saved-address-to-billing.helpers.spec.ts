...
/** Golden WU checkout-cmp-apply-saved-address-to-billing -- applySavedAddressToBilling. */
describe('CheckoutComponent applySavedAddressToBilling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applySavedAddressToBilling(undefined as any); }).not.toThrow();
  });
});
