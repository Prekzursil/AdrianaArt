...
/** Golden WU checkout-shipping-step-set-delivery-type -- setDeliveryType. */
describe('CheckoutShippingStepComponent setDeliveryType (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setDeliveryType(undefined as any); }).not.toThrow();
  });
});
