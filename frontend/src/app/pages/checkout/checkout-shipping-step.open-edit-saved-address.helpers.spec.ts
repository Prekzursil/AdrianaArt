...
/** Golden WU checkout-shipping-step-open-edit-saved-address -- openEditSavedAddress. */
describe('CheckoutShippingStepComponent openEditSavedAddress (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openEditSavedAddress(undefined as any); }).not.toThrow();
  });
});
