...
/** Golden WU checkout-persist-address-if-requested -- persistAddressIfRequested. */
describe('CheckoutComponent persistAddressIfRequested (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).persistAddressIfRequested()).not.toThrow();
  });
});
