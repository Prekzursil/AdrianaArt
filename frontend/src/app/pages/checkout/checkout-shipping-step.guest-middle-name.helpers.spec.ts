...
/** Golden WU checkout-shipping-step-guest-middle-name -- guestMiddleName. */
describe('CheckoutShippingStepComponent guestMiddleName (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestMiddleName(); }).not.toThrow();
  });
});
