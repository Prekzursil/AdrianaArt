...
/** Golden WU checkout-shipping-step-courier-allowed -- courierAllowed. */
describe('CheckoutShippingStepComponent courierAllowed (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.courierAllowed(null as any); }).not.toThrow();
  });
});
