...
/** Golden WU checkout-shipping-step-on-guest-phone-changed -- onGuestPhoneChanged. */
describe('CheckoutShippingStepComponent onGuestPhoneChanged (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onGuestPhoneChanged(); }).not.toThrow();
  });
});
