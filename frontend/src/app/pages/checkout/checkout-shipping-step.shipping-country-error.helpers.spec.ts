...
/** Golden WU checkout-shipping-step-shipping-country-error -- shippingCountryError. */
describe('CheckoutShippingStepComponent shippingCountryError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).shippingCountryError(); }).not.toThrow();
  });
});
