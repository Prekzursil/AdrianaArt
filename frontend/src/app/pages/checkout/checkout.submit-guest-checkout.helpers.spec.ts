...
/** Golden WU checkout-submit-guest-checkout -- submitGuestCheckout. */
describe('CheckoutComponent submitGuestCheckout (golden WU)', () => {
...
http: { get: jasmine.createSpy('hg'), post: jasmine.createSpy('hp') },
    ...
    expect(() => (cmp as any).submitGuestCheckout()).not.toThrow();
  });
});
