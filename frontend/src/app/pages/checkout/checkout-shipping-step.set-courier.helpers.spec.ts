...
/** Golden WU checkout-shipping-step-set-courier -- setCourier. */
describe('CheckoutShippingStepComponent setCourier (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setCourier(null as any); }).not.toThrow();
  });
});
