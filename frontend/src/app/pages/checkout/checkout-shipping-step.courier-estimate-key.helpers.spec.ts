...
/** Golden WU checkout-shipping-step-courier-estimate-key -- courierEstimateKey. */
describe('CheckoutShippingStepComponent courierEstimateKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.courierEstimateKey(null as any); }).not.toThrow();
  });
});
