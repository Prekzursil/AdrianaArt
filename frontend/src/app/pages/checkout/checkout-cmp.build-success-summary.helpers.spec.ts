...
/** Golden WU checkout-cmp-build-success-summary -- buildSuccessSummary. */
describe('CheckoutComponent buildSuccessSummary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).buildSuccessSummary('', undefined as any, undefined as any); }).not.toThrow();
  });
});
