...
/** Golden WU checkout-persist-auto-apply-best-coupon-preference -- persistAutoApplyBestCouponPreference. */
describe('CheckoutComponent persistAutoApplyBestCouponPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).persistAutoApplyBestCouponPreference(false)).not.toThrow();
  });
});
