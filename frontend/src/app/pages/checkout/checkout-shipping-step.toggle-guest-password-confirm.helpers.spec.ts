...
/** Golden WU checkout-shipping-step-toggle-guest-password-confirm -- toggleGuestPasswordConfirm. */
describe('CheckoutShippingStepComponent toggleGuestPasswordConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).toggleGuestPasswordConfirm()).not.toThrow();
  });
});
