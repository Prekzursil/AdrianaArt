...
/** Golden WU checkout-shipping-step-on-billing-same-as-shipping-changed -- onBillingSameAsShippingChanged. */
describe('CheckoutShippingStepComponent onBillingSameAsShippingChanged (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(CheckoutShippingStepComponent.prototype) as CheckoutShippingStepComponent;
    ...
    expect(() => (cmp as any).onBillingSameAsShippingChanged()).not.toThrow();
  });
});
