...
/** Golden WU checkout-shipping-step-guest-resend-seconds-left -- guestResendSecondsLeft. */
describe('CheckoutShippingStepComponent guestResendSecondsLeft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).guestResendSecondsLeft(); }).not.toThrow();
  });
});
