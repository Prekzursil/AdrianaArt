...
/** Golden WU checkout-shipping-step-address-error -- addressError. */
describe('CheckoutShippingStepComponent addressError (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addressError(); }).not.toThrow();
  });
});
