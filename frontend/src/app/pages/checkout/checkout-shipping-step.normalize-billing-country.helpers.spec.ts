...
/** Golden WU checkout-shipping-step-normalize-billing-country -- normalizeBillingCountry. */
describe('CheckoutShippingStepComponent normalizeBillingCountry (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).normalizeBillingCountry()).not.toThrow();
  });
});
