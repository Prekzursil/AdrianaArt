...
/** Golden WU product-update-structured-data -- updateStructuredData. */
describe('ProductComponent updateStructuredData (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateStructuredData(undefined as any); }).not.toThrow();
  });
});
