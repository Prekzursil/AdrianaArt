...
/** Golden WU product-duplicate-from-storefront -- duplicateFromStorefront. */
describe('ProductComponent duplicateFromStorefront (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).duplicateFromStorefront(); }).not.toThrow();
  });
});
