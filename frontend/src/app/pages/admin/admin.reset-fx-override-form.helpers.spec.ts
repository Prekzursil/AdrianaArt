...
/** Golden WU admin-reset-fx-override-form -- resetFxOverrideForm. */
describe('AdminComponent resetFxOverrideForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetFxOverrideForm(); }).not.toThrow();
  });
});
