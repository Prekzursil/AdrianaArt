...
/** Golden WU admin-dismiss-page-draft-autosave -- dismissPageDraftAutosave. */
describe('AdminComponent dismissPageDraftAutosave (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).dismissPageDraftAutosave(undefined as any); }).not.toThrow();
  });
});
