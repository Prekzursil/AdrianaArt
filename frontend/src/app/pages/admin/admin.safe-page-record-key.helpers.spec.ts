...
/** Golden WU admin-safe-page-record-key -- safePageRecordKey. */
describe('AdminComponent safePageRecordKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).safePageRecordKey(undefined as any); }).not.toThrow();
  });
});
