...
/** Golden WU admin-redo-page-draft -- redoPageDraft. */
describe('AdminComponent redoPageDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).redoPageDraft(undefined as any); }).not.toThrow();
  });
});
