...
/** Golden WU admin-on-cms-media-drag-over -- onCmsMediaDragOver. */
describe('AdminComponent onCmsMediaDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onCmsMediaDragOver({} as any); }).not.toThrow();
  });
});
