...
/** Golden WU admin-clear-blog-bulk-selection -- clearBlogBulkSelection. */
describe('AdminComponent clearBlogBulkSelection (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).clearBlogBulkSelection()).not.toThrow();
  });
});
