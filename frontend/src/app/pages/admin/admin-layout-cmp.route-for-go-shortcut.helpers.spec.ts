...
/** Golden WU admin-layout-cmp-route-for-go-shortcut -- routeForGoShortcut. */
describe('AdminLayoutComponent routeForGoShortcut (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).routeForGoShortcut(''); }).not.toThrow();
  });
});
