...
/** Golden WU admin-on-page-block-drag-end -- onPageBlockDragEnd. */
describe('AdminComponent onPageBlockDragEnd (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlockDragEnd(); }).not.toThrow();
  });
});
