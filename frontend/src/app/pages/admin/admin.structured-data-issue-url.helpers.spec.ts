...
/** Golden WU admin-structured-data-issue-url -- structuredDataIssueUrl. */
describe('AdminComponent structuredDataIssueUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).structuredDataIssueUrl(''); }).not.toThrow();
  });
});
