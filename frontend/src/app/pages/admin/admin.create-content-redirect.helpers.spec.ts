...
/** Golden WU admin-create-content-redirect -- createContentRedirect. */
describe('AdminComponent createContentRedirect (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).createContentRedirect()).not.toThrow();
  });
});
