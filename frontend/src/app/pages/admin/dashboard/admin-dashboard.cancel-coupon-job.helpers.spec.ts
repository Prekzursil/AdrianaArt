...
/** Golden WU admin-dashboard-cancel-coupon-job -- cancelCouponJob. */
describe('AdminDashboardComponent cancelCouponJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelCouponJob(undefined as any); }).not.toThrow();
  });
});
