...
/** Golden WU admin-dashboard-persist-sales-metric-preference -- persistSalesMetricPreference. */
describe('AdminDashboardComponent persistSalesMetricPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).persistSalesMetricPreference(undefined as any); }).not.toThrow();
  });
});
