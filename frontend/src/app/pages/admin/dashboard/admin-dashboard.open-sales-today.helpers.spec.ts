...
/** Golden WU admin-dashboard-open-sales-today -- openSalesToday. */
describe('AdminDashboardComponent openSalesToday (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openSalesToday(); }).not.toThrow();
  });
});
