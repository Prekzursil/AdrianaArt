...
/** Golden WU admin-dashboard-go-to-create-product -- goToCreateProduct. */
describe('AdminDashboardComponent goToCreateProduct (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).goToCreateProduct(); }).not.toThrow();
  });
});
