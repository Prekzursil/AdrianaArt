...
/** Golden WU admin-dashboard-open-scheduled-publish -- openScheduledPublish. */
describe('AdminDashboardComponent openScheduledPublish (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openScheduledPublish(undefined as any); }).not.toThrow();
  });
});
