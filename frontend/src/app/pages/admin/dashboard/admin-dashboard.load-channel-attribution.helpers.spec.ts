...
/** Golden WU admin-dashboard-load-channel-attribution -- loadChannelAttribution. */
describe('AdminDashboardComponent loadChannelAttribution (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadChannelAttribution(); }).not.toThrow();
  });
});
