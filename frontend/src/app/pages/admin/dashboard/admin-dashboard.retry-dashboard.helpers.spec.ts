...
/** Golden WU admin-dashboard-retry-dashboard -- retryDashboard. */
describe('AdminDashboardComponent retryDashboard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).retryDashboard(); }).not.toThrow();
  });
});
