...
/** Golden WU admin-dashboard-apply-audit-filters -- applyAuditFilters. */
describe('AdminDashboardComponent applyAuditFilters (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).applyAuditFilters()).not.toThrow();
  });
});
