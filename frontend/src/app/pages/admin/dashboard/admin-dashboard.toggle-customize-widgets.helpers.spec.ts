...
/** Golden WU admin-dashboard-toggle-customize-widgets -- toggleCustomizeWidgets. */
describe('AdminDashboardComponent toggleCustomizeWidgets (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleCustomizeWidgets(); }).not.toThrow();
  });
});
