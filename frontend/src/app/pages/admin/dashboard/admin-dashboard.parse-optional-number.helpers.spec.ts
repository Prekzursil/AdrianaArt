...
/** Golden WU admin-dashboard-parse-optional-number -- parseOptionalNumber. */
describe('AdminDashboardComponent parseOptionalNumber (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseOptionalNumber(undefined as any, 0); }).not.toThrow();
  });
});
