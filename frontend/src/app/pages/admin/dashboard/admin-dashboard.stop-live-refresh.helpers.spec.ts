...
/** Golden WU admin-dashboard-stop-live-refresh -- stopLiveRefresh. */
describe('AdminDashboardComponent stopLiveRefresh (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).stopLiveRefresh(); }).not.toThrow();
  });
});
