...
/** Golden WU admin-dashboard-complete-onboarding -- completeOnboarding. */
describe('AdminDashboardComponent completeOnboarding (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).completeOnboarding(); }).not.toThrow();
  });
});
