...
/** Golden WU admin-dashboard-go-to-create-coupon -- goToCreateCoupon. */
describe('AdminDashboardComponent goToCreateCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).goToCreateCoupon(); }).not.toThrow();
  });
});
