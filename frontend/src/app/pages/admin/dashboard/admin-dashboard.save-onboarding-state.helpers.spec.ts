...
/** Golden WU admin-dashboard-save-onboarding-state -- saveOnboardingState. */
describe('AdminDashboardComponent saveOnboardingState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveOnboardingState(undefined as any); }).not.toThrow();
  });
});
