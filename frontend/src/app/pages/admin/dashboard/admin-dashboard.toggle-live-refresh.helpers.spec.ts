...
/** Golden WU admin-dashboard-toggle-live-refresh -- toggleLiveRefresh. */
describe('AdminDashboardComponent toggleLiveRefresh (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleLiveRefresh(); }).not.toThrow();
  });
});
