...
/** Golden WU admin-dashboard-load-onboarding-state -- loadOnboardingState. */
describe('AdminDashboardComponent loadOnboardingState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadOnboardingState(); }).not.toThrow();
  });
});
