...
/** Golden WU admin-dashboard-refresh-funnel-silent -- refreshFunnelSilent. */
describe('AdminDashboardComponent refreshFunnelSilent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshFunnelSilent(); }).not.toThrow();
  });
});
