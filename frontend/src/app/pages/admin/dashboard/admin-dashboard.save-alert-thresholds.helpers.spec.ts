...
/** Golden WU admin-dashboard-save-alert-thresholds -- saveAlertThresholds. */
describe('AdminDashboardComponent saveAlertThresholds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveAlertThresholds(); }).not.toThrow();
  });
});
