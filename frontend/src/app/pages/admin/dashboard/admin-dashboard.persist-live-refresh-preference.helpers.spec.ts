...
/** Golden WU admin-dashboard-persist-live-refresh-preference -- persistLiveRefreshPreference. */
describe('AdminDashboardComponent persistLiveRefreshPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).persistLiveRefreshPreference(false); }).not.toThrow();
  });
});
