...
/** Golden WU admin-dashboard-open-refund-requests -- openRefundRequests. */
describe('AdminDashboardComponent openRefundRequests (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openRefundRequests(); }).not.toThrow();
  });
});
