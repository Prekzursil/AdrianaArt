...
/** Golden WU admin-dashboard-open-sales-range -- openSalesRange. */
describe('AdminDashboardComponent openSalesRange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openSalesRange(); }).not.toThrow();
  });
});
