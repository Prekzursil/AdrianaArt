...
/** Golden WU admin-dashboard-load-refunds-breakdown -- loadRefundsBreakdown. */
describe('AdminDashboardComponent loadRefundsBreakdown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadRefundsBreakdown(); }).not.toThrow();
  });
});
