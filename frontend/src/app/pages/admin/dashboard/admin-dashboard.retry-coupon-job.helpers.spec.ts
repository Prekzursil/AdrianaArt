...
/** Golden WU admin-dashboard-retry-coupon-job -- retryCouponJob. */
describe('AdminDashboardComponent retryCouponJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).retryCouponJob(undefined as any); }).not.toThrow();
  });
});
