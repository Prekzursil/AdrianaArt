...
/** Golden WU admin-dashboard-download-orders-export -- downloadOrdersExport. */
describe('AdminDashboardComponent downloadOrdersExport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).downloadOrdersExport(); }).not.toThrow();
  });
});
