...
/** Golden WU admin-dashboard-seed-alert-threshold-form -- seedAlertThresholdForm. */
describe('AdminDashboardComponent seedAlertThresholdForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).seedAlertThresholdForm(undefined as any); }).not.toThrow();
  });
});
