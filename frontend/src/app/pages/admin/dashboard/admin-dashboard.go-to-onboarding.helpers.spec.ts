...
/** Golden WU admin-dashboard-go-to-onboarding -- goToOnboarding. */
describe('AdminDashboardComponent goToOnboarding (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).goToOnboarding(''); }).not.toThrow();
  });
});
