...
/** Golden WU admin-dashboard-audit-entity-label -- auditEntityLabel. */
describe('AdminDashboardComponent auditEntityLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).auditEntityLabel(undefined as any); }).not.toThrow();
  });
});
