...
/** Golden WU admin-dashboard-load-audit-retention -- loadAuditRetention. */
describe('AdminDashboardComponent loadAuditRetention (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadAuditRetention(); }).not.toThrow();
  });
});
