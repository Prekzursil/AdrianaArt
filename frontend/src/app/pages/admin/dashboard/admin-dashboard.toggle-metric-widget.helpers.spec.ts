...
/** Golden WU admin-dashboard-toggle-metric-widget -- toggleMetricWidget. */
describe('AdminDashboardComponent toggleMetricWidget (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleMetricWidget(undefined as any); }).not.toThrow();
  });
});
