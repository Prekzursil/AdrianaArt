...
/** Golden WU admin-dashboard-download-audit-csv -- downloadAuditCsv. */
describe('AdminDashboardComponent downloadAuditCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).downloadAuditCsv(); }).not.toThrow();
  });
});
