...
/** Golden WU admin-dashboard-on-global-search-change -- onGlobalSearchChange. */
describe('AdminDashboardComponent onGlobalSearchChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onGlobalSearchChange(); }).not.toThrow();
  });
});
