...
/** Golden WU admin-dashboard-open-orders-today -- openOrdersToday. */
describe('AdminDashboardComponent openOrdersToday (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).openOrdersToday()).not.toThrow();
  });
});
