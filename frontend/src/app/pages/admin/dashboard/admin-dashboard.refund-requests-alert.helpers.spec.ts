...
/** Golden WU admin-dashboard-refund-requests-alert -- refundRequestsAlert. */
describe('AdminDashboardComponent refundRequestsAlert (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refundRequestsAlert(); }).not.toThrow();
  });
});
