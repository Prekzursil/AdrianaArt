...
/** Golden WU admin-dashboard-submit-owner-transfer -- submitOwnerTransfer. */
describe('AdminDashboardComponent submitOwnerTransfer (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitOwnerTransfer(); }).not.toThrow();
  });
});
