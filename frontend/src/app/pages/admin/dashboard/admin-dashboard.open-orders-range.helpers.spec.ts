...
/** Golden WU admin-dashboard-open-orders-range -- openOrdersRange. */
describe('AdminDashboardComponent openOrdersRange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openOrdersRange(); }).not.toThrow();
  });
});
