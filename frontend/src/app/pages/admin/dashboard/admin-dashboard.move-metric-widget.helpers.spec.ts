...
/** Golden WU admin-dashboard-move-metric-widget -- moveMetricWidget. */
describe('AdminDashboardComponent moveMetricWidget (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).moveMetricWidget(undefined as any, undefined as any); }).not.toThrow();
  });
});
