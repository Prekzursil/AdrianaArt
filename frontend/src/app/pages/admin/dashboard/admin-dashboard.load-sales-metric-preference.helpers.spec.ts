...
/** Golden WU admin-dashboard-load-sales-metric-preference -- loadSalesMetricPreference. */
describe('AdminDashboardComponent loadSalesMetricPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadSalesMetricPreference(); }).not.toThrow();
  });
});
