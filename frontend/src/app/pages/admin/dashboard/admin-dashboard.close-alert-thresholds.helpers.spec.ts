...
/** Golden WU admin-dashboard-close-alert-thresholds -- closeAlertThresholds. */
describe('AdminDashboardComponent closeAlertThresholds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).closeAlertThresholds(); }).not.toThrow();
  });
});
