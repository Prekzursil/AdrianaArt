...
/** Golden WU admin-dashboard-download-gdpr-export -- downloadGdprExport. */
describe('AdminDashboardComponent downloadGdprExport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).downloadGdprExport(undefined as any); }).not.toThrow();
  });
});
