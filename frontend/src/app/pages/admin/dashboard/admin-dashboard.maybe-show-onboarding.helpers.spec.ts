...
/** Golden WU admin-dashboard-maybe-show-onboarding -- maybeShowOnboarding. */
describe('AdminDashboardComponent maybeShowOnboarding (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).maybeShowOnboarding(); }).not.toThrow();
  });
});
