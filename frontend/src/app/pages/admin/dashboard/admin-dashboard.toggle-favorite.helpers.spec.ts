...
/** Golden WU admin-dashboard-toggle-favorite -- toggleFavorite. */
describe('AdminDashboardComponent toggleFavorite (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleFavorite(undefined as any, {} as any); }).not.toThrow();
  });
});
