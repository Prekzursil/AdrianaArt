...
/** Golden WU admin-dashboard-open-favorite -- openFavorite. */
describe('AdminDashboardComponent openFavorite (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openFavorite(undefined as any); }).not.toThrow();
  });
});
