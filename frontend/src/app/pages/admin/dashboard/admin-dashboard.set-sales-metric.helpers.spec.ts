...
/** Golden WU admin-dashboard-set-sales-metric -- setSalesMetric. */
describe('AdminDashboardComponent setSalesMetric (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setSalesMetric(undefined as any); }).not.toThrow();
  });
});
