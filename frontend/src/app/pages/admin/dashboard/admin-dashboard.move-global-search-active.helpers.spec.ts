...
/** Golden WU admin-dashboard-move-global-search-active -- moveGlobalSearchActive. */
describe('AdminDashboardComponent moveGlobalSearchActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).moveGlobalSearchActive(0); }).not.toThrow();
  });
});
