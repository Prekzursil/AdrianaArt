...
/** Golden WU admin-dashboard-load-shipping-performance -- loadShippingPerformance. */
describe('AdminDashboardComponent loadShippingPerformance (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadShippingPerformance(); }).not.toThrow();
  });
});
