...
/** Golden WU admin-dashboard-open-recent -- openRecent. */
describe('AdminDashboardComponent openRecent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openRecent(undefined as any); }).not.toThrow();
  });
});
