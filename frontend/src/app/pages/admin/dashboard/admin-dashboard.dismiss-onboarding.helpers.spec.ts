...
/** Golden WU admin-dashboard-dismiss-onboarding -- dismissOnboarding. */
describe('AdminDashboardComponent dismissOnboarding (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).dismissOnboarding()).not.toThrow();
  });
});
