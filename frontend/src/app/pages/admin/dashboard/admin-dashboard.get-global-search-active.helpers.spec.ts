...
/** Golden WU admin-dashboard-get-global-search-active -- getGlobalSearchActive. */
describe('AdminDashboardComponent getGlobalSearchActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getGlobalSearchActive(); }).not.toThrow();
  });
});
