...
/** Golden WU admin-dashboard-retry-gdpr-export -- retryGdprExport. */
describe('AdminDashboardComponent retryGdprExport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).retryGdprExport(undefined as any); }).not.toThrow();
  });
});
