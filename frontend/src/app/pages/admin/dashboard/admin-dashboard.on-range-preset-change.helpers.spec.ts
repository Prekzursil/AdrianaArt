...
/** Golden WU admin-dashboard-on-range-preset-change -- onRangePresetChange. */
describe('AdminDashboardComponent onRangePresetChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onRangePresetChange(); }).not.toThrow();
  });
});
