...
/** Golden WU admin-dashboard-open-global-search -- openGlobalSearch. */
describe('AdminDashboardComponent openGlobalSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openGlobalSearch(); }).not.toThrow();
  });
});
