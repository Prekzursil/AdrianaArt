...
/** Golden WU admin-dashboard-load-channel-breakdown -- loadChannelBreakdown. */
describe('AdminDashboardComponent loadChannelBreakdown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadChannelBreakdown(); }).not.toThrow();
  });
});
