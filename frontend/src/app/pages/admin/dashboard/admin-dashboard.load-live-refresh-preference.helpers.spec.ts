...
/** Golden WU admin-dashboard-load-live-refresh-preference -- loadLiveRefreshPreference. */
describe('AdminDashboardComponent loadLiveRefreshPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadLiveRefreshPreference(); }).not.toThrow();
  });
});
