...
/** Golden WU admin-dashboard-select-global-search -- selectGlobalSearch. */
describe('AdminDashboardComponent selectGlobalSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectGlobalSearch(undefined as any, {} as any); }).not.toThrow();
  });
});
