...
/** Golden WU admin-dashboard-resolve-window-days -- resolveWindowDays. */
describe('AdminDashboardComponent resolveWindowDays (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resolveWindowDays(undefined as any); }).not.toThrow();
  });
});
