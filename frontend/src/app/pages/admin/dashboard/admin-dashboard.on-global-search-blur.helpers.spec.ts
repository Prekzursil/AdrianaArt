...
/** Golden WU admin-dashboard-on-global-search-blur -- onGlobalSearchBlur. */
describe('AdminDashboardComponent onGlobalSearchBlur (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onGlobalSearchBlur(); }).not.toThrow();
  });
});
