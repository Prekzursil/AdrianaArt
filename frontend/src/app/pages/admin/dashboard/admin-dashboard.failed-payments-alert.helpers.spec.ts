...
/** Golden WU admin-dashboard-failed-payments-alert -- failedPaymentsAlert. */
describe('AdminDashboardComponent failedPaymentsAlert (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).failedPaymentsAlert(); }).not.toThrow();
  });
});
