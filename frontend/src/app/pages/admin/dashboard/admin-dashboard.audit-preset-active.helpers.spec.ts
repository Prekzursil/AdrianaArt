...
/** Golden WU admin-dashboard-audit-preset-active -- auditPresetActive. */
describe('AdminDashboardComponent auditPresetActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).auditPresetActive(undefined as any); }).not.toThrow();
  });
});
