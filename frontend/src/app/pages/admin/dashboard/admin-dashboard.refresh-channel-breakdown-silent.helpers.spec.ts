...
/** Golden WU admin-dashboard-refresh-channel-breakdown-silent -- refreshChannelBreakdownSilent. */
describe('AdminDashboardComponent refreshChannelBreakdownSilent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshChannelBreakdownSilent(); }).not.toThrow();
  });
});
