...
/** Golden WU admin-dashboard-open-inventory -- openInventory. */
describe('AdminDashboardComponent openInventory (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).openInventory()).not.toThrow();
  });
});
