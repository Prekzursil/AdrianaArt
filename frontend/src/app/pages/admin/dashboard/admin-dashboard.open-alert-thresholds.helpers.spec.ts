...
/** Golden WU admin-dashboard-open-alert-thresholds -- openAlertThresholds. */
describe('AdminDashboardComponent openAlertThresholds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openAlertThresholds(); }).not.toThrow();
  });
});
