...
/** Golden WU admin-dashboard-admin-content-section-for-key -- adminContentSectionForKey. */
describe('AdminDashboardComponent adminContentSectionForKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).adminContentSectionForKey(''); }).not.toThrow();
  });
});
