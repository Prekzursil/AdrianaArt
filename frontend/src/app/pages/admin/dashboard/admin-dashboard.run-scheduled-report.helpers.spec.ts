...
/** Golden WU admin-dashboard-run-scheduled-report -- runScheduledReport. */
describe('AdminDashboardComponent runScheduledReport (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).runScheduledReport(undefined as any); }).not.toThrow();
  });
});
