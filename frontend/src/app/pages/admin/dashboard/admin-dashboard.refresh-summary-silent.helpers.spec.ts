...
/** Golden WU admin-dashboard-refresh-summary-silent -- refreshSummarySilent. */
describe('AdminDashboardComponent refreshSummarySilent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshSummarySilent(); }).not.toThrow();
  });
});
