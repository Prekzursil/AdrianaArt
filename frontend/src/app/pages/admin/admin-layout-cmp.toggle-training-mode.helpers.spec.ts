...
/** Golden WU admin-layout-cmp-toggle-training-mode -- toggleTrainingMode. */
describe('AdminLayoutComponent toggleTrainingMode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleTrainingMode({} as any); }).not.toThrow();
  });
});
