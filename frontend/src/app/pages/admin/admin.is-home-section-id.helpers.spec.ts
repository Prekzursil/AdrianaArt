...
/** Golden WU admin-is-home-section-id -- isHomeSectionId. */
describe('AdminComponent isHomeSectionId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).isHomeSectionId(undefined as any); }).not.toThrow();
  });
});
