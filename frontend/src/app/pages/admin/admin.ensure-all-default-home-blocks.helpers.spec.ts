...
/** Golden WU admin-ensure-all-default-home-blocks -- ensureAllDefaultHomeBlocks. */
describe('AdminComponent ensureAllDefaultHomeBlocks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).ensureAllDefaultHomeBlocks(undefined as any); }).not.toThrow();
  });
});
