...
/** Golden WU admin-to-preview-slides -- toPreviewSlides. */
describe('AdminComponent toPreviewSlides (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toPreviewSlides(undefined as any, undefined as any); }).not.toThrow();
  });
});
