...
/** Golden WU admin-add-page-columns-column -- addPageColumnsColumn. */
describe('AdminComponent addPageColumnsColumn (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageColumnsColumn(undefined as any, ''); }).not.toThrow();
  });
});
