...
/** Golden WU admin-ensure-page-draft -- ensurePageDraft. */
describe('AdminComponent ensurePageDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).ensurePageDraft(undefined as any); }).not.toThrow();
  });
});
