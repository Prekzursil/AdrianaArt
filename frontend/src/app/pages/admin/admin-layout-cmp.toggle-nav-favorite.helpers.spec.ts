...
/** Golden WU admin-layout-cmp-toggle-nav-favorite -- toggleNavFavorite. */
describe('AdminLayoutComponent toggleNavFavorite (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleNavFavorite(undefined as any, {} as any); }).not.toThrow();
  });
});
