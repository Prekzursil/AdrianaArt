...
/** Golden WU admin-add-home-columns-column -- addHomeColumnsColumn. */
describe('AdminComponent addHomeColumnsColumn (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addHomeColumnsColumn(''); }).not.toThrow();
  });
});
