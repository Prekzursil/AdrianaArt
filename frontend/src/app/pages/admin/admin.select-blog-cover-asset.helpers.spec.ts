...
/** Golden WU admin-select-blog-cover-asset -- selectBlogCoverAsset. */
describe('AdminComponent selectBlogCoverAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectBlogCoverAsset(undefined as any); }).not.toThrow();
  });
});
