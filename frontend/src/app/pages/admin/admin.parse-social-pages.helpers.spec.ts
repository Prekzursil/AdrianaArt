...
/** Golden WU admin-parse-social-pages -- parseSocialPages. */
describe('AdminComponent parseSocialPages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseSocialPages(undefined as any, ''); }).not.toThrow();
  });
});
