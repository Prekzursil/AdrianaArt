...
/** Golden WU admin-on-blog-image-drop -- onBlogImageDrop. */
describe('AdminComponent onBlogImageDrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onBlogImageDrop(undefined as any, {} as any); }).not.toThrow();
  });
});
