...
/** Golden WU admin-insert-reusable-block-into-page -- insertReusableBlockIntoPage. */
describe('AdminComponent insertReusableBlockIntoPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertReusableBlockIntoPage(undefined as any, ''); }).not.toThrow();
  });
});
