...
/** Golden WU admin-select-home-blocks-lang -- selectHomeBlocksLang. */
describe('AdminComponent selectHomeBlocksLang (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectHomeBlocksLang(undefined as any); }).not.toThrow();
  });
});
