...
/** Golden WU admin-insert-blog-code-block -- insertBlogCodeBlock. */
describe('AdminComponent insertBlogCodeBlock (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertBlogCodeBlock(undefined as any); }).not.toThrow();
  });
});
