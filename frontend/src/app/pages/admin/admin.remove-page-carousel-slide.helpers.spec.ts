...
/** Golden WU admin-remove-page-carousel-slide -- removePageCarouselSlide. */
describe('AdminComponent removePageCarouselSlide (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removePageCarouselSlide(undefined as any, '', 0); }).not.toThrow();
  });
});
