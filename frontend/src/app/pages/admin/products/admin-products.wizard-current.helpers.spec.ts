...
/** Golden WU admin-products-wizard-current -- wizardCurrent. */
describe('AdminProductsComponent wizardCurrent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).wizardCurrent(); }).not.toThrow();
  });
});
