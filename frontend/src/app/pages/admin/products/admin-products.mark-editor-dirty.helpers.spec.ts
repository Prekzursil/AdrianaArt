...
/** Golden WU admin-products-mark-editor-dirty -- markEditorDirty. */
describe('AdminProductsComponent markEditorDirty (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.markEditorDirty(); }).not.toThrow();
  });
});
