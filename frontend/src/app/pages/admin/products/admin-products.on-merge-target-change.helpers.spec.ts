...
/** Golden WU admin-products-on-merge-target-change -- onMergeTargetChange. */
describe('AdminProductsComponent onMergeTargetChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onMergeTargetChange(); }).not.toThrow();
  });
});
