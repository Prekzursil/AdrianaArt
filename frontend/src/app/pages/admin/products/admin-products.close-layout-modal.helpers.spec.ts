...
/** Golden WU admin-products-close-layout-modal -- closeLayoutModal. */
describe('AdminProductsComponent closeLayoutModal (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).closeLayoutModal()).not.toThrow();
  });
});
