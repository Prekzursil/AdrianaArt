...
/** Golden WU admin-products-reset-deleted-images -- resetDeletedImages. */
describe('AdminProductsComponent resetDeletedImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetDeletedImages(); }).not.toThrow();
  });
});
