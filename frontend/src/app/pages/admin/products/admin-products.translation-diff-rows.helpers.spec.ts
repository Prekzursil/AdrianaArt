...
/** Golden WU admin-products-translation-diff-rows -- translationDiffRows. */
describe('AdminProductsComponent translationDiffRows (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).translationDiffRows(); }).not.toThrow();
  });
});
