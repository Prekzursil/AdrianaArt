...
/** Golden WU admin-products-wizard-can-next -- wizardCanNext. */
describe('AdminProductsComponent wizardCanNext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).wizardCanNext(); }).not.toThrow();
  });
});
