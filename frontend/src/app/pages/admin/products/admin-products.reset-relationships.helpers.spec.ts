...
/** Golden WU admin-products-reset-relationships -- resetRelationships. */
describe('AdminProductsComponent resetRelationships (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetRelationships(); }).not.toThrow();
  });
});
