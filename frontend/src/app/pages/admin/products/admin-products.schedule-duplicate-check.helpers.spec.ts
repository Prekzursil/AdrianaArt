...
/** Golden WU admin-products-schedule-duplicate-check -- scheduleDuplicateCheck. */
describe('AdminProductsComponent scheduleDuplicateCheck (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).scheduleDuplicateCheck(); }).not.toThrow();
  });
});
