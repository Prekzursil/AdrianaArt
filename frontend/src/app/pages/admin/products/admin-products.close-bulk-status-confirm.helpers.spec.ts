...
/** Golden WU admin-products-close-bulk-status-confirm -- closeBulkStatusConfirm. */
describe('AdminProductsComponent closeBulkStatusConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closeBulkStatusConfirm()).not.toThrow();
  });
});
