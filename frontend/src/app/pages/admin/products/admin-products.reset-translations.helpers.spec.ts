...
/** Golden WU admin-products-reset-translations -- resetTranslations. */
describe('AdminProductsComponent resetTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetTranslations(); }).not.toThrow();
  });
});
