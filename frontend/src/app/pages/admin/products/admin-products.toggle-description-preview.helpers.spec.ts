...
/** Golden WU admin-products-toggle-description-preview -- toggleDescriptionPreview. */
describe('AdminProductsComponent toggleDescriptionPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleDescriptionPreview(); }).not.toThrow();
  });
});
