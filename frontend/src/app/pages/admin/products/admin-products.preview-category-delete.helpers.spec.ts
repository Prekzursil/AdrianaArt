...
/** Golden WU admin-products-preview-category-delete -- previewCategoryDelete. */
describe('AdminProductsComponent previewCategoryDelete (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).previewCategoryDelete(); }).not.toThrow();
  });
});
