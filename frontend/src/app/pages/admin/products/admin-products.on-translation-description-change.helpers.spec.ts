...
/** Golden WU admin-products-on-translation-description-change -- onTranslationDescriptionChange. */
describe('AdminProductsComponent onTranslationDescriptionChange (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onTranslationDescriptionChange('en')).not.toThrow();
  });
});
