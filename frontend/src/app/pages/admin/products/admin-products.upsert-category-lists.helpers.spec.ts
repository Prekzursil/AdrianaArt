...
/** Golden WU admin-products-upsert-category-lists -- upsertCategoryLists. */
describe('AdminProductsComponent upsertCategoryLists (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).upsertCategoryLists(undefined as any); }).not.toThrow();
  });
});
