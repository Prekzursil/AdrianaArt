...
/** Golden WU admin-products-start-publish-wizard -- startPublishWizard. */
describe('AdminProductsComponent startPublishWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startPublishWizard(); }).not.toThrow();
  });
});
