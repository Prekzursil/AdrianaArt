...
/** Golden WU admin-products-reprocess-image -- reprocessImage. */
describe('AdminProductsComponent reprocessImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).reprocessImage(); }).not.toThrow();
  });
});
