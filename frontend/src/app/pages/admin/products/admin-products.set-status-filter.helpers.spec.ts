...
/** Golden WU admin-products-set-status-filter -- setStatusFilter. */
describe('AdminProductsComponent setStatusFilter (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setStatusFilter(undefined as any); }).not.toThrow();
  });
});
