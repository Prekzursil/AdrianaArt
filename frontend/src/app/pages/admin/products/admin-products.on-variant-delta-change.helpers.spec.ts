...
/** Golden WU admin-products-on-variant-delta-change -- onVariantDeltaChange. */
describe('AdminProductsComponent onVariantDeltaChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onVariantDeltaChange(0, undefined as any); }).not.toThrow();
  });
});
