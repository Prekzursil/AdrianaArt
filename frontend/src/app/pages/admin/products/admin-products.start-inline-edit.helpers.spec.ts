...
/** Golden WU admin-products-start-inline-edit -- startInlineEdit. */
describe('AdminProductsComponent startInlineEdit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startInlineEdit(undefined as any); }).not.toThrow();
  });
});
