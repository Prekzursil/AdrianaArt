...
/** Golden WU admin-products-track-by-translation-diff-row -- trackByTranslationDiffRow. */
describe('AdminProductsComponent trackByTranslationDiffRow (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).trackByTranslationDiffRow(0, undefined as any); }).not.toThrow();
  });
});
