...
/** Golden WU admin-products-scroll-to-wizard-anchor -- scrollToWizardAnchor. */
describe('AdminProductsComponent scrollToWizardAnchor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).scrollToWizardAnchor(''); }).not.toThrow();
  });
});
