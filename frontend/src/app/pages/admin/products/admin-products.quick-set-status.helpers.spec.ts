...
/** Golden WU admin-products-quick-set-status -- quickSetStatus. */
describe('AdminProductsComponent quickSetStatus (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).quickSetStatus(undefined as any, undefined as any); }).not.toThrow();
  });
});
