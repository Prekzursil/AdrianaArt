...
/** Golden WU admin-products-reset-stock-ledger -- resetStockLedger. */
describe('AdminProductsComponent resetStockLedger (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetStockLedger(); }).not.toThrow();
  });
});
