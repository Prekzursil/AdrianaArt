...
/** Golden WU admin-products-start-create-wizard -- startCreateWizard. */
describe('AdminProductsComponent startCreateWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startCreateWizard(); }).not.toThrow();
  });
});
