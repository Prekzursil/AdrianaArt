...
/** Golden WU admin-products-update-variant -- updateVariant. */
describe('AdminProductsComponent updateVariant (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateVariant(0, undefined as any); }).not.toThrow();
  });
});
