...
/** Golden WU admin-products-publish-selected -- publishSelected. */
describe('AdminProductsComponent publishSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).publishSelected(); }).not.toThrow();
  });
});
