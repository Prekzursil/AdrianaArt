...
/** Golden WU admin-products-load-stock-adjustments -- loadStockAdjustments. */
describe('AdminProductsComponent loadStockAdjustments (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadStockAdjustments(''); }).not.toThrow();
  });
});
