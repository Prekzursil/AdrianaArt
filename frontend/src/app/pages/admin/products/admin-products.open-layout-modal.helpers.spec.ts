...
/** Golden WU admin-products-open-layout-modal -- openLayoutModal. */
describe('AdminProductsComponent openLayoutModal (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).openLayoutModal()).not.toThrow();
  });
});
