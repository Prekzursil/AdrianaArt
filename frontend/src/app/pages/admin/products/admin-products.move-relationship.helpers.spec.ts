...
/** Golden WU admin-products-move-relationship -- moveRelationship. */
describe('AdminProductsComponent moveRelationship (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).moveRelationship(undefined as any, 0, undefined as any); }).not.toThrow();
  });
});
