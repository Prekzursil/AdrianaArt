...
/** Golden WU admin-products-set-product-search-active -- setProductSearchActive. */
describe('AdminProductsComponent setProductSearchActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setProductSearchActive(0); }).not.toThrow();
  });
});
