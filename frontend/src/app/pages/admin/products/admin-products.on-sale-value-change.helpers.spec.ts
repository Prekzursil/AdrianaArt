...
/** Golden WU admin-products-on-sale-value-change -- onSaleValueChange. */
describe('AdminProductsComponent onSaleValueChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onSaleValueChange(undefined as any); }).not.toThrow();
  });
});
