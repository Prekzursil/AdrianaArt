...
/** Golden WU admin-products-on-relationship-search-change -- onRelationshipSearchChange. */
describe('AdminProductsComponent onRelationshipSearchChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onRelationshipSearchChange(undefined as any); }).not.toThrow();
  });
});
