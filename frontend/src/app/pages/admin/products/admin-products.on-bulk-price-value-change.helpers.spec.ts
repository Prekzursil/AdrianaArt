...
/** Golden WU admin-products-on-bulk-price-value-change -- onBulkPriceValueChange. */
describe('AdminProductsComponent onBulkPriceValueChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onBulkPriceValueChange(undefined as any); }).not.toThrow();
  });
});
