...
/** Golden WU admin-products-set-variants-from-product -- setVariantsFromProduct. */
describe('AdminProductsComponent setVariantsFromProduct (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setVariantsFromProduct(undefined as any); }).not.toThrow();
  });
});
