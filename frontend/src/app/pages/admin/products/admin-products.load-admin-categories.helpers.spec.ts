...
/** Golden WU admin-products-load-admin-categories -- loadAdminCategories. */
describe('AdminProductsComponent loadAdminCategories (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadAdminCategories(); }).not.toThrow();
  });
});
