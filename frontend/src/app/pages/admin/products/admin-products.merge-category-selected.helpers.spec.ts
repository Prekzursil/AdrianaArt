...
/** Golden WU admin-products-merge-category-selected -- mergeCategorySelected. */
describe('AdminProductsComponent mergeCategorySelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.mergeCategorySelected(); }).not.toThrow();
  });
});
