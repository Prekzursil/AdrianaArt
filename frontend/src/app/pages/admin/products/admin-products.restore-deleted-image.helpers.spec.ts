...
/** Golden WU admin-products-restore-deleted-image -- restoreDeletedImage. */
describe('AdminProductsComponent restoreDeletedImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).restoreDeletedImage(''); }).not.toThrow();
  });
});
