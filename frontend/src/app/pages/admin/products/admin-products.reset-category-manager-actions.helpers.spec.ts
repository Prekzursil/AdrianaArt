...
/** Golden WU admin-products-reset-category-manager-actions -- resetCategoryManagerActions. */
describe('AdminProductsComponent resetCategoryManagerActions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.resetCategoryManagerActions(); }).not.toThrow();
  });
});
