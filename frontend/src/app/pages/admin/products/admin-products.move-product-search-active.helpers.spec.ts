...
/** Golden WU admin-products-move-product-search-active -- moveProductSearchActive. */
describe('AdminProductsComponent moveProductSearchActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).moveProductSearchActive(0); }).not.toThrow();
  });
});
