...
/** Golden WU admin-products-remove-variant-row -- removeVariantRow. */
describe('AdminProductsComponent removeVariantRow (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeVariantRow(undefined as any); }).not.toThrow();
  });
});
