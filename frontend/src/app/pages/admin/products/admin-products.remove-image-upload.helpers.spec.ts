...
/** Golden WU admin-products-remove-image-upload -- removeImageUpload. */
describe('AdminProductsComponent removeImageUpload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeImageUpload(''); }).not.toThrow();
  });
});
