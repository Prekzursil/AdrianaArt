...
/** Golden WU admin-products-retry-image-upload -- retryImageUpload. */
describe('AdminProductsComponent retryImageUpload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).retryImageUpload(''); }).not.toThrow();
  });
});
