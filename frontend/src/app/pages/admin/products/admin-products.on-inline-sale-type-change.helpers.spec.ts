...
/** Golden WU admin-products-on-inline-sale-type-change -- onInlineSaleTypeChange. */
describe('AdminProductsComponent onInlineSaleTypeChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onInlineSaleTypeChange(); }).not.toThrow();
  });
});
