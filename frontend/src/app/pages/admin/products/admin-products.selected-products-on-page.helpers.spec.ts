...
/** Golden WU admin-products-selected-products-on-page -- selectedProductsOnPage. */
describe('AdminProductsComponent selectedProductsOnPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectedProductsOnPage(); }).not.toThrow();
  });
});
