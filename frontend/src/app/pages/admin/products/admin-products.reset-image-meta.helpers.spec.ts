...
/** Golden WU admin-products-reset-image-meta -- resetImageMeta. */
describe('AdminProductsComponent resetImageMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetImageMeta(); }).not.toThrow();
  });
});
