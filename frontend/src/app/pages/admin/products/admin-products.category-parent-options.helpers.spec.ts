...
/** Golden WU admin-products-category-parent-options -- categoryParentOptions. */
describe('AdminProductsComponent categoryParentOptions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).categoryParentOptions(undefined as any); }).not.toThrow();
  });
});
