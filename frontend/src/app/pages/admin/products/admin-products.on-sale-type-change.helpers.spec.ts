...
/** Golden WU admin-products-on-sale-type-change -- onSaleTypeChange. */
describe('AdminProductsComponent onSaleTypeChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onSaleTypeChange(); }).not.toThrow();
  });
});
