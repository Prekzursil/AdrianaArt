...
/** Golden WU admin-products-on-inline-stock-change -- onInlineStockChange. */
describe('AdminProductsComponent onInlineStockChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onInlineStockChange(undefined as any); }).not.toThrow();
  });
});
