...
/** Golden WU admin-products-maybe-start-image-upload -- maybeStartImageUpload. */
describe('AdminProductsComponent maybeStartImageUpload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).maybeStartImageUpload(); }).not.toThrow();
  });
});
