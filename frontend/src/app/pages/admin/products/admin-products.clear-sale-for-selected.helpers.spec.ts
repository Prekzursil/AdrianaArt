...
/** Golden WU admin-products-clear-sale-for-selected -- clearSaleForSelected. */
describe('AdminProductsComponent clearSaleForSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).clearSaleForSelected()).not.toThrow();
  });
});
