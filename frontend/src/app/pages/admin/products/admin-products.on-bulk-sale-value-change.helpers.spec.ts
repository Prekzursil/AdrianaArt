...
/** Golden WU admin-products-on-bulk-sale-value-change -- onBulkSaleValueChange. */
describe('AdminProductsComponent onBulkSaleValueChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onBulkSaleValueChange(undefined as any); }).not.toThrow();
  });
});
