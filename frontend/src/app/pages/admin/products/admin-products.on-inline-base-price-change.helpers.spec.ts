...
/** Golden WU admin-products-on-inline-base-price-change -- onInlineBasePriceChange. */
describe('AdminProductsComponent onInlineBasePriceChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onInlineBasePriceChange(undefined as any); }).not.toThrow();
  });
});
