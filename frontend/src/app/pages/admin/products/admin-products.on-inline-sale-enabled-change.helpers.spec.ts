...
/** Golden WU admin-products-on-inline-sale-enabled-change -- onInlineSaleEnabledChange. */
describe('AdminProductsComponent onInlineSaleEnabledChange (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onInlineSaleEnabledChange()).not.toThrow();
  });
});
