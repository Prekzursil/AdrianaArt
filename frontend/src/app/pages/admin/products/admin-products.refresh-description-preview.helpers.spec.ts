...
/** Golden WU admin-products-refresh-description-preview -- refreshDescriptionPreview. */
describe('AdminProductsComponent refreshDescriptionPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshDescriptionPreview(); }).not.toThrow();
  });
});
