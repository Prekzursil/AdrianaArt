...
/** Golden WU admin-products-download-categories-csv -- downloadCategoriesCsv. */
describe('AdminProductsComponent downloadCategoriesCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).downloadCategoriesCsv(false); }).not.toThrow();
  });
});
