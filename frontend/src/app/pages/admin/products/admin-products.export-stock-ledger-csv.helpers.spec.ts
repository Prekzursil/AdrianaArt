...
/** Golden WU admin-products-export-stock-ledger-csv -- exportStockLedgerCsv. */
describe('AdminProductsComponent exportStockLedgerCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.exportStockLedgerCsv(); }).not.toThrow();
  });
});
