...
/** Golden WU admin-products-download-blob -- downloadBlob. */
describe('AdminProductsComponent downloadBlob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).downloadBlob(null as any, '')).not.toThrow();
  });
});