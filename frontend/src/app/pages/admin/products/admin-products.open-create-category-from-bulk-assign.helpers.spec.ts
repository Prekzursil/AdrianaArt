...
/** Golden WU admin-products-open-create-category-from-bulk-assign -- openCreateCategoryFromBulkAssign. */
describe('AdminProductsComponent openCreateCategoryFromBulkAssign (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.openCreateCategoryFromBulkAssign(); }).not.toThrow();
  });
});
