...
/** Golden WU admin-products-save-image-meta -- saveImageMeta. */
describe('AdminProductsComponent saveImageMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveImageMeta(); }).not.toThrow();
  });
});
