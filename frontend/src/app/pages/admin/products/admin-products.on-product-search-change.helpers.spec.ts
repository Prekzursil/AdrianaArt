...
/** Golden WU admin-products-on-product-search-change -- onProductSearchChange. */
describe('AdminProductsComponent onProductSearchChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onProductSearchChange(); }).not.toThrow();
  });
});
