...
/** Golden WU admin-products-apply-category-to-selected -- applyCategoryToSelected. */
describe('AdminProductsComponent applyCategoryToSelected (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyCategoryToSelected()).not.toThrow();
  });
});
