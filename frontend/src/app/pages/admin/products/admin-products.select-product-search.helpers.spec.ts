...
/** Golden WU admin-products-select-product-search -- selectProductSearch. */
describe('AdminProductsComponent selectProductSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectProductSearch(undefined as any, {} as any); }).not.toThrow();
  });
});
