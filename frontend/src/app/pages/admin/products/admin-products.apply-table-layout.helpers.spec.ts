...
/** Golden WU admin-products-apply-table-layout -- applyTableLayout. */
describe('AdminProductsComponent applyTableLayout (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyTableLayout(null as any)).not.toThrow();
  });
});
