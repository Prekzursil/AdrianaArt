...
/** Golden WU admin-products-apply-price-adjustment-to-selected -- applyPriceAdjustmentToSelected. */
describe('AdminProductsComponent applyPriceAdjustmentToSelected (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyPriceAdjustmentToSelected()).not.toThrow();
  });
});
