...
/** Golden WU admin-products-open-product-search -- openProductSearch. */
describe('AdminProductsComponent openProductSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openProductSearch(); }).not.toThrow();
  });
});
