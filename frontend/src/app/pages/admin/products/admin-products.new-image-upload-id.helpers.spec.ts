...
/** Golden WU admin-products-new-image-upload-id -- newImageUploadId. */
describe('AdminProductsComponent newImageUploadId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).newImageUploadId(); }).not.toThrow();
  });
});
