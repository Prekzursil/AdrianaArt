...
/** Golden WU admin-products-set-bulk-price-mode -- setBulkPriceMode. */
describe('AdminProductsComponent setBulkPriceMode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setBulkPriceMode(undefined as any); }).not.toThrow();
  });
});
