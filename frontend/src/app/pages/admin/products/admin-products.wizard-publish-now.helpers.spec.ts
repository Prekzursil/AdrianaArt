...
/** Golden WU admin-products-wizard-publish-now -- wizardPublishNow. */
describe('AdminProductsComponent wizardPublishNow (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).wizardPublishNow(); }).not.toThrow();
  });
});
