...
/** Golden WU admin-products-confirm-bulk-status-change -- confirmBulkStatusChange. */
describe('AdminProductsComponent confirmBulkStatusChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.confirmBulkStatusChange(); }).not.toThrow();
  });
});
