...
/** Golden WU admin-products-set-bulk-price-direction -- setBulkPriceDirection. */
describe('AdminProductsComponent setBulkPriceDirection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setBulkPriceDirection(undefined as any); }).not.toThrow();
  });
});
