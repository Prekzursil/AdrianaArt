...
/** Golden WU admin-products-visible-column-ids -- visibleColumnIds. */
describe('AdminProductsComponent visibleColumnIds (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).visibleColumnIds(); }).not.toThrow();
  });
});
