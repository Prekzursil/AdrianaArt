...
/** Golden WU admin-products-save-category-manager-parent -- saveCategoryManagerParent. */
describe('AdminProductsComponent saveCategoryManagerParent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveCategoryManagerParent(); }).not.toThrow();
  });
});
