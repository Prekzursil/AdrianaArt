...
/** Golden WU admin-products-close-status-confirm -- closeStatusConfirm. */
describe('AdminProductsComponent closeStatusConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closeStatusConfirm()).not.toThrow();
  });
});
