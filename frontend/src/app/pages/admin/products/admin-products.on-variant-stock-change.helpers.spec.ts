...
/** Golden WU admin-products-on-variant-stock-change -- onVariantStockChange. */
describe('AdminProductsComponent onVariantStockChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onVariantStockChange(0, undefined as any); }).not.toThrow();
  });
});
