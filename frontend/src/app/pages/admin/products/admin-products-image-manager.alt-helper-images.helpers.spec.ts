...
/** Golden WU admin-products-image-manager-alt-helper-images -- altHelperImages. */
describe('AdminProductsImageManagerComponent altHelperImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.altHelperImages(); }).not.toThrow();
  });
});
