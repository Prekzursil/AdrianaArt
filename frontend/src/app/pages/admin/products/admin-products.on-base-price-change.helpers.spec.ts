...
/** Golden WU admin-products-on-base-price-change -- onBasePriceChange. */
describe('AdminProductsComponent onBasePriceChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onBasePriceChange(undefined as any); }).not.toThrow();
  });
});
