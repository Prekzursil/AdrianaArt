...
/** Golden WU admin-products-on-category-manager-select -- onCategoryManagerSelect. */
describe('AdminProductsComponent onCategoryManagerSelect (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onCategoryManagerSelect(''); }).not.toThrow();
  });
});
