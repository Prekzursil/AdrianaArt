...
/** Golden WU admin-products-reset-category-manager-parent -- resetCategoryManagerParent. */
describe('AdminProductsComponent resetCategoryManagerParent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.resetCategoryManagerParent(); }).not.toThrow();
  });
});
