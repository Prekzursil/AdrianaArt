...
/** Golden WU admin-products-on-inline-sale-value-change -- onInlineSaleValueChange. */
describe('AdminProductsComponent onInlineSaleValueChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onInlineSaleValueChange(undefined as any); }).not.toThrow();
  });
});
