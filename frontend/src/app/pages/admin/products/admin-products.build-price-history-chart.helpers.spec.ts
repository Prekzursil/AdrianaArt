...
/** Golden WU admin-products-build-price-history-chart -- buildPriceHistoryChart. */
describe('AdminProductsComponent buildPriceHistoryChart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).buildPriceHistoryChart({} as any); }).not.toThrow();
  });
});
