...
/** Golden WU admin-products-on-description-change -- onDescriptionChange. */
describe('AdminProductsComponent onDescriptionChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onDescriptionChange(); }).not.toThrow();
  });
});
