...
/** Golden WU admin-products-on-sku-change -- onSkuChange. */
describe('AdminProductsComponent onSkuChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onSkuChange(undefined as any); }).not.toThrow();
  });
});
