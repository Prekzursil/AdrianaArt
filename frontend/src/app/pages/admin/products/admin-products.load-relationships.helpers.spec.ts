...
/** Golden WU admin-products-load-relationships -- loadRelationships. */
describe('AdminProductsComponent loadRelationships (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadRelationships(''); }).not.toThrow();
  });
});
