...
/** Golden WU admin-products-toggle-translation-preview -- toggleTranslationPreview. */
describe('AdminProductsComponent toggleTranslationPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleTranslationPreview(undefined as any); }).not.toThrow();
  });
});
