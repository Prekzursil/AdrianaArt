...
/** Golden WU admin-products-update-image-upload -- updateImageUpload. */
describe('AdminProductsComponent updateImageUpload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).updateImageUpload('', null as any)).not.toThrow();
  });
});