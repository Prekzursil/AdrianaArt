...
/** Golden WU admin-products-remove-relationship -- removeRelationship. */
describe('AdminProductsComponent removeRelationship (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeRelationship('', undefined as any); }).not.toThrow();
  });
});
