...
/** Golden WU admin-products-clear-unpublish-schedule-for-selected -- clearUnpublishScheduleForSelected. */
describe('AdminProductsComponent clearUnpublishScheduleForSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).clearUnpublishScheduleForSelected()).not.toThrow();
  });
});
