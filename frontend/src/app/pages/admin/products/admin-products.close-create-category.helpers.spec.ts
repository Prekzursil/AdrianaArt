...
/** Golden WU admin-products-close-create-category -- closeCreateCategory. */
describe('AdminProductsComponent closeCreateCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closeCreateCategory()).not.toThrow();
  });
});
