...
/** Golden WU admin-products-reset-image-uploads -- resetImageUploads. */
describe('AdminProductsComponent resetImageUploads (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetImageUploads(); }).not.toThrow();
  });
});
