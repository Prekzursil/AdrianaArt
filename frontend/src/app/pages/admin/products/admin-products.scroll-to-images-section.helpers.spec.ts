...
/** Golden WU admin-products-scroll-to-images-section -- scrollToImagesSection. */
describe('AdminProductsComponent scrollToImagesSection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).scrollToImagesSection(); }).not.toThrow();
  });
});
