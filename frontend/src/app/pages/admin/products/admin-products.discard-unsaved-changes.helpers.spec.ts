...
/** Golden WU admin-products-discard-unsaved-changes -- discardUnsavedChanges. */
describe('AdminProductsComponent discardUnsavedChanges (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.discardUnsavedChanges(); }).not.toThrow();
  });
});
