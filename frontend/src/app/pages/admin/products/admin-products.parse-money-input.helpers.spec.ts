...
/** Golden WU admin-products-parse-money-input -- parseMoneyInput. */
describe('AdminProductsComponent parseMoneyInput (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseMoneyInput(''); }).not.toThrow();
  });
});
