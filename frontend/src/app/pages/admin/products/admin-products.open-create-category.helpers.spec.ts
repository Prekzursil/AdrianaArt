...
/** Golden WU admin-products-open-create-category -- openCreateCategory. */
describe('AdminProductsComponent openCreateCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openCreateCategory(undefined as any); }).not.toThrow();
  });
});
