...
/** Golden WU admin-products-run-relationship-search -- runRelationshipSearch. */
describe('AdminProductsComponent runRelationshipSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).runRelationshipSearch(''); }).not.toThrow();
  });
});
