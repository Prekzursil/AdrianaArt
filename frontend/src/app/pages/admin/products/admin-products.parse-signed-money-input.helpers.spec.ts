...
/** Golden WU admin-products-parse-signed-money-input -- parseSignedMoneyInput. */
describe('AdminProductsComponent parseSignedMoneyInput (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseSignedMoneyInput(''); }).not.toThrow();
  });
});
