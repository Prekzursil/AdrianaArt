...
/** Golden WU admin-products-open-pending-editor -- openPendingEditor. */
describe('AdminProductsComponent openPendingEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openPendingEditor(); }).not.toThrow();
  });
});
