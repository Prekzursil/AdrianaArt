...
/** Golden WU admin-products-build-short-description -- buildShortDescription. */
describe('AdminProductsComponent buildShortDescription (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).buildShortDescription()).not.toThrow();
  });
});
