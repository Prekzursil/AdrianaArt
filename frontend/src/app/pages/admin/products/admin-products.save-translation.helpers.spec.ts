...
/** Golden WU admin-products-save-translation -- saveTranslation. */
describe('AdminProductsComponent saveTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveTranslation(undefined as any); }).not.toThrow();
  });
});
