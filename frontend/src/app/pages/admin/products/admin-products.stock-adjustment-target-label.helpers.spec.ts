...
/** Golden WU admin-products-stock-adjustment-target-label -- stockAdjustmentTargetLabel. */
describe('AdminProductsComponent stockAdjustmentTargetLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).stockAdjustmentTargetLabel(undefined as any); }).not.toThrow();
  });
});
