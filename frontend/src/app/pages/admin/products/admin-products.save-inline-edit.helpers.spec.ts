...
/** Golden WU admin-products-save-inline-edit -- saveInlineEdit. */
describe('AdminProductsComponent saveInlineEdit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveInlineEdit(); }).not.toThrow();
  });
});
