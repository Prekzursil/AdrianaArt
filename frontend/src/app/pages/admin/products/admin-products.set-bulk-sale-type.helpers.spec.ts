...
/** Golden WU admin-products-set-bulk-sale-type -- setBulkSaleType. */
describe('AdminProductsComponent setBulkSaleType (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setBulkSaleType(undefined as any); }).not.toThrow();
  });
});
