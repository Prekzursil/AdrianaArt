...
/** Golden WU admin-products-toggle-current-view-pin -- toggleCurrentViewPin. */
describe('AdminProductsComponent toggleCurrentViewPin (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleCurrentViewPin(); }).not.toThrow();
  });
});
