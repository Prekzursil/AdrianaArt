...
/** Golden WU admin-products-load-translations -- loadTranslations. */
describe('AdminProductsComponent loadTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadTranslations(''); }).not.toThrow();
  });
});
