...
/** Golden WU admin-products-cancel-inline-edit -- cancelInlineEdit. */
describe('AdminProductsComponent cancelInlineEdit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).cancelInlineEdit()).not.toThrow();
  });
});
