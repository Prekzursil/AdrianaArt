...
/** Golden WU admin-products-export-products-csv -- exportProductsCsv. */
describe('AdminProductsComponent exportProductsCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.exportProductsCsv(); }).not.toThrow();
  });
});
