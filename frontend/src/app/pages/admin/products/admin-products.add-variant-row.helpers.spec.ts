...
/** Golden WU admin-products-add-variant-row -- addVariantRow. */
describe('AdminProductsComponent addVariantRow (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).addVariantRow()).not.toThrow();
  });
});
