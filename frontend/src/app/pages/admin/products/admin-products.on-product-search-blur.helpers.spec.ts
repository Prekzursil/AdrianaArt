...
/** Golden WU admin-products-on-product-search-blur -- onProductSearchBlur. */
describe('AdminProductsComponent onProductSearchBlur (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.onProductSearchBlur(); }).not.toThrow();
  });
});
