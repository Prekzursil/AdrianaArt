...
/** Golden WU admin-products-open-create-category-from-manager -- openCreateCategoryFromManager. */
describe('AdminProductsComponent openCreateCategoryFromManager (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.openCreateCategoryFromManager(); }).not.toThrow();
  });
});
