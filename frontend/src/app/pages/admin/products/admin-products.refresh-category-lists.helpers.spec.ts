...
/** Golden WU admin-products-refresh-category-lists -- refreshCategoryLists. */
describe('AdminProductsComponent refreshCategoryLists (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshCategoryLists(); }).not.toThrow();
  });
});
