...
/** Golden WU admin-products-preview-category-merge -- previewCategoryMerge. */
describe('AdminProductsComponent previewCategoryMerge (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).previewCategoryMerge(); }).not.toThrow();
  });
});
