...
/** Golden WU admin-products-on-category-import-file-change -- onCategoryImportFileChange. */
describe('AdminProductsComponent onCategoryImportFileChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onCategoryImportFileChange({} as any); }).not.toThrow();
  });
});
