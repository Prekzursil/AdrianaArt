...
/** Golden WU admin-products-on-sale-enabled-change -- onSaleEnabledChange. */
describe('AdminProductsComponent onSaleEnabledChange (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onSaleEnabledChange()).not.toThrow();
  });
});
