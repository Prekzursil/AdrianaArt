...
/** Golden WU admin-products-get-product-search-active -- getProductSearchActive. */
describe('AdminProductsComponent getProductSearchActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getProductSearchActive(); }).not.toThrow();
  });
});
