...
/** Golden WU admin-products-toggle-select-all -- toggleSelectAll. */
describe('AdminProductsComponent toggleSelectAll (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleSelectAll({} as any); }).not.toThrow();
  });
});
