...
/** Golden WU admin-products-maybe-apply-filters-from-state -- maybeApplyFiltersFromState. */
describe('AdminProductsComponent maybeApplyFiltersFromState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).maybeApplyFiltersFromState(undefined as any); }).not.toThrow();
  });
});
