...
/** Golden WU admin-products-load-deleted-images -- loadDeletedImages. */
describe('AdminProductsComponent loadDeletedImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadDeletedImages(''); }).not.toThrow();
  });
});
