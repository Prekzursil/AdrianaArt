...
/** Golden WU admin-products-load-categories -- loadCategories. */
describe('AdminProductsComponent loadCategories (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadCategories(); }).not.toThrow();
  });
});
