...
/** Golden WU admin-products-open-status-confirm -- openStatusConfirm. */
describe('AdminProductsComponent openStatusConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openStatusConfirm(); }).not.toThrow();
  });
});
