...
/** Golden WU admin-products-schedule-product-filters-apply -- scheduleProductFiltersApply. */
describe('AdminProductsComponent scheduleProductFiltersApply (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.scheduleProductFiltersApply(); }).not.toThrow();
  });
});
