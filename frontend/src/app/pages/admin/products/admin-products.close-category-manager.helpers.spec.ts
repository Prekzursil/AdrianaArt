...
/** Golden WU admin-products-close-category-manager -- closeCategoryManager. */
describe('AdminProductsComponent closeCategoryManager (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closeCategoryManager()).not.toThrow();
  });
});
