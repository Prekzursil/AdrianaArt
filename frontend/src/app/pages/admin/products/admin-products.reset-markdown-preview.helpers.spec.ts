...
/** Golden WU admin-products-reset-markdown-preview -- resetMarkdownPreview. */
describe('AdminProductsComponent resetMarkdownPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetMarkdownPreview(); }).not.toThrow();
  });
});
