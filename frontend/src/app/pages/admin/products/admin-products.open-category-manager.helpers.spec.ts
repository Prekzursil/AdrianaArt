...
/** Golden WU admin-products-open-category-manager -- openCategoryManager. */
describe('AdminProductsComponent openCategoryManager (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.openCategoryManager(); }).not.toThrow();
  });
});
