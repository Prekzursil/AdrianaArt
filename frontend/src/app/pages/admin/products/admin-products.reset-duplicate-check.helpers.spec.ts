...
/** Golden WU admin-products-reset-duplicate-check -- resetDuplicateCheck. */
describe('AdminProductsComponent resetDuplicateCheck (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetDuplicateCheck(); }).not.toThrow();
  });
});
