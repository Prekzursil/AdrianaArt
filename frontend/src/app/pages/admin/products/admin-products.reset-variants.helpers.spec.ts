...
/** Golden WU admin-products-reset-variants -- resetVariants. */
describe('AdminProductsComponent resetVariants (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetVariants(); }).not.toThrow();
  });
});
