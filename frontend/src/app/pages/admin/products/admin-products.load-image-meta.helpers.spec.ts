...
/** Golden WU admin-products-load-image-meta -- loadImageMeta. */
describe('AdminProductsComponent loadImageMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadImageMeta('', '')).not.toThrow();
  });
});