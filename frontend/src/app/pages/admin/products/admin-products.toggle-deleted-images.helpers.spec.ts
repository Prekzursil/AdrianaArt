...
/** Golden WU admin-products-toggle-deleted-images -- toggleDeletedImages. */
describe('AdminProductsComponent toggleDeletedImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleDeletedImages(); }).not.toThrow();
  });
});
