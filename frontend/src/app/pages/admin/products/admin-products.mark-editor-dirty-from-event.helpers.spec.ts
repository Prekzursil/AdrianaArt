...
/** Golden WU admin-products-mark-editor-dirty-from-event -- markEditorDirtyFromEvent. */
describe('AdminProductsComponent markEditorDirtyFromEvent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).markEditorDirtyFromEvent({} as any); }).not.toThrow();
  });
});
