...
/** Golden WU admin-products-refresh-translation-preview -- refreshTranslationPreview. */
describe('AdminProductsComponent refreshTranslationPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshTranslationPreview(undefined as any); }).not.toThrow();
  });
});
