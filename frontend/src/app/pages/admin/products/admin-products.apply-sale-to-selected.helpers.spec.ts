...
/** Golden WU admin-products-apply-sale-to-selected -- applySaleToSelected. */
describe('AdminProductsComponent applySaleToSelected (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applySaleToSelected()).not.toThrow();
  });
});
