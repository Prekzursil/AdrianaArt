...
/** Golden WU admin-products-make-image-primary -- makeImagePrimary. */
describe('AdminProductsComponent makeImagePrimary (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).makeImagePrimary('' as any)).not.toThrow();
  });
});
