...
/** Golden WU admin-products-save-relationships -- saveRelationships. */
describe('AdminProductsComponent saveRelationships (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveRelationships(); }).not.toThrow();
  });
});
