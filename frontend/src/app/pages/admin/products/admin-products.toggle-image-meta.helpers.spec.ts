...
/** Golden WU admin-products-toggle-image-meta -- toggleImageMeta. */
describe('AdminProductsComponent toggleImageMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleImageMeta(''); }).not.toThrow();
  });
});
