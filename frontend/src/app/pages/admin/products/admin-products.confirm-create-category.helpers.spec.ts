...
/** Golden WU admin-products-confirm-create-category -- confirmCreateCategory. */
describe('AdminProductsComponent confirmCreateCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.confirmCreateCategory(); }).not.toThrow();
  });
});
