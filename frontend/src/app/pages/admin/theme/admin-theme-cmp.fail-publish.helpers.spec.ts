...
/** Golden WU admin-theme-cmp-fail-publish -- failPublish. */
describe('AdminThemeComponent failPublish (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).failPublish(undefined as any); }).not.toThrow();
  });
});
