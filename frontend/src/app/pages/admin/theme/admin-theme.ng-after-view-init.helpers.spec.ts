...
/** Golden WU admin-theme-ng-after-view-init -- ngAfterViewInit. */
describe('AdminThemeComponent ngAfterViewInit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).ngAfterViewInit()).not.toThrow();
  });
});
