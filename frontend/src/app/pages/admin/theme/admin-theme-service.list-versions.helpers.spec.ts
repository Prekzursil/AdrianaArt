...
/** Golden WU admin-theme-service-list-versions -- listVersions. */
describe('AdminThemeService listVersions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(AdminThemeService.prototype) as AdminThemeService;
    ...
    expect(() => { cmp.listVersions(); }).not.toThrow();
  });
});
