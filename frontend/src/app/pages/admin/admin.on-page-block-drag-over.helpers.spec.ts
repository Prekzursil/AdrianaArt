...
/** Golden WU admin-on-page-block-drag-over -- onPageBlockDragOver. */
describe('AdminComponent onPageBlockDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlockDragOver({} as any); }).not.toThrow();
  });
});
