...
/** Golden WU admin-add-page-testimonial -- addPageTestimonial. */
describe('AdminComponent addPageTestimonial (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageTestimonial(undefined as any, ''); }).not.toThrow();
  });
});
