...
/** Golden WU admin-move-page-carousel-slide -- movePageCarouselSlide. */
describe('AdminComponent movePageCarouselSlide (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).movePageCarouselSlide(undefined as any, '', 0, 0); }).not.toThrow();
  });
});
