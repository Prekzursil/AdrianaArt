...
/** Golden WU admin-default-navigation-form -- defaultNavigationForm. */
describe('AdminComponent defaultNavigationForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).defaultNavigationForm(); }).not.toThrow();
  });
});
