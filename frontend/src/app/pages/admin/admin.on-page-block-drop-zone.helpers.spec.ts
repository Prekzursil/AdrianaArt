...
/** Golden WU admin-on-page-block-drop-zone -- onPageBlockDropZone. */
describe('AdminComponent onPageBlockDropZone (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlockDropZone({} as any, undefined as any, 0); }).not.toThrow();
  });
});
