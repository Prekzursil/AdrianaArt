...
/** Golden WU admin-parse-navigation-links -- parseNavigationLinks. */
describe('AdminComponent parseNavigationLinks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseNavigationLinks(undefined as any); }).not.toThrow();
  });
});
