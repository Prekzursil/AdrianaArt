...
/** Golden WU admin-toggle-page-block-enabled -- togglePageBlockEnabled. */
describe('AdminComponent togglePageBlockEnabled (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).togglePageBlockEnabled(undefined as any, '', {} as any); }).not.toThrow();
  });
});
