...
/** Golden WU admin-blank-category-translation -- blankCategoryTranslation. */
describe('AdminComponent blankCategoryTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).blankCategoryTranslation(); }).not.toThrow();
  });
});
