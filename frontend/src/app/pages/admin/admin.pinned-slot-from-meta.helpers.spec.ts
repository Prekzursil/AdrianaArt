...
/** Golden WU admin-pinned-slot-from-meta -- pinnedSlotFromMeta. */
describe('AdminComponent pinnedSlotFromMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pinnedSlotFromMeta(undefined as any); }).not.toThrow();
  });
});
