...
/** Golden WU admin-generate-blog-preview-link -- generateBlogPreviewLink. */
describe('AdminComponent generateBlogPreviewLink (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).generateBlogPreviewLink(); }).not.toThrow();
  });
});
