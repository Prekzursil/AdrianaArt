...
/** Golden WU admin-sync-blog-meta-to-form -- syncBlogMetaToForm. */
describe('AdminComponent syncBlogMetaToForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).syncBlogMetaToForm(undefined as any); }).not.toThrow();
  });
});
