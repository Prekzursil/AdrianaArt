...
/** Golden WU admin-on-home-block-drop -- onHomeBlockDrop. */
describe('AdminComponent onHomeBlockDrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onHomeBlockDrop({} as any, ''); }).not.toThrow();
  });
});
