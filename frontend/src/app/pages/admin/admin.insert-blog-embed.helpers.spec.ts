...
/** Golden WU admin-insert-blog-embed -- insertBlogEmbed. */
describe('AdminComponent insertBlogEmbed (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertBlogEmbed(undefined as any, undefined as any); }).not.toThrow();
  });
});
