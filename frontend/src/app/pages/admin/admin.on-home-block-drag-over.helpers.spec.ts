...
/** Golden WU admin-on-home-block-drag-over -- onHomeBlockDragOver. */
describe('AdminComponent onHomeBlockDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onHomeBlockDragOver({} as any); }).not.toThrow();
  });
});
