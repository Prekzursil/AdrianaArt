...
/** Golden WU admin-update-category-low-stock-threshold -- updateCategoryLowStockThreshold. */
describe('AdminComponent updateCategoryLowStockThreshold (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateCategoryLowStockThreshold(undefined as any, undefined as any); }).not.toThrow();
  });
});
