...
/** Golden WU admin-last-uploaded-content-image -- lastUploadedContentImage. */
describe('AdminComponent lastUploadedContentImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).lastUploadedContentImage(undefined as any); }).not.toThrow();
  });
});
