...
/** Golden WU admin-select-seo-lang -- selectSeoLang. */
describe('AdminComponent selectSeoLang (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectSeoLang(undefined as any); }).not.toThrow();
  });
});
