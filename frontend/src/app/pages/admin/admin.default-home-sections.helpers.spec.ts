...
/** Golden WU admin-default-home-sections -- defaultHomeSections. */
describe('AdminComponent defaultHomeSections (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).defaultHomeSections(); }).not.toThrow();
  });
});
