...
/** Golden WU admin-move-page-block -- movePageBlock. */
describe('AdminComponent movePageBlock (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).movePageBlock(undefined as any, '', 0); }).not.toThrow();
  });
});
