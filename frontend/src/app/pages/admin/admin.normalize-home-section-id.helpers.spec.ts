...
/** Golden WU admin-normalize-home-section-id -- normalizeHomeSectionId. */
describe('AdminComponent normalizeHomeSectionId (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).normalizeHomeSectionId(undefined as any); }).not.toThrow();
  });
});
