...
/** Golden WU admin-to-carousel-settings-draft -- toCarouselSettingsDraft. */
describe('AdminComponent toCarouselSettingsDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toCarouselSettingsDraft(undefined as any); }).not.toThrow();
  });
});
