...
/** Golden WU admin-set-page-insert-drag-active -- setPageInsertDragActive. */
describe('AdminComponent setPageInsertDragActive (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPageInsertDragActive(false); }).not.toThrow();
  });
});
