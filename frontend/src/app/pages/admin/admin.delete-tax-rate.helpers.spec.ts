...
/** Golden WU admin-delete-tax-rate -- deleteTaxRate. */
describe('AdminComponent deleteTaxRate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteTaxRate(undefined as any, ''); }).not.toThrow();
  });
});
