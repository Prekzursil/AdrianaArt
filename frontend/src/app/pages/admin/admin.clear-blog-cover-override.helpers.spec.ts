...
/** Golden WU admin-clear-blog-cover-override -- clearBlogCoverOverride. */
describe('AdminComponent clearBlogCoverOverride (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).clearBlogCoverOverride()).not.toThrow();
  });
});
