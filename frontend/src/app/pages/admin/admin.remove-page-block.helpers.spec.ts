...
/** Golden WU admin-remove-page-block -- removePageBlock. */
describe('AdminComponent removePageBlock (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removePageBlock(undefined as any, ''); }).not.toThrow();
  });
});
