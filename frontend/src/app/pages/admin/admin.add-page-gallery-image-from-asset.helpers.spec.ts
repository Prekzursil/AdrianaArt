...
/** Golden WU admin-add-page-gallery-image-from-asset -- addPageGalleryImageFromAsset. */
describe('AdminComponent addPageGalleryImageFromAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageGalleryImageFromAsset(undefined as any, '', undefined as any); }).not.toThrow();
  });
});
