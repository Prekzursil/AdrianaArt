...
/** Golden WU admin-insert-page-block-at -- insertPageBlockAt. */
describe('AdminComponent insertPageBlockAt (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertPageBlockAt(undefined as any, undefined as any, 0, undefined as any); }).not.toThrow();
  });
});
