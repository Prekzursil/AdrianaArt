...
/** Golden WU admin-upload-and-insert-blog-image -- uploadAndInsertBlogImage. */
describe('AdminComponent uploadAndInsertBlogImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadAndInsertBlogImage(undefined as any, {} as any); }).not.toThrow();
  });
});
