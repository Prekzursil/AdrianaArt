...
/** Golden WU admin-toggle-category-translations -- toggleCategoryTranslations. */
describe('AdminComponent toggleCategoryTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleCategoryTranslations(''); }).not.toThrow();
  });
});
