...
/** Golden WU admin-wrap-blog-selection -- wrapBlogSelection. */
describe('AdminComponent wrapBlogSelection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).wrapBlogSelection(undefined as any, '', '', ''); }).not.toThrow();
  });
});
