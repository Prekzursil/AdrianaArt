...
/** Golden WU admin-set-page-carousel-slide-image -- setPageCarouselSlideImage. */
describe('AdminComponent setPageCarouselSlideImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPageCarouselSlideImage(undefined as any, '', 0, undefined as any); }).not.toThrow();
  });
});
