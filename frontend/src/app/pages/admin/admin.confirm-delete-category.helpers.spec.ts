...
/** Golden WU admin-confirm-delete-category -- confirmDeleteCategory. */
describe('AdminComponent confirmDeleteCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).confirmDeleteCategory(); }).not.toThrow();
  });
});
