...
/** Golden WU admin-page-publish-checklist-block-label -- pagePublishChecklistBlockLabel. */
describe('AdminComponent pagePublishChecklistBlockLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pagePublishChecklistBlockLabel(undefined as any, 0); }).not.toThrow();
  });
});
