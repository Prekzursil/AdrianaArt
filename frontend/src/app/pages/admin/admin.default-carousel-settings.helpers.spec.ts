...
/** Golden WU admin-default-carousel-settings -- defaultCarouselSettings. */
describe('AdminComponent defaultCarouselSettings (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).defaultCarouselSettings(); }).not.toThrow();
  });
});
