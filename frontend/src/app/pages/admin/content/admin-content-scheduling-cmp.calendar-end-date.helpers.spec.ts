...
/** Golden WU admin-content-scheduling-cmp-calendar-end-date -- calendarEndDate. */
describe('AdminContentSchedulingComponent calendarEndDate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).calendarEndDate(); }).not.toThrow();
  });
});
