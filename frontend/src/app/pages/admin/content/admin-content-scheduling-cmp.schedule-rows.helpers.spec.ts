...
/** Golden WU admin-content-scheduling-cmp-schedule-rows -- scheduleRows. */
describe('AdminContentSchedulingComponent scheduleRows (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).scheduleRows(); }).not.toThrow();
  });
});
