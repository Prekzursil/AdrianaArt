...
/** Golden WU admin-add-page-faq-item -- addPageFaqItem. */
describe('AdminComponent addPageFaqItem (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageFaqItem(undefined as any, ''); }).not.toThrow();
  });
});
