...
/** Golden WU admin-allowed-cms-library-types -- allowedCmsLibraryTypes. */
describe('AdminComponent allowedCmsLibraryTypes (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).allowedCmsLibraryTypes(undefined as any); }).not.toThrow();
  });
});
