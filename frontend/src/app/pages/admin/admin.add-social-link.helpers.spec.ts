...
/** Golden WU admin-add-social-link -- addSocialLink. */
describe('AdminComponent addSocialLink (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addSocialLink(undefined as any); }).not.toThrow();
  });
});
