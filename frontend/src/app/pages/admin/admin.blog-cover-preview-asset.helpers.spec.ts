...
/** Golden WU admin-blog-cover-preview-asset -- blogCoverPreviewAsset. */
describe('AdminComponent blogCoverPreviewAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).blogCoverPreviewAsset(); }).not.toThrow();
  });
});
