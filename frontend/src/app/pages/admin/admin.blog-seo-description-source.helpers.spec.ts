...
/** Golden WU admin-blog-seo-description-source -- blogSeoDescriptionSource. */
describe('AdminComponent blogSeoDescriptionSource (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).blogSeoDescriptionSource(undefined as any); }).not.toThrow();
  });
});
