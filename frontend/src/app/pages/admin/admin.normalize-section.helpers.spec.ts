...
/** Golden WU admin-normalize-section -- normalizeSection. */
describe('AdminComponent normalizeSection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).normalizeSection(undefined as any); }).not.toThrow();
  });
});
