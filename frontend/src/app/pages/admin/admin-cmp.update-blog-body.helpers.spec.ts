...
/** Golden WU admin-cmp-update-blog-body -- updateBlogBody. */
describe('AdminComponent updateBlogBody (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateBlogBody(undefined as any, '', 0, 0); }).not.toThrow();
  });
});
