...
/** Golden WU admin-close-category-delete-confirm -- closeCategoryDeleteConfirm. */
describe('AdminComponent closeCategoryDeleteConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).closeCategoryDeleteConfirm(); }).not.toThrow();
  });
});
