...
/** Golden WU admin-edit-blog-cover-focal-point -- editBlogCoverFocalPoint. */
describe('AdminComponent editBlogCoverFocalPoint (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).editBlogCoverFocalPoint()).not.toThrow();
  });
});
