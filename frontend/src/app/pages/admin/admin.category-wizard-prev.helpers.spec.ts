...
/** Golden WU admin-category-wizard-prev -- categoryWizardPrev. */
describe('AdminComponent categoryWizardPrev (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).categoryWizardPrev(); }).not.toThrow();
  });
});
