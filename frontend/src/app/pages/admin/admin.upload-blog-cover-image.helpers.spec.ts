...
/** Golden WU admin-upload-blog-cover-image -- uploadBlogCoverImage. */
describe('AdminComponent uploadBlogCoverImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).uploadBlogCoverImage({} as any); }).not.toThrow();
  });
});
