...
/** Golden WU admin-cmp-save-legal-page-both -- saveLegalPageBoth. */
describe('AdminComponent saveLegalPageBoth (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveLegalPageBoth(undefined as any, undefined as any); }).not.toThrow();
  });
});
