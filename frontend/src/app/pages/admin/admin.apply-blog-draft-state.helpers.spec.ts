...
/** Golden WU admin-apply-blog-draft-state -- applyBlogDraftState. */
describe('AdminComponent applyBlogDraftState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applyBlogDraftState(undefined as any); }).not.toThrow();
  });
});
