...
/** Golden WU admin-ensure-new-page-block-type-for-key -- ensureNewPageBlockTypeForKey. */
describe('AdminComponent ensureNewPageBlockTypeForKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).ensureNewPageBlockTypeForKey(undefined as any); }).not.toThrow();
  });
});
