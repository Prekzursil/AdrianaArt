...
/** Golden WU admin-apply-blog-bulk-action -- applyBlogBulkAction. */
describe('AdminComponent applyBlogBulkAction (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyBlogBulkAction()).not.toThrow();
  });
});
