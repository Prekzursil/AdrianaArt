...
/** Golden WU admin-send-report-now -- sendReportNow. */
describe('AdminComponent sendReportNow (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).sendReportNow(undefined as any, undefined as any); }).not.toThrow();
  });
});
