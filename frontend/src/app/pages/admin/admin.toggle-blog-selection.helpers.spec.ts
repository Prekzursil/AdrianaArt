...
/** Golden WU admin-toggle-blog-selection -- toggleBlogSelection. */
describe('AdminComponent toggleBlogSelection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleBlogSelection('', {} as any); }).not.toThrow();
  });
});
