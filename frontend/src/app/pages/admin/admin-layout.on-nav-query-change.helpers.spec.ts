...
/** Golden WU admin-layout-on-nav-query-change -- onNavQueryChange. */
describe('AdminLayoutComponent onNavQueryChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onNavQueryChange(''); }).not.toThrow();
  });
});
