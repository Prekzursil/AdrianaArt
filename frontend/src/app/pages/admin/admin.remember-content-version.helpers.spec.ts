...
/** Golden WU admin-remember-content-version -- rememberContentVersion. */
describe('AdminComponent rememberContentVersion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).rememberContentVersion('', undefined as any); }).not.toThrow();
  });
});
