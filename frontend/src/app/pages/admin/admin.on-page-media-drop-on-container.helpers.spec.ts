...
/** Golden WU admin-on-page-media-drop-on-container -- onPageMediaDropOnContainer. */
describe('AdminComponent onPageMediaDropOnContainer (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageMediaDropOnContainer({} as any, undefined as any); }).not.toThrow();
  });
});
