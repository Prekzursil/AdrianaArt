...
/** Golden WU admin-prefix-blog-lines -- prefixBlogLines. */
describe('AdminComponent prefixBlogLines (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).prefixBlogLines(undefined as any, ''); }).not.toThrow();
  });
});
