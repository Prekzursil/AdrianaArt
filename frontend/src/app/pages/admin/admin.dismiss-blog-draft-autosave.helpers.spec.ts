...
/** Golden WU admin-dismiss-blog-draft-autosave -- dismissBlogDraftAutosave. */
describe('AdminComponent dismissBlogDraftAutosave (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).dismissBlogDraftAutosave()).not.toThrow();
  });
});
