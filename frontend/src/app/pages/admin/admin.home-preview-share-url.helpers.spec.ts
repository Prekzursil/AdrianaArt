...
/** Golden WU admin-home-preview-share-url -- homePreviewShareUrl. */
describe('AdminComponent homePreviewShareUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).homePreviewShareUrl(); }).not.toThrow();
  });
});
