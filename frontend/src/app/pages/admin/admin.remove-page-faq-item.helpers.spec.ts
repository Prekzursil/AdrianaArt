...
/** Golden WU admin-remove-page-faq-item -- removePageFaqItem. */
describe('AdminComponent removePageFaqItem (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removePageFaqItem(undefined as any, '', 0); }).not.toThrow();
  });
});
