...
/** Golden WU admin-refresh-page-preview -- refreshPagePreview. */
describe('AdminComponent refreshPagePreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshPagePreview(); }).not.toThrow();
  });
});
