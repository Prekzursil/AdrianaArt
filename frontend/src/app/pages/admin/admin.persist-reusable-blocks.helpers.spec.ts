...
/** Golden WU admin-persist-reusable-blocks -- persistReusableBlocks. */
describe('AdminComponent persistReusableBlocks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).persistReusableBlocks(undefined as any, ''); }).not.toThrow();
  });
});
