...
/** Golden WU admin-admin-delete-comment -- adminDeleteComment. */
describe('AdminComponent adminDeleteComment (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).adminDeleteComment(undefined as any); }).not.toThrow();
  });
});
