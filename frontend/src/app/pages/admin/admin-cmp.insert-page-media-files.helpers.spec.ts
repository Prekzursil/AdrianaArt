...
/** Golden WU admin-cmp-insert-page-media-files -- insertPageMediaFiles. */
describe('AdminComponent insertPageMediaFiles (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertPageMediaFiles(undefined as any, 0, undefined as any); }).not.toThrow();
  });
});
