...
/** Golden WU admin-upsert-tax-rate -- upsertTaxRate. */
describe('AdminComponent upsertTaxRate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).upsertTaxRate(undefined as any); }).not.toThrow();
  });
});
