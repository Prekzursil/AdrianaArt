...
/** Golden WU admin-set-page-banner-slide-image -- setPageBannerSlideImage. */
describe('AdminComponent setPageBannerSlideImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPageBannerSlideImage(undefined as any, '', undefined as any); }).not.toThrow();
  });
});
