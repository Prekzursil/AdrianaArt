...
/** Golden WU admin-on-home-block-drag-end -- onHomeBlockDragEnd. */
describe('AdminComponent onHomeBlockDragEnd (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onHomeBlockDragEnd(); }).not.toThrow();
  });
});
