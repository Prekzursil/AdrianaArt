...
/** Golden WU admin-add-page-block-from-library -- addPageBlockFromLibrary. */
describe('AdminComponent addPageBlockFromLibrary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageBlockFromLibrary(undefined as any, undefined as any, undefined as any); }).not.toThrow();
  });
});
