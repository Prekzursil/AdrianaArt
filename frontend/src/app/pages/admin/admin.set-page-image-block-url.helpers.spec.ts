...
/** Golden WU admin-set-page-image-block-url -- setPageImageBlockUrl. */
describe('AdminComponent setPageImageBlockUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPageImageBlockUrl(undefined as any, '', undefined as any); }).not.toThrow();
  });
});
