...
/** Golden WU admin-remove-home-columns-column -- removeHomeColumnsColumn. */
describe('AdminComponent removeHomeColumnsColumn (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeHomeColumnsColumn('', 0); }).not.toThrow();
  });
});
