...
/** Golden WU admin-ensure-selected-page-is-visible -- ensureSelectedPageIsVisible. */
describe('AdminComponent ensureSelectedPageIsVisible (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).ensureSelectedPageIsVisible(); }).not.toThrow();
  });
});
