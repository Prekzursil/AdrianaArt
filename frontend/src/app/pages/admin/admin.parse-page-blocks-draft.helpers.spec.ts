...
/** Golden WU admin-parse-page-blocks-draft -- parsePageBlocksDraft. */
describe('AdminComponent parsePageBlocksDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parsePageBlocksDraft(undefined as any); }).not.toThrow();
  });
});
