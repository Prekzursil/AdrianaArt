...
/** Golden WU admin-parse-reusable-blocks -- parseReusableBlocks. */
describe('AdminComponent parseReusableBlocks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseReusableBlocks(undefined as any); }).not.toThrow();
  });
});
