...
/** Golden WU admin-to-preview-slide -- toPreviewSlide. */
describe('AdminComponent toPreviewSlide (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toPreviewSlide(undefined as any, undefined as any); }).not.toThrow();
  });
});
