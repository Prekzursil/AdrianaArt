...
/** Golden WU admin-sync-cms-draft-poller -- syncCmsDraftPoller. */
describe('AdminComponent syncCmsDraftPoller (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).syncCmsDraftPoller(undefined as any); }).not.toThrow();
  });
});
