...
/** Golden WU admin-save-category-translation -- saveCategoryTranslation. */
describe('AdminComponent saveCategoryTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveCategoryTranslation(undefined as any); }).not.toThrow();
  });
});
