...
/** Golden WU admin-toggle-page-needs-translation -- togglePageNeedsTranslation. */
describe('AdminComponent togglePageNeedsTranslation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).togglePageNeedsTranslation(undefined as any, undefined as any, {} as any); }).not.toThrow();
  });
});
