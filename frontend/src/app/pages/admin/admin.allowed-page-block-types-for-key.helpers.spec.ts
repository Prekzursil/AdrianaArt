...
/** Golden WU admin-allowed-page-block-types-for-key -- allowedPageBlockTypesForKey. */
describe('AdminComponent allowedPageBlockTypesForKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).allowedPageBlockTypesForKey(undefined as any); }).not.toThrow();
  });
});
