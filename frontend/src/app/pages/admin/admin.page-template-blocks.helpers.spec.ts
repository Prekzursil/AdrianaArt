...
/** Golden WU admin-page-template-blocks -- pageTemplateBlocks. */
describe('AdminComponent pageTemplateBlocks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pageTemplateBlocks(undefined as any); }).not.toThrow();
  });
});
