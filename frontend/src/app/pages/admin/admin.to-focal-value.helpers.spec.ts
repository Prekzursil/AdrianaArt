...
/** Golden WU admin-to-focal-value -- toFocalValue. */
describe('AdminComponent toFocalValue (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toFocalValue(undefined as any, undefined as any); }).not.toThrow();
  });
});
