...
/** Golden WU admin-make-home-block-draft -- makeHomeBlockDraft. */
describe('AdminComponent makeHomeBlockDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).makeHomeBlockDraft('', undefined as any, false); }).not.toThrow();
  });
});
