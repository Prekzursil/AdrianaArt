...
/** Golden WU admin-to-cms-block-layout -- toCmsBlockLayout. */
describe('AdminComponent toCmsBlockLayout (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toCmsBlockLayout(undefined as any); }).not.toThrow();
  });
});
