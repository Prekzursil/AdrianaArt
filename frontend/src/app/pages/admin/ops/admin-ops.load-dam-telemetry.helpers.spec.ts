...
/** Golden WU admin-ops-load-dam-telemetry -- loadDamTelemetry. */
describe('AdminOpsComponent loadDamTelemetry (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadDamTelemetry()).not.toThrow();
  });
});
