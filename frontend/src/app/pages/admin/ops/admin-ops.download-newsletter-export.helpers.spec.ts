...
/** Golden WU admin-ops-download-newsletter-export -- downloadNewsletterExport. */
describe('AdminOpsComponent downloadNewsletterExport (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).downloadNewsletterExport()).not.toThrow();
  });
});
