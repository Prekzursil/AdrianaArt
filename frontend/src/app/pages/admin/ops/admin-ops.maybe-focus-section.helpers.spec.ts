...
/** Golden WU admin-ops-maybe-focus-section -- maybeFocusSection. */
describe('AdminOpsComponent maybeFocusSection (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).maybeFocusSection()).not.toThrow();
  });
});
