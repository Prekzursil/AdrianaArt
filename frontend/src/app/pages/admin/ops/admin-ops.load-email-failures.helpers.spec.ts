...
/** Golden WU admin-ops-load-email-failures -- loadEmailFailures. */
describe('AdminOpsComponent loadEmailFailures (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadEmailFailures()).not.toThrow();
  });
});
