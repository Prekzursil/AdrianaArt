...
/** Golden WU admin-ops-load-health-dashboard -- loadHealthDashboard. */
describe('AdminOpsComponent loadHealthDashboard (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadHealthDashboard()).not.toThrow();
  });
});
