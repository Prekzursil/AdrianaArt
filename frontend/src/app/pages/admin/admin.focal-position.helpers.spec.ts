...
/** Golden WU admin-focal-position -- focalPosition. */
describe('AdminComponent focalPosition (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).focalPosition(undefined as any, undefined as any); }).not.toThrow();
  });
});
