...
/** Golden WU admin-build-page-blocks-meta -- buildPageBlocksMeta. */
describe('AdminComponent buildPageBlocksMeta (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).buildPageBlocksMeta(undefined as any); }).not.toThrow();
  });
});
