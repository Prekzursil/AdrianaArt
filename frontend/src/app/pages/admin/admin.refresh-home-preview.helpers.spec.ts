...
/** Golden WU admin-refresh-home-preview -- refreshHomePreview. */
describe('AdminComponent refreshHomePreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshHomePreview(); }).not.toThrow();
  });
});
