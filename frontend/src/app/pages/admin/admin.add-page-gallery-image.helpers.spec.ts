...
/** Golden WU admin-add-page-gallery-image -- addPageGalleryImage. */
describe('AdminComponent addPageGalleryImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageGalleryImage(undefined as any, ''); }).not.toThrow();
  });
});
