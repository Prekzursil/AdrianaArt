...
/** Golden WU admin-insert-blog-image-markdown -- insertBlogImageMarkdown. */
describe('AdminComponent insertBlogImageMarkdown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertBlogImageMarkdown('', undefined as any); }).not.toThrow();
  });
});
