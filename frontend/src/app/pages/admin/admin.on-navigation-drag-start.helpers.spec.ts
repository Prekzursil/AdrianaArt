...
/** Golden WU admin-on-navigation-drag-start -- onNavigationDragStart. */
describe('AdminComponent onNavigationDragStart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onNavigationDragStart(undefined as any, ''); }).not.toThrow();
  });
});
