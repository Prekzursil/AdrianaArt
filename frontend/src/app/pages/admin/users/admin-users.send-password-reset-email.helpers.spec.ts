...
/** Golden WU admin-users-send-password-reset-email -- sendPasswordResetEmail. */
describe('AdminUsersComponent sendPasswordResetEmail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).sendPasswordResetEmail(); }).not.toThrow();
  });
});
