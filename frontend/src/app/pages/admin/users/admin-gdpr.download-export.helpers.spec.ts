...
/** Golden WU admin-gdpr-download-export -- downloadExport. */
describe('AdminGdprComponent downloadExport (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).downloadExport(null as any)).not.toThrow();
  });
});
