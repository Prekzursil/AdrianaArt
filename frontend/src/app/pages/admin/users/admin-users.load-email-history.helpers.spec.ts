...
/** Golden WU admin-users-load-email-history -- loadEmailHistory. */
describe('AdminUsersComponent loadEmailHistory (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadEmailHistory()).not.toThrow();
  });
});
