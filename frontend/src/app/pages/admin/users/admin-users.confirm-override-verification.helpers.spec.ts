...
/** Golden WU admin-users-confirm-override-verification -- confirmOverrideVerification. */
describe('AdminUsersComponent confirmOverrideVerification (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).confirmOverrideVerification()).not.toThrow();
  });
});
