...
/** Golden WU admin-gdpr-confirm-execute-deletion -- confirmExecuteDeletion. */
describe('AdminGdprComponent confirmExecuteDeletion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).confirmExecuteDeletion()).not.toThrow();
  });
});
