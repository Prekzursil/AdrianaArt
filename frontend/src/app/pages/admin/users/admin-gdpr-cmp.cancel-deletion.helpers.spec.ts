...
/** Golden WU admin-gdpr-cmp-cancel-deletion -- cancelDeletion. */
describe('AdminGdprComponent cancelDeletion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelDeletion(undefined as any); }).not.toThrow();
  });
});
