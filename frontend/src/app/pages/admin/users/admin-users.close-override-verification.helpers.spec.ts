...
/** Golden WU admin-users-close-override-verification -- closeOverrideVerification. */
describe('AdminUsersComponent closeOverrideVerification (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).closeOverrideVerification()).not.toThrow();
  });
});
