...
/** Golden WU admin-users-maybe-apply-filters-from-state -- maybeApplyFiltersFromState. */
describe('AdminUsersComponent maybeApplyFiltersFromState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).maybeApplyFiltersFromState(null as any)).not.toThrow();
  });
});
