...
/** Golden WU admin-users-ensure-coupon-promotions -- ensureCouponPromotions. */
describe('AdminUsersComponent ensureCouponPromotions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.ensureCouponPromotions(undefined as any); }).not.toThrow();
  });
});
