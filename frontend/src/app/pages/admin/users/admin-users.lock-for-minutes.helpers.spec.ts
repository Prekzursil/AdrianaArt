...
/** Golden WU admin-users-lock-for-minutes -- lockForMinutes. */
describe('AdminUsersComponent lockForMinutes (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).lockForMinutes('' as any)).not.toThrow();
  });
});
