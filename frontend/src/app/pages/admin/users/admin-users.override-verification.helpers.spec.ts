...
/** Golden WU admin-users-override-verification -- overrideVerification. */
describe('AdminUsersComponent overrideVerification (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).overrideVerification()).not.toThrow();
  });
});
