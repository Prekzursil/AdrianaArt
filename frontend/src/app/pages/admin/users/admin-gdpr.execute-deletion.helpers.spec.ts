...
/** Golden WU admin-gdpr-execute-deletion -- executeDeletion. */
describe('AdminGdprComponent executeDeletion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.executeDeletion(null as any); }).not.toThrow();
  });
});
