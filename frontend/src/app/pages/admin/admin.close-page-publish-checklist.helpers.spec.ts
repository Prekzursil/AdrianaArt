...
/** Golden WU admin-close-page-publish-checklist -- closePagePublishChecklist. */
describe('AdminComponent closePagePublishChecklist (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).closePagePublishChecklist()).not.toThrow();
  });
});
