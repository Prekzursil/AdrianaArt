...
/** Golden WU admin-search-product-grid-products -- searchProductGridProducts. */
describe('AdminComponent searchProductGridProducts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).searchProductGridProducts(''); }).not.toThrow();
  });
});
