...
/** Golden WU admin-open-category-wizard-translations -- openCategoryWizardTranslations. */
describe('AdminComponent openCategoryWizardTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openCategoryWizardTranslations(); }).not.toThrow();
  });
});
