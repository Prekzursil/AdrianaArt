...
/** Golden WU admin-restore-page-draft-autosave -- restorePageDraftAutosave. */
describe('AdminComponent restorePageDraftAutosave (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).restorePageDraftAutosave(undefined as any); }).not.toThrow();
  });
});
