...
/** Golden WU admin-layout-submit-feedback -- submitFeedback. */
describe('AdminLayoutComponent submitFeedback (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitFeedback(); }).not.toThrow();
  });
});
