...
/** Golden WU admin-on-home-media-drop-on-container -- onHomeMediaDropOnContainer. */
describe('AdminComponent onHomeMediaDropOnContainer (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onHomeMediaDropOnContainer({} as any); }).not.toThrow();
  });
});
