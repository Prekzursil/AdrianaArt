...
/** Golden WU admin-start-category-wizard -- startCategoryWizard. */
describe('AdminComponent startCategoryWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startCategoryWizard(); }).not.toThrow();
  });
});
