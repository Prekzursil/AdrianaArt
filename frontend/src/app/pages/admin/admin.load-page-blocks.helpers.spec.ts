...
/** Golden WU admin-load-page-blocks -- loadPageBlocks. */
describe('AdminComponent loadPageBlocks (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadPageBlocks(undefined as any); }).not.toThrow();
  });
});
