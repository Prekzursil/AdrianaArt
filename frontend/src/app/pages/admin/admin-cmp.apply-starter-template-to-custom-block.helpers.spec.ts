...
/** Golden WU admin-cmp-apply-starter-template-to-custom-block -- applyStarterTemplateToCustomBlock. */
describe('AdminComponent applyStarterTemplateToCustomBlock (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applyStarterTemplateToCustomBlock(undefined as any, undefined as any); }).not.toThrow();
  });
});
