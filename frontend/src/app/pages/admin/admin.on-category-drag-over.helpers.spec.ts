...
/** Golden WU admin-on-category-drag-over -- onCategoryDragOver. */
describe('AdminComponent onCategoryDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onCategoryDragOver({} as any); }).not.toThrow();
  });
});
