...
/** Golden WU admin-inventory-reload-reservations -- reloadReservations. */
describe('AdminInventoryComponent reloadReservations (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).reloadReservations()).not.toThrow();
  });
});
