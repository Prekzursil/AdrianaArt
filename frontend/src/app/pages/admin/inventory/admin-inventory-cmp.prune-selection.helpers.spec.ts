...
/** Golden WU admin-inventory-cmp-prune-selection -- pruneSelection. */
describe('AdminInventoryComponent pruneSelection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pruneSelection(undefined as any); }).not.toThrow();
  });
});
