...
/** Golden WU admin-on-page-blocks-key-change -- onPageBlocksKeyChange. */
describe('AdminComponent onPageBlocksKeyChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlocksKeyChange(undefined as any); }).not.toThrow();
  });
});
