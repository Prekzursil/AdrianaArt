...
/** Golden WU admin-cmp-insert-home-media-files -- insertHomeMediaFiles. */
describe('AdminComponent insertHomeMediaFiles (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertHomeMediaFiles(0, undefined as any); }).not.toThrow();
  });
});
