...
/** Golden WU admin-run-structured-data-validation -- runStructuredDataValidation. */
describe('AdminComponent runStructuredDataValidation (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).runStructuredDataValidation(); }).not.toThrow();
  });
});
