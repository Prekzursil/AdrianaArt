...
/** Golden WU admin-reset-collection-form -- resetCollectionForm. */
describe('AdminComponent resetCollectionForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetCollectionForm(); }).not.toThrow();
  });
});
