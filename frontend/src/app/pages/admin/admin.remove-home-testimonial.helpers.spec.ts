...
/** Golden WU admin-remove-home-testimonial -- removeHomeTestimonial. */
describe('AdminComponent removeHomeTestimonial (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeHomeTestimonial('', 0); }).not.toThrow();
  });
});
