...
/** Golden WU admin-support-cmp-delete-template -- deleteTemplate. */
describe('AdminSupportComponent deleteTemplate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteTemplate(undefined as any); }).not.toThrow();
  });
});
