...
/** Golden WU admin-home-preview-iframe-src -- homePreviewIframeSrc. */
describe('AdminComponent homePreviewIframeSrc (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).homePreviewIframeSrc(); }).not.toThrow();
  });
});
