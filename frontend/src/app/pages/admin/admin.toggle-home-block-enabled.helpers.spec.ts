...
/** Golden WU admin-toggle-home-block-enabled -- toggleHomeBlockEnabled. */
describe('AdminComponent toggleHomeBlockEnabled (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleHomeBlockEnabled(undefined as any, {} as any); }).not.toThrow();
  });
});
