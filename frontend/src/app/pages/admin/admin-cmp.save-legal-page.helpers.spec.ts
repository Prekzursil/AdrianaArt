...
/** Golden WU admin-cmp-save-legal-page -- saveLegalPage. */
describe('AdminComponent saveLegalPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveLegalPage(undefined as any, '', undefined as any); }).not.toThrow();
  });
});
