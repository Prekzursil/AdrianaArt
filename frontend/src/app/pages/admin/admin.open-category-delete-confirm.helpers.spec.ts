...
/** Golden WU admin-open-category-delete-confirm -- openCategoryDeleteConfirm. */
describe('AdminComponent openCategoryDeleteConfirm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openCategoryDeleteConfirm(undefined as any); }).not.toThrow();
  });
});
