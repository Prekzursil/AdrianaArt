...
/** Golden WU admin-update-category-parent -- updateCategoryParent. */
describe('AdminComponent updateCategoryParent (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateCategoryParent(undefined as any, ''); }).not.toThrow();
  });
});
