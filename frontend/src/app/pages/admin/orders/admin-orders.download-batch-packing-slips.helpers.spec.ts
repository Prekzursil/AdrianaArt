...
/** Golden WU admin-orders-download-batch-packing-slips -- downloadBatchPackingSlips. */
describe('AdminOrdersComponent downloadBatchPackingSlips (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).downloadBatchPackingSlips()).not.toThrow();
  });
});
