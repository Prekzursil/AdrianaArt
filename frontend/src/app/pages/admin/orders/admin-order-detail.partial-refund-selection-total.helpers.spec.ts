...
/** Golden WU admin-order-detail-partial-refund-selection-total -- partialRefundSelectionTotal. */
describe('AdminOrderDetailComponent partialRefundSelectionTotal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).partialRefundSelectionTotal(undefined as any); }).not.toThrow();
  });
});
