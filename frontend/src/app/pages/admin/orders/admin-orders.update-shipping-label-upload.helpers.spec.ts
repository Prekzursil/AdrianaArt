...
/** Golden WU admin-orders-update-shipping-label-upload -- updateShippingLabelUpload. */
describe('AdminOrdersComponent updateShippingLabelUpload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateShippingLabelUpload(0, undefined as any); }).not.toThrow();
  });
});
