...
/** Golden WU admin-order-detail-copy-to-clipboard -- copyToClipboard. */
describe('AdminOrderDetailComponent copyToClipboard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).copyToClipboard('')).not.toThrow();
  });
});