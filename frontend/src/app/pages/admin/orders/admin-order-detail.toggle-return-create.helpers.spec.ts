...
/** Golden WU admin-order-detail-toggle-return-create -- toggleReturnCreate. */
describe('AdminOrderDetailComponent toggleReturnCreate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).toggleReturnCreate()).not.toThrow();
  });
});
