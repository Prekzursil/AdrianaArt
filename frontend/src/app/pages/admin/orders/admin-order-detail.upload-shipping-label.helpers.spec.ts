...
/** Golden WU admin-order-detail-upload-shipping-label -- uploadShippingLabel. */
describe('AdminOrderDetailComponent uploadShippingLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.uploadShippingLabel(); }).not.toThrow();
  });
});
