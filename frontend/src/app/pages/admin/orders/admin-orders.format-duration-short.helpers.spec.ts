...
/** Golden WU admin-orders-format-duration-short -- formatDurationShort. */
describe('AdminOrdersComponent formatDurationShort (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).formatDurationShort(0); }).not.toThrow();
  });
});
