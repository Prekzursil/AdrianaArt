...
/** Golden WU admin-order-detail-toggle-test-tag -- toggleTestTag. */
describe('AdminOrderDetailComponent toggleTestTag (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.toggleTestTag(); }).not.toThrow();
  });
});
