...
/** Golden WU admin-orders-download-pick-list-csv -- downloadPickListCsv. */
describe('AdminOrdersComponent downloadPickListCsv (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.downloadPickListCsv(); }).not.toThrow();
  });
});
