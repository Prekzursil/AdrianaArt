...
/** Golden WU admin-order-detail-address-phone-hint -- addressPhoneHint. */
describe('AdminOrderDetailComponent addressPhoneHint (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).addressPhoneHint()).not.toThrow();
  });
});
