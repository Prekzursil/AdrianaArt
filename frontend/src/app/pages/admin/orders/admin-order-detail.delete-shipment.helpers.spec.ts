...
/** Golden WU admin-order-detail-delete-shipment -- deleteShipment. */
describe('AdminOrderDetailComponent deleteShipment (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteShipment(''); }).not.toThrow();
  });
});
