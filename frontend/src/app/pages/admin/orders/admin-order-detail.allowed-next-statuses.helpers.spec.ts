...
/** Golden WU admin-order-detail-allowed-next-statuses -- allowedNextStatuses. */
describe('AdminOrderDetailComponent allowedNextStatuses (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).allowedNextStatuses(null as any, '', null as any)).not.toThrow();
  });
});