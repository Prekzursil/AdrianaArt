...
/** Golden WU admin-orders-on-kanban-drop -- onKanbanDrop. */
describe('AdminOrdersComponent onKanbanDrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onKanbanDrop(undefined as any, undefined as any); }).not.toThrow();
  });
});
