...
/** Golden WU admin-orders-persist-view-mode -- persistViewMode. */
describe('AdminOrdersComponent persistViewMode (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).persistViewMode(); }).not.toThrow();
  });
});
