...
/** Golden WU admin-orders-download-selected-shipping-labels-zip -- downloadSelectedShippingLabelsZip. */
describe('AdminOrdersComponent downloadSelectedShippingLabelsZip (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.downloadSelectedShippingLabelsZip(); }).not.toThrow();
  });
});
