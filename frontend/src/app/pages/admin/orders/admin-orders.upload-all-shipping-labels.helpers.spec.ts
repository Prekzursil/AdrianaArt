...
/** Golden WU admin-orders-upload-all-shipping-labels -- uploadAllShippingLabels. */
describe('AdminOrdersComponent uploadAllShippingLabels (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.uploadAllShippingLabels(); }).not.toThrow();
  });
});
