...
/** Golden WU admin-order-detail-set-partial-refund-qty -- setPartialRefundQty. */
describe('AdminOrderDetailComponent setPartialRefundQty (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPartialRefundQty('', undefined as any, 0); }).not.toThrow();
  });
});
