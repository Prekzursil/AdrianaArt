...
/** Golden WU admin-orders-close-export-modal -- closeExportModal. */
describe('AdminOrdersComponent closeExportModal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closeExportModal()).not.toThrow();
  });
});
