...
/** Golden WU admin-order-detail-send-delivery-email -- sendDeliveryEmail. */
describe('AdminOrderDetailComponent sendDeliveryEmail (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.sendDeliveryEmail(); }).not.toThrow();
  });
});
