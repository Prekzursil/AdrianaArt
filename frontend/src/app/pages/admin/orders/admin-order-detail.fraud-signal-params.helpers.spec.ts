...
/** Golden WU admin-order-detail-fraud-signal-params -- fraudSignalParams. */
describe('AdminOrderDetailComponent fraudSignalParams (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).fraudSignalParams(undefined as any); }).not.toThrow();
  });
});
