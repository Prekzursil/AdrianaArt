...
/** Golden WU admin-order-detail-open-refund-wizard -- openRefundWizard. */
describe('AdminOrderDetailComponent openRefundWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).openRefundWizard()).not.toThrow();
  });
});
