...
/** Golden WU admin-order-detail-toggle-pii-reveal -- togglePiiReveal. */
describe('AdminOrderDetailComponent togglePiiReveal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.togglePiiReveal(); }).not.toThrow();
  });
});
