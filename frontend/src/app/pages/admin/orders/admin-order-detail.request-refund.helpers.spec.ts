...
/** Golden WU admin-order-detail-request-refund -- requestRefund. */
describe('AdminOrderDetailComponent requestRefund (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).requestRefund()).not.toThrow();
  });
});
