...
/** Golden WU admin-orders-toggle-export-column -- toggleExportColumn. */
describe('AdminOrdersComponent toggleExportColumn (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleExportColumn('', false); }).not.toThrow();
  });
});
