...
/** Golden WU admin-order-detail-add-admin-note -- addAdminNote. */
describe('AdminOrderDetailComponent addAdminNote (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).addAdminNote()).not.toThrow();
  });
});
