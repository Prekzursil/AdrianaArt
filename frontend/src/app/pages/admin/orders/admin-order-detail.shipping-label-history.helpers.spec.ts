...
/** Golden WU admin-order-detail-shipping-label-history -- shippingLabelHistory. */
describe('AdminOrderDetailComponent shippingLabelHistory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.shippingLabelHistory(); }).not.toThrow();
  });
});
