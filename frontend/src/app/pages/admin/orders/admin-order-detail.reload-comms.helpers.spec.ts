...
/** Golden WU admin-order-detail-reload-comms -- reloadComms. */
describe('AdminOrderDetailComponent reloadComms (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).reloadComms()).not.toThrow();
  });
});
