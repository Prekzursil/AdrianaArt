...
/** Golden WU admin-order-detail-address-needs-attention -- addressNeedsAttention. */
describe('AdminOrderDetailComponent addressNeedsAttention (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).addressNeedsAttention(undefined as any, undefined as any)).not.toThrow();
  });
});
