...
/** Golden WU admin-order-detail-save-shipment-editor -- saveShipmentEditor. */
describe('AdminOrderDetailComponent saveShipmentEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.saveShipmentEditor(); }).not.toThrow();
  });
});
