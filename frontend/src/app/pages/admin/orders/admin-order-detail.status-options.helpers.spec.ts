...
/** Golden WU admin-order-detail-status-options -- statusOptions. */
describe('AdminOrderDetailComponent statusOptions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.statusOptions(); }).not.toThrow();
  });
});
