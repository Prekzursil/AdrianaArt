...
/** Golden WU admin-orders-download-pick-list-pdf -- downloadPickListPdf. */
describe('AdminOrdersComponent downloadPickListPdf (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.downloadPickListPdf(); }).not.toThrow();
  });
});
