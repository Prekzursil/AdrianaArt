...
/** Golden WU admin-orders-export-storage-key -- exportStorageKey. */
describe('AdminOrdersComponent exportStorageKey (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).exportStorageKey()).not.toThrow();
  });
});
