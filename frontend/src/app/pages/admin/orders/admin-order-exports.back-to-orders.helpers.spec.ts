...
/** Golden WU admin-order-exports-back-to-orders -- backToOrders. */
describe('AdminOrderExportsComponent backToOrders (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).backToOrders()).not.toThrow();
  });
});
