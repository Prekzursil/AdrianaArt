...
/** Golden WU admin-order-detail-open-partial-refund-wizard -- openPartialRefundWizard. */
describe('AdminOrderDetailComponent openPartialRefundWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).openPartialRefundWizard()).not.toThrow();
  });
});
