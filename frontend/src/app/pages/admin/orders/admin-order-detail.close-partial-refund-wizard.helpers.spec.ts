...
/** Golden WU admin-order-detail-close-partial-refund-wizard -- closePartialRefundWizard. */
describe('AdminOrderDetailComponent closePartialRefundWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).closePartialRefundWizard()).not.toThrow();
  });
});
