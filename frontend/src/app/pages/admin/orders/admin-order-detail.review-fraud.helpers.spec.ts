...
/** Golden WU admin-order-detail-review-fraud -- reviewFraud. */
describe('AdminOrderDetailComponent reviewFraud (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).reviewFraud(undefined as any); }).not.toThrow();
  });
});
