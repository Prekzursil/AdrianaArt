...
/** Golden WU admin-orders-toggle-select-all-on-page -- toggleSelectAllOnPage. */
describe('AdminOrdersComponent toggleSelectAllOnPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleSelectAllOnPage(false); }).not.toThrow();
  });
});
