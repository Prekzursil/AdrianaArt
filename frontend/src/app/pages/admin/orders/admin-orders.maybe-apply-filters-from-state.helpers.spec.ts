...
/** Golden WU admin-orders-maybe-apply-filters-from-state -- maybeApplyFiltersFromState. */
describe('AdminOrdersComponent maybeApplyFiltersFromState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.maybeApplyFiltersFromState(); }).not.toThrow();
  });
});
