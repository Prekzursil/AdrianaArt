...
/** Golden WU admin-order-detail-address-postal-hint -- addressPostalHint. */
describe('AdminOrderDetailComponent addressPostalHint (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).addressPostalHint()).not.toThrow();
  });
});
