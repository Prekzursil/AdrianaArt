...
/** Golden WU admin-orders-open-shipping-labels-modal -- openShippingLabelsModal. */
describe('AdminOrdersComponent openShippingLabelsModal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.openShippingLabelsModal(); }).not.toThrow();
  });
});
