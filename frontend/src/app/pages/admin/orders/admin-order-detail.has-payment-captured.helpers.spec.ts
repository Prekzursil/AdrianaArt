...
/** Golden WU admin-order-detail-has-payment-captured -- hasPaymentCaptured. */
describe('AdminOrderDetailComponent hasPaymentCaptured (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).hasPaymentCaptured(null as any)).not.toThrow();
  });
});
