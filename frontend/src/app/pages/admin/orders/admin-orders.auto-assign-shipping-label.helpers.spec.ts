...
/** Golden WU admin-orders-auto-assign-shipping-label -- autoAssignShippingLabel. */
describe('AdminOrdersComponent autoAssignShippingLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).autoAssignShippingLabel(undefined as any); }).not.toThrow();
  });
});
