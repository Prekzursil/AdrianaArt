...
/** Golden WU admin-order-detail-print-shipping-label -- printShippingLabel. */
describe('AdminOrderDetailComponent printShippingLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).printShippingLabel()).not.toThrow();
  });
});
