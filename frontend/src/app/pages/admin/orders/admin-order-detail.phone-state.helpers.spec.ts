...
/** Golden WU admin-order-detail-phone-state -- phoneState. */
describe('AdminOrderDetailComponent phoneState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).phoneState('', '', undefined as any)).not.toThrow();
  });
});