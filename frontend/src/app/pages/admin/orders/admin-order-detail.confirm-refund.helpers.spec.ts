...
/** Golden WU admin-order-detail-confirm-refund -- confirmRefund. */
describe('AdminOrderDetailComponent confirmRefund (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).confirmRefund()).not.toThrow();
  });
});
