...
/** Golden WU admin-order-detail-open-address-editor -- openAddressEditor. */
describe('AdminOrderDetailComponent openAddressEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openAddressEditor(undefined as any); }).not.toThrow();
  });
});
