...
/** Golden WU admin-orders-open-export-modal -- openExportModal. */
describe('AdminOrdersComponent openExportModal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openExportModal(); }).not.toThrow();
  });
});
