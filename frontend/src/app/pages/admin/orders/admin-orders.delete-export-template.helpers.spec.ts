...
/** Golden WU admin-orders-delete-export-template -- deleteExportTemplate. */
describe('AdminOrdersComponent deleteExportTemplate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).deleteExportTemplate()).not.toThrow();
  });
});
