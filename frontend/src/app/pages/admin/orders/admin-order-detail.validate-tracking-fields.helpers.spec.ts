...
/** Golden WU admin-order-detail-validate-tracking-fields -- validateTrackingFields. */
describe('AdminOrderDetailComponent validateTrackingFields (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).validateTrackingFields('', '', '')).not.toThrow();
  });
});