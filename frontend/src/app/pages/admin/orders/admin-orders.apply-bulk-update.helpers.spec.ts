...
/** Golden WU admin-orders-apply-bulk-update -- applyBulkUpdate. */
describe('AdminOrdersComponent applyBulkUpdate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).applyBulkUpdate()).not.toThrow();
  });
});
