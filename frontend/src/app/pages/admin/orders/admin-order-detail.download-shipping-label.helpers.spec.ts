...
/** Golden WU admin-order-detail-download-shipping-label -- downloadShippingLabel. */
describe('AdminOrderDetailComponent downloadShippingLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).downloadShippingLabel()).not.toThrow();
  });
});
