...
/** Golden WU admin-orders-build-shipping-labels-order-options -- buildShippingLabelsOrderOptions. */
describe('AdminOrdersComponent buildShippingLabelsOrderOptions (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).buildShippingLabelsOrderOptions()).not.toThrow();
  });
});
