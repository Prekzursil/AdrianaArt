...
/** Golden WU admin-order-detail-save-address-editor -- saveAddressEditor. */
describe('AdminOrderDetailComponent saveAddressEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).saveAddressEditor()).not.toThrow();
  });
});
