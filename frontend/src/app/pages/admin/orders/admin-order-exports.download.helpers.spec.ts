...
/** Golden WU admin-order-exports-download -- download. */
describe('AdminOrderExportsComponent download (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).download(null as any)).not.toThrow();
  });
});
