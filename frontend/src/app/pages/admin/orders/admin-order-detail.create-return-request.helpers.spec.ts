...
/** Golden WU admin-order-detail-create-return-request -- createReturnRequest. */
describe('AdminOrderDetailComponent createReturnRequest (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).createReturnRequest()).not.toThrow();
  });
});
