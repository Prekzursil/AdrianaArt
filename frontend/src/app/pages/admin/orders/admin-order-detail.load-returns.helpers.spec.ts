...
/** Golden WU admin-order-detail-load-returns -- loadReturns. */
describe('AdminOrderDetailComponent loadReturns (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadReturns(''); }).not.toThrow();
  });
});
