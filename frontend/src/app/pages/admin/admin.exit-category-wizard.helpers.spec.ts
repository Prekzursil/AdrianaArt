...
/** Golden WU admin-exit-category-wizard -- exitCategoryWizard. */
describe('AdminComponent exitCategoryWizard (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).exitCategoryWizard(); }).not.toThrow();
  });
});
