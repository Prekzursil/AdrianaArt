...
/** Golden WU admin-prune-blog-bulk-selection -- pruneBlogBulkSelection. */
describe('AdminComponent pruneBlogBulkSelection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).pruneBlogBulkSelection(); }).not.toThrow();
  });
});
