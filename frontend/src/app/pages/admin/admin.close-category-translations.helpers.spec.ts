...
/** Golden WU admin-close-category-translations -- closeCategoryTranslations. */
describe('AdminComponent closeCategoryTranslations (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).closeCategoryTranslations(); }).not.toThrow();
  });
});
