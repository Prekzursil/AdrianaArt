...
/** Golden WU admin-on-home-block-drop-zone -- onHomeBlockDropZone. */
describe('AdminComponent onHomeBlockDropZone (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onHomeBlockDropZone({} as any, 0); }).not.toThrow();
  });
});
