...
/** Golden WU admin-restore-home-draft-autosave -- restoreHomeDraftAutosave. */
describe('AdminComponent restoreHomeDraftAutosave (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).restoreHomeDraftAutosave(); }).not.toThrow();
  });
});
