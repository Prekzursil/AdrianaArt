...
/** Golden WU admin-cmp-compute-page-publish-checklist-local -- computePagePublishChecklistLocal. */
describe('AdminComponent computePagePublishChecklistLocal (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).computePagePublishChecklistLocal(undefined as any); }).not.toThrow();
  });
});
