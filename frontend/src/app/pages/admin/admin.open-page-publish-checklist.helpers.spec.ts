...
/** Golden WU admin-open-page-publish-checklist -- openPagePublishChecklist. */
describe('AdminComponent openPagePublishChecklist (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openPagePublishChecklist(undefined as any); }).not.toThrow();
  });
});
