...
/** Golden WU admin-returns-download-return-label -- downloadReturnLabel. */
describe('AdminReturnsComponent downloadReturnLabel (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).downloadReturnLabel()).not.toThrow();
  });
});
