...
/** Golden WU admin-confirm-page-publish-checklist -- confirmPagePublishChecklist. */
describe('AdminComponent confirmPagePublishChecklist (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).confirmPagePublishChecklist()).not.toThrow();
  });
});
