...
/** Golden WU admin-undo-page-draft -- undoPageDraft. */
describe('AdminComponent undoPageDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).undoPageDraft(undefined as any); }).not.toThrow();
  });
});
