...
/** Golden WU admin-remove-page-columns-column -- removePageColumnsColumn. */
describe('AdminComponent removePageColumnsColumn (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removePageColumnsColumn(undefined as any, '', 0); }).not.toThrow();
  });
});
