...
/** Golden WU admin-on-page-block-drag-start -- onPageBlockDragStart. */
describe('AdminComponent onPageBlockDragStart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlockDragStart(undefined as any, ''); }).not.toThrow();
  });
});
