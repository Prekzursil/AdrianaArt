...
/** Golden WU admin-apply-blog-reading-time-estimate -- applyBlogReadingTimeEstimate. */
describe('AdminComponent applyBlogReadingTimeEstimate (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyBlogReadingTimeEstimate()).not.toThrow();
  });
});
