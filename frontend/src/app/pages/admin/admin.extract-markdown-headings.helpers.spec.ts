...
/** Golden WU admin-extract-markdown-headings -- extractMarkdownHeadings. */
describe('AdminComponent extractMarkdownHeadings (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).extractMarkdownHeadings(''); }).not.toThrow();
  });
});
