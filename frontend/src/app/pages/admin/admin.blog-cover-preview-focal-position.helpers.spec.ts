...
/** Golden WU admin-blog-cover-preview-focal-position -- blogCoverPreviewFocalPosition. */
describe('AdminComponent blogCoverPreviewFocalPosition (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).blogCoverPreviewFocalPosition(); }).not.toThrow();
  });
});
