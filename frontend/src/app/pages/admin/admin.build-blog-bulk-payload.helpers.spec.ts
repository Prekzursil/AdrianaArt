...
/** Golden WU admin-build-blog-bulk-payload -- buildBlogBulkPayload. */
describe('AdminComponent buildBlogBulkPayload (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).buildBlogBulkPayload(undefined as any); }).not.toThrow();
  });
});
