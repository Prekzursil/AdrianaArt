...
/** Golden WU admin-insert-blog-link -- insertBlogLink. */
describe('AdminComponent insertBlogLink (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).insertBlogLink(undefined as any); }).not.toThrow();
  });
});
