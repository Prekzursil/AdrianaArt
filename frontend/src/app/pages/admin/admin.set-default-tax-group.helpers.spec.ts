...
/** Golden WU admin-set-default-tax-group -- setDefaultTaxGroup. */
describe('AdminComponent setDefaultTaxGroup (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setDefaultTaxGroup(undefined as any); }).not.toThrow();
  });
});
