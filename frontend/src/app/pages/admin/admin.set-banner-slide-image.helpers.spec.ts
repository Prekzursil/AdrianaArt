...
/** Golden WU admin-set-banner-slide-image -- setBannerSlideImage. */
describe('AdminComponent setBannerSlideImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setBannerSlideImage('', undefined as any); }).not.toThrow();
  });
});
