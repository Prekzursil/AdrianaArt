...
/** Golden WU admin-add-home-testimonial -- addHomeTestimonial. */
describe('AdminComponent addHomeTestimonial (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addHomeTestimonial(''); }).not.toThrow();
  });
});
