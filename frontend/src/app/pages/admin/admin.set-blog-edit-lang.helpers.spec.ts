...
/** Golden WU admin-set-blog-edit-lang -- setBlogEditLang. */
describe('AdminComponent setBlogEditLang (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setBlogEditLang(undefined as any); }).not.toThrow();
  });
});
