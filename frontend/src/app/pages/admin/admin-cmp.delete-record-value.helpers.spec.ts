...
/** Golden WU admin-cmp-delete-record-value -- deleteRecordValue. */
describe('AdminComponent deleteRecordValue (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteRecordValue('', '', undefined as any); }).not.toThrow();
  });
});
