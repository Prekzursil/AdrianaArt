...
/** Golden WU admin-sync-split-scroll -- syncSplitScroll. */
describe('AdminComponent syncSplitScroll (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).syncSplitScroll(undefined as any, undefined as any); }).not.toThrow();
  });
});
