...
/** Golden WU admin-layout-cmp-toggle-sidebar-compact -- toggleSidebarCompact. */
describe('AdminLayoutComponent toggleSidebarCompact (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleSidebarCompact({} as any); }).not.toThrow();
  });
});
