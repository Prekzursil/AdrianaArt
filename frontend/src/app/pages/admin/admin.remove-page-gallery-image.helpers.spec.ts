...
/** Golden WU admin-remove-page-gallery-image -- removePageGalleryImage. */
describe('AdminComponent removePageGalleryImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removePageGalleryImage(undefined as any, '', 0); }).not.toThrow();
  });
});
