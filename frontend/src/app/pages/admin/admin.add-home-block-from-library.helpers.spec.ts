...
/** Golden WU admin-add-home-block-from-library -- addHomeBlockFromLibrary. */
describe('AdminComponent addHomeBlockFromLibrary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addHomeBlockFromLibrary(undefined as any, undefined as any); }).not.toThrow();
  });
});
