...
/** Golden WU admin-select-info-lang -- selectInfoLang. */
describe('AdminComponent selectInfoLang (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectInfoLang(undefined as any); }).not.toThrow();
  });
});
