...
/** Golden WU admin-set-carousel-slide-image -- setCarouselSlideImage. */
describe('AdminComponent setCarouselSlideImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setCarouselSlideImage('', 0, undefined as any); }).not.toThrow();
  });
});
