...
/** Golden WU admin-on-legal-page-key-change -- onLegalPageKeyChange. */
describe('AdminComponent onLegalPageKeyChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onLegalPageKeyChange(undefined as any); }).not.toThrow();
  });
});
