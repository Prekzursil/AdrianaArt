...
/** Golden WU admin-save-page-block-as-reusable -- savePageBlockAsReusable. */
describe('AdminComponent savePageBlockAsReusable (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).savePageBlockAsReusable(undefined as any, ''); }).not.toThrow();
  });
});
