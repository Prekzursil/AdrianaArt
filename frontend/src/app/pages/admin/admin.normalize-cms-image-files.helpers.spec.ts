...
/** Golden WU admin-normalize-cms-image-files -- normalizeCmsImageFiles. */
describe('AdminComponent normalizeCmsImageFiles (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).normalizeCmsImageFiles(undefined as any); }).not.toThrow();
  });
});
