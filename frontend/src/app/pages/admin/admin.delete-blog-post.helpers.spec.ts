...
/** Golden WU admin-delete-blog-post -- deleteBlogPost. */
describe('AdminComponent deleteBlogPost (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteBlogPost(undefined as any); }).not.toThrow();
  });
});
