...
/** Golden WU admin-select-blog-post -- selectBlogPost. */
describe('AdminComponent selectBlogPost (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectBlogPost(undefined as any); }).not.toThrow();
  });
});
