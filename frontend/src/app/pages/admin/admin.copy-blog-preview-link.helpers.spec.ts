...
/** Golden WU admin-copy-blog-preview-link -- copyBlogPreviewLink. */
describe('AdminComponent copyBlogPreviewLink (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).copyBlogPreviewLink()).not.toThrow();
  });
});
