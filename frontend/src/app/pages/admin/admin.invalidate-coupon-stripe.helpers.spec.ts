...
/** Golden WU admin-invalidate-coupon-stripe -- invalidateCouponStripe. */
describe('AdminComponent invalidateCouponStripe (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).invalidateCouponStripe(undefined as any); }).not.toThrow();
  });
});
