...
/** Golden WU admin-delete-tax-group -- deleteTaxGroup. */
describe('AdminComponent deleteTaxGroup (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).deleteTaxGroup(undefined as any); }).not.toThrow();
  });
});
