...
/** Golden WU admin-dismiss-home-draft-autosave -- dismissHomeDraftAutosave. */
describe('AdminComponent dismissHomeDraftAutosave (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).dismissHomeDraftAutosave()).not.toThrow();
  });
});
