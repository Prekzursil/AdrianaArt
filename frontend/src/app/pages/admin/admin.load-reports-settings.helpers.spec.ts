...
/** Golden WU admin-load-reports-settings -- loadReportsSettings. */
describe('AdminComponent loadReportsSettings (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadReportsSettings(); }).not.toThrow();
  });
});
