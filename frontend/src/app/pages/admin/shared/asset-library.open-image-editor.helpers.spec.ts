...
/** Golden WU asset-library-open-image-editor -- openImageEditor. */
describe('AssetLibraryComponent openImageEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openImageEditor(undefined as any); }).not.toThrow();
  });
});
