...
/** Golden WU content-revisions-cmp-recompute-diff -- recomputeDiff. */
describe('ContentRevisionsComponent recomputeDiff (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).recomputeDiff(); }).not.toThrow();
  });
});
