...
/** Golden WU content-revisions-cmp-snapshot-text -- snapshotText. */
describe('ContentRevisionsComponent snapshotText (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).snapshotText(undefined as any); }).not.toThrow();
  });
});
