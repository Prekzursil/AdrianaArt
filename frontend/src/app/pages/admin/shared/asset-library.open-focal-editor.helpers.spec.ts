...
/** Golden WU asset-library-open-focal-editor -- openFocalEditor. */
describe('AssetLibraryComponent openFocalEditor (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openFocalEditor(undefined as any); }).not.toThrow();
  });
});
