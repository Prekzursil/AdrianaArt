...
/** Golden WU dam-asset-library-compute-retry-policy-diff-rows -- computeRetryPolicyDiffRows. */
describe('DamAssetLibraryComponent computeRetryPolicyDiffRows (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).computeRetryPolicyDiffRows(null as any, null as any)).not.toThrow();
  });
});