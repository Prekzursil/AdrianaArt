...
/** Golden WU dam-asset-library-load-collections -- loadCollections. */
describe('DamAssetLibraryComponent loadCollections (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { void (cmp as any).loadCollections(); }).not.toThrow();
  });
});
