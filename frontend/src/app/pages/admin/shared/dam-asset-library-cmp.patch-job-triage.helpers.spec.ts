...
/** Golden WU dam-asset-library-cmp-patch-job-triage -- patchJobTriage. */
describe('DamAssetLibraryComponent patchJobTriage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).patchJobTriage(undefined as any, undefined as any, ''); }).not.toThrow();
  });
});
