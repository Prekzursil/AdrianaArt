...
/** Golden WU cms-editor-prefs-persist -- persist. */
describe('CmsEditorPrefsService persist (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(CmsEditorPrefsService.prototype) as CmsEditorPrefsService;
    ...
    expect(() => { (cmp as any).persist(); }).not.toThrow();
  });
});
