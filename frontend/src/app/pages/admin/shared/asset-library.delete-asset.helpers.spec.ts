...
/** Golden WU asset-library-delete-asset -- deleteAsset. */
describe('AssetLibraryComponent deleteAsset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.deleteAsset(undefined as any); }).not.toThrow();
  });
});
