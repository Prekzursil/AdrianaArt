...
/** Golden WU dam-asset-library-add-triage-note -- addTriageNote. */
describe('DamAssetLibraryComponent addTriageNote (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.addTriageNote(null as any); }).not.toThrow();
  });
});
