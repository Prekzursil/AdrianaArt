...
/** Golden WU dam-asset-library-toggle-selected -- toggleSelected. */
describe('DamAssetLibraryComponent toggleSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleSelected('', {} as any); }).not.toThrow();
  });
});
