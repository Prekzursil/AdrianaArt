...
/** Golden WU dam-asset-library-load-retry-policies -- loadRetryPolicies. */
describe('DamAssetLibraryComponent loadRetryPolicies (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadRetryPolicies()).not.toThrow();
  });
});
