...
/** Golden WU content-revisions-cmp-load-selected-version -- loadSelectedVersion. */
describe('ContentRevisionsComponent loadSelectedVersion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ContentRevisionsComponent.prototype) as ContentRevisionsComponent;
    ...
    expect(() => { (cmp as any).loadSelectedVersion(); }).not.toThrow();
  });
});
