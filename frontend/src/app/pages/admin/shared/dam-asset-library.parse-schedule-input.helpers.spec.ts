...
/** Golden WU dam-asset-library-parse-schedule-input -- parseScheduleInput. */
describe('DamAssetLibraryComponent parseScheduleInput (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).parseScheduleInput(''); }).not.toThrow();
  });
});
