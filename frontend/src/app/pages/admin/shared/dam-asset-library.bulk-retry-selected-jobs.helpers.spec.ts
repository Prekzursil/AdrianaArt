...
/** Golden WU dam-asset-library-bulk-retry-selected-jobs -- bulkRetrySelectedJobs. */
describe('DamAssetLibraryComponent bulkRetrySelectedJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).bulkRetrySelectedJobs()).not.toThrow();
  });
});
