...
/** Golden WU dam-asset-library-edit-tags -- editTags. */
describe('DamAssetLibraryComponent editTags (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).editTags(undefined as any); }).not.toThrow();
  });
});
