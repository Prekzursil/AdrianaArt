...
/** Golden WU asset-library-build-asset-groups -- buildAssetGroups. */
describe('AssetLibraryComponent buildAssetGroups (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).buildAssetGroups(undefined as any); }).not.toThrow();
  });
});
