...
/** Golden WU dam-asset-library-create-collection -- createCollection. */
describe('DamAssetLibraryComponent createCollection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { void (cmp as any).createCollection(); }).not.toThrow();
  });
});
