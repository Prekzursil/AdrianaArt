...
/** Golden WU dam-asset-library-stop-queue-polling -- stopQueuePolling. */
describe('DamAssetLibraryComponent stopQueuePolling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.stopQueuePolling(); }).not.toThrow();
  });
});
