...
/** Golden WU dam-asset-library-set-retry-policy-draft-enabled -- setRetryPolicyDraftEnabled. */
describe('DamAssetLibraryComponent setRetryPolicyDraftEnabled (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setRetryPolicyDraftEnabled(undefined as any, false); }).not.toThrow();
  });
});
