...
/** Golden WU dam-asset-library-cmp-rollback-retry-policy-preset -- rollbackRetryPolicyPreset. */
describe('DamAssetLibraryComponent rollbackRetryPolicyPreset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).rollbackRetryPolicyPreset(undefined as any, undefined as any); }).not.toThrow();
  });
});
