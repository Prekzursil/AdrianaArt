...
/** Golden WU dam-asset-library-attach-selection-to-collection -- attachSelectionToCollection. */
describe('DamAssetLibraryComponent attachSelectionToCollection (golden WU)', () => {
  it('async invokes without throwing when dependencies are stubbed', async () => {
    ...
    await expectAsync(cmp.attachSelectionToCollection(undefined as any)).toBeResolved();
  });
});
