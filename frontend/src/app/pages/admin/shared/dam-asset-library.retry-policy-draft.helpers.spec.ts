...
/** Golden WU dam-asset-library-retry-policy-draft -- retryPolicyDraft. */
describe('DamAssetLibraryComponent retryPolicyDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).retryPolicyDraft(null as any)).not.toThrow();
  });
});
