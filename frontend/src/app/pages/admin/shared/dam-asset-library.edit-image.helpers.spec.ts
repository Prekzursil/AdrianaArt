...
/** Golden WU dam-asset-library-edit-image -- editImage. */
describe('DamAssetLibraryComponent editImage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).editImage(undefined as any); }).not.toThrow();
  });
});
