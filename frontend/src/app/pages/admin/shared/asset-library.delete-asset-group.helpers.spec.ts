...
/** Golden WU asset-library-delete-asset-group -- deleteAssetGroup. */
describe('AssetLibraryComponent deleteAssetGroup (golden WU)', () => {
  it('async invokes without throwing when dependencies are stubbed', async () => {
    ...
    await expectAsync(cmp.deleteAssetGroup(undefined as any)).toBeResolved();
  });
});
