...
/** Golden WU dam-asset-library-open-details -- openDetails. */
describe('DamAssetLibraryComponent openDetails (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).openDetails(null as any)).not.toThrow();
  });
});
