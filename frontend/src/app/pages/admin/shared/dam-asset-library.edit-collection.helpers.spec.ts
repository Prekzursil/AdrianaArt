...
/** Golden WU dam-asset-library-edit-collection -- editCollection. */
describe('DamAssetLibraryComponent editCollection (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).editCollection(undefined as any); }).not.toThrow();
  });
});
