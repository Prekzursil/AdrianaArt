...
/** Golden WU dam-asset-library-set-retry-policy-draft-jitter -- setRetryPolicyDraftJitter. */
describe('DamAssetLibraryComponent setRetryPolicyDraftJitter (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setRetryPolicyDraftJitter(undefined as any, undefined as any); }).not.toThrow();
  });
});
