...
/** Golden WU content-revisions-ng-on-changes -- ngOnChanges. */
describe('ContentRevisionsComponent ngOnChanges (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).ngOnChanges(undefined as any)).not.toThrow();
  });
});
