...
/** Golden WU asset-library-open-details -- openDetails. */
describe('AssetLibraryComponent openDetails (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).openDetails(undefined as any); }).not.toThrow();
  });
});
