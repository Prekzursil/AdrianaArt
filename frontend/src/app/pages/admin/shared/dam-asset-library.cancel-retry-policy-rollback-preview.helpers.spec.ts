...
/** Golden WU dam-asset-library-cancel-retry-policy-rollback-preview -- cancelRetryPolicyRollbackPreview. */
describe('DamAssetLibraryComponent cancelRetryPolicyRollbackPreview (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).cancelRetryPolicyRollbackPreview()).not.toThrow();
  });
});
