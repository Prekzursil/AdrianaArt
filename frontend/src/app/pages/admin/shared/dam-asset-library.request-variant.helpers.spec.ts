...
/** Golden WU dam-asset-library-request-variant -- requestVariant. */
describe('DamAssetLibraryComponent requestVariant (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).requestVariant(undefined as any); }).not.toThrow();
  });
});
