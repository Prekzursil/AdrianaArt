...
/** Golden WU dam-asset-library-start-queue-polling -- startQueuePolling. */
describe('DamAssetLibraryComponent startQueuePolling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.startQueuePolling(); }).not.toThrow();
  });
});
