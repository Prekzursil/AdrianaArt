...
/** Golden WU dam-asset-library-soft-delete -- softDelete. */
describe('DamAssetLibraryComponent softDelete (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).softDelete(undefined as any); }).not.toThrow();
  });
});
