...
/** Golden WU dam-asset-library-bulk-mark-selected-jobs -- bulkMarkSelectedJobs. */
describe('DamAssetLibraryComponent bulkMarkSelectedJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).bulkMarkSelectedJobs(undefined as any); }).not.toThrow();
  });
});
