...
/** Golden WU dam-asset-library-bulk-assign-selected-jobs -- bulkAssignSelectedJobs. */
describe('DamAssetLibraryComponent bulkAssignSelectedJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).bulkAssignSelectedJobs()).not.toThrow();
  });
});
