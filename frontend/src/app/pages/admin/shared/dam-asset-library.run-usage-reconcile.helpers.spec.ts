...
/** Golden WU dam-asset-library-run-usage-reconcile -- runUsageReconcile. */
describe('DamAssetLibraryComponent runUsageReconcile (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.runUsageReconcile(); }).not.toThrow();
  });
});
