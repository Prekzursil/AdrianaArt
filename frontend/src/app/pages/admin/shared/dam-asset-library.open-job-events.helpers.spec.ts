...
/** Golden WU dam-asset-library-open-job-events -- openJobEvents. */
describe('DamAssetLibraryComponent openJobEvents (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).openJobEvents(null as any)).not.toThrow();
  });
});
