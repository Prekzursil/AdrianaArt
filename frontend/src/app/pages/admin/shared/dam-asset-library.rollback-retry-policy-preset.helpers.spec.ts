...
/** Golden WU dam-asset-library-rollback-retry-policy-preset -- rollbackRetryPolicyPreset. */
describe('DamAssetLibraryComponent rollbackRetryPolicyPreset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).rollbackRetryPolicyPreset(null as any, null as any)).not.toThrow();
  });
});