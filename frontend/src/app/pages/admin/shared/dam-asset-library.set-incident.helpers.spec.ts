...
/** Golden WU dam-asset-library-set-incident -- setIncident. */
describe('DamAssetLibraryComponent setIncident (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setIncident(undefined as any); }).not.toThrow();
  });
});
