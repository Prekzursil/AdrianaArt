...
/** Golden WU dam-asset-library-next-queue-page -- nextQueuePage. */
describe('DamAssetLibraryComponent nextQueuePage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).nextQueuePage()).not.toThrow();
  });
});
