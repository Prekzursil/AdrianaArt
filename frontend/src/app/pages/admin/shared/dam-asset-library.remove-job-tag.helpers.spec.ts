...
/** Golden WU dam-asset-library-remove-job-tag -- removeJobTag. */
describe('DamAssetLibraryComponent removeJobTag (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).removeJobTag(undefined as any); }).not.toThrow();
  });
});
