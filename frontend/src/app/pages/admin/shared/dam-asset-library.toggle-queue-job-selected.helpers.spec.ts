...
/** Golden WU dam-asset-library-toggle-queue-job-selected -- toggleQueueJobSelected. */
describe('DamAssetLibraryComponent toggleQueueJobSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleQueueJobSelected('', {} as any); }).not.toThrow();
  });
});
