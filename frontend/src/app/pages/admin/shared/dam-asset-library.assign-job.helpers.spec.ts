...
/** Golden WU dam-asset-library-assign-job -- assignJob. */
describe('DamAssetLibraryComponent assignJob (golden WU)', () => {
  it('async invokes without throwing when dependencies are stubbed', async () => {
    ...
    await expectAsync(cmp.assignJob(undefined as any)).toBeResolved();
  });
});
