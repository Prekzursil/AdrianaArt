...
/** Golden WU asset-library-edit-alt-text -- editAltText. */
describe('AssetLibraryComponent editAltText (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).editAltText(null as any)).not.toThrow();
  });
});
