...
/** Golden WU admin-save-info-ui -- saveInfoUi. */
describe('AdminComponent saveInfoUi (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).saveInfoUi(undefined as any, undefined as any); }).not.toThrow();
  });
});
