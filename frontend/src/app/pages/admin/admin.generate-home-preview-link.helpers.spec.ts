...
/** Golden WU admin-generate-home-preview-link -- generateHomePreviewLink. */
describe('AdminComponent generateHomePreviewLink (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).generateHomePreviewLink(); }).not.toThrow();
  });
});
