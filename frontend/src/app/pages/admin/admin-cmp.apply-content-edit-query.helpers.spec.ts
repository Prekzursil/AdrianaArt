...
/** Golden WU admin-cmp-apply-content-edit-query -- applyContentEditQuery. */
describe('AdminComponent applyContentEditQuery (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applyContentEditQuery(undefined as any, undefined as any); }).not.toThrow();
  });
});
