...
/** Golden WU admin-cmp-get-blog-summary -- getBlogSummary. */
describe('AdminComponent getBlogSummary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).getBlogSummary('', undefined as any); }).not.toThrow();
  });
});
