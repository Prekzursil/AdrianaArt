...
/** Golden WU admin-go-to-category-wizard-step -- goToCategoryWizardStep. */
describe('AdminComponent goToCategoryWizardStep (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).goToCategoryWizardStep(0); }).not.toThrow();
  });
});
