...
/** Golden WU admin-to-boolean-value -- toBooleanValue. */
describe('AdminComponent toBooleanValue (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toBooleanValue(undefined as any, undefined as any); }).not.toThrow();
  });
});
