...
/** Golden WU admin-load-legal-page -- loadLegalPage. */
describe('AdminComponent loadLegalPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadLegalPage(undefined as any); }).not.toThrow();
  });
});
