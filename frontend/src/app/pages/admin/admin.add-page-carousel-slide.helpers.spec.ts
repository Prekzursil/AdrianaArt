...
/** Golden WU admin-add-page-carousel-slide -- addPageCarouselSlide. */
describe('AdminComponent addPageCarouselSlide (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).addPageCarouselSlide(undefined as any, ''); }).not.toThrow();
  });
});
