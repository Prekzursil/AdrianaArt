...
/** Golden WU admin-is-reserved-page-slug -- isReservedPageSlug. */
describe('AdminComponent isReservedPageSlug (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).isReservedPageSlug(''); }).not.toThrow();
  });
});
