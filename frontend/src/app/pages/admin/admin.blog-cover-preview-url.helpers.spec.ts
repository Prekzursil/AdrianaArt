...
/** Golden WU admin-blog-cover-preview-url -- blogCoverPreviewUrl. */
describe('AdminComponent blogCoverPreviewUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).blogCoverPreviewUrl(); }).not.toThrow();
  });
});
