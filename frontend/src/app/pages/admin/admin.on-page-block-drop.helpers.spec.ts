...
/** Golden WU admin-on-page-block-drop -- onPageBlockDrop. */
describe('AdminComponent onPageBlockDrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onPageBlockDrop({} as any, undefined as any, ''); }).not.toThrow();
  });
});
