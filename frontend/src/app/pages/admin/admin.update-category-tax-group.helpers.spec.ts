...
/** Golden WU admin-update-category-tax-group -- updateCategoryTaxGroup. */
describe('AdminComponent updateCategoryTaxGroup (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateCategoryTaxGroup(undefined as any, ''); }).not.toThrow();
  });
});
