...
/** Golden WU admin-normalize-page-block-draft -- normalizePageBlockDraft. */
describe('AdminComponent normalizePageBlockDraft (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).normalizePageBlockDraft(undefined as any); }).not.toThrow();
  });
});
