...
/** Golden WU admin-layout-recompute-nav-views -- recomputeNavViews. */
describe('AdminLayoutComponent recomputeNavViews (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).recomputeNavViews(); }).not.toThrow();
  });
});
