...
/** Golden WU admin-on-selected-user-id-change -- onSelectedUserIdChange. */
describe('AdminComponent onSelectedUserIdChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onSelectedUserIdChange(''); }).not.toThrow();
  });
});
