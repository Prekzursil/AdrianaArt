...
/** Golden WU admin-restore-fx-override-from-audit -- restoreFxOverrideFromAudit. */
describe('AdminComponent restoreFxOverrideFromAudit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).restoreFxOverrideFromAudit(undefined as any); }).not.toThrow();
  });
});
