...
/** Golden WU admin-coupons-select-coupon -- selectCoupon. */
describe('AdminCouponsComponent selectCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).selectCoupon(null as any)).not.toThrow();
  });
});
