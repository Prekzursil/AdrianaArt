...
/** Golden WU admin-coupons-promotion-to-form -- promotionToForm. */
describe('AdminCouponsComponent promotionToForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).promotionToForm(undefined as any); }).not.toThrow();
  });
});
