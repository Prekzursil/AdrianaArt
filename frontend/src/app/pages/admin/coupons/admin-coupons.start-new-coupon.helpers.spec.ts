...
/** Golden WU admin-coupons-start-new-coupon -- startNewCoupon. */
describe('AdminCouponsComponent startNewCoupon (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).startNewCoupon()).not.toThrow();
  });
});
