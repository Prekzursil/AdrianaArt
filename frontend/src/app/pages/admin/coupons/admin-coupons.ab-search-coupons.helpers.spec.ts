...
/** Golden WU admin-coupons-ab-search-coupons -- abSearchCoupons. */
describe('AdminCouponsComponent abSearchCoupons (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).abSearchCoupons()).not.toThrow();
  });
});
