...
/** Golden WU admin-coupons-sync-category-scopes -- syncCategoryScopes. */
describe('AdminCouponsComponent syncCategoryScopes (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.syncCategoryScopes(null as any); }).not.toThrow();
  });
});
