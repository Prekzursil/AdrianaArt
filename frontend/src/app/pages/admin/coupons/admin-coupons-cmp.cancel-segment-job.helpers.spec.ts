...
/** Golden WU admin-coupons-cmp-cancel-segment-job -- cancelSegmentJob. */
describe('AdminCouponsComponent cancelSegmentJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).cancelSegmentJob(undefined as any); }).not.toThrow();
  });
});
