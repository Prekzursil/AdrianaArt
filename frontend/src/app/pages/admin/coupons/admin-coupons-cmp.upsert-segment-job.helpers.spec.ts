...
/** Golden WU admin-coupons-cmp-upsert-segment-job -- upsertSegmentJob. */
describe('AdminCouponsComponent upsertSegmentJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).upsertSegmentJob(undefined as any, false); }).not.toThrow();
  });
});
