...
/** Golden WU admin-coupons-generate-coupon-code -- generateCouponCode. */
describe('AdminCouponsComponent generateCouponCode (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).generateCouponCode()).not.toThrow();
  });
});
