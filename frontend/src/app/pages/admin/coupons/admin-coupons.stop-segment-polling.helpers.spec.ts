...
/** Golden WU admin-coupons-stop-segment-polling -- stopSegmentPolling. */
describe('AdminCouponsComponent stopSegmentPolling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.stopSegmentPolling(); }).not.toThrow();
  });
});
