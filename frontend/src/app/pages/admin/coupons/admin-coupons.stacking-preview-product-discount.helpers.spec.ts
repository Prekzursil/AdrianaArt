...
/** Golden WU admin-coupons-stacking-preview-product-discount -- stackingPreviewProductDiscount. */
describe('AdminCouponsComponent stackingPreviewProductDiscount (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.stackingPreviewProductDiscount(false); }).not.toThrow();
  });
});
