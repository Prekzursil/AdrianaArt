...
/** Golden WU admin-coupons-load-assignments -- loadAssignments. */
describe('AdminCouponsComponent loadAssignments (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).loadAssignments()).not.toThrow();
  });
});
