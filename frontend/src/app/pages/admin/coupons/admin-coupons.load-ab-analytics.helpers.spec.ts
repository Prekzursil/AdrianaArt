...
/** Golden WU admin-coupons-load-ab-analytics -- loadAbAnalytics. */
describe('AdminCouponsComponent loadAbAnalytics (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadAbAnalytics()).not.toThrow();
  });
});
