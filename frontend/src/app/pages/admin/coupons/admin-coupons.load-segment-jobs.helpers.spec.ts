...
/** Golden WU admin-coupons-load-segment-jobs -- loadSegmentJobs. */
describe('AdminCouponsComponent loadSegmentJobs (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadSegmentJobs()).not.toThrow();
  });
});
