...
/** Golden WU admin-coupons-promotion-schedule-rows -- promotionScheduleRows. */
describe('AdminCouponsComponent promotionScheduleRows (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).promotionScheduleRows()).not.toThrow();
  });
});
