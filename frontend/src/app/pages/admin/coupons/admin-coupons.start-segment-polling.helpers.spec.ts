...
/** Golden WU admin-coupons-start-segment-polling -- startSegmentPolling. */
describe('AdminCouponsComponent startSegmentPolling (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).startSegmentPolling(''); }).not.toThrow();
  });
});
