...
/** Golden WU admin-coupons-refresh-ab-jobs -- refreshAbJobs. */
describe('AdminCouponsComponent refreshAbJobs (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).refreshAbJobs(); }).not.toThrow();
  });
});
