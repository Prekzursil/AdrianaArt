...
/** Golden WU admin-coupons-blank-promotion-form -- blankPromotionForm. */
describe('AdminCouponsComponent blankPromotionForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.blankPromotionForm(); }).not.toThrow();
  });
});
