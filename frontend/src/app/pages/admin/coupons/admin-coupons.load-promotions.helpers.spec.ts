...
/** Golden WU admin-coupons-load-promotions -- loadPromotions. */
describe('AdminCouponsComponent loadPromotions (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).loadPromotions()).not.toThrow();
  });
});
