...
/** Golden WU admin-coupons-remove-scope-product -- removeScopeProduct. */
describe('AdminCouponsComponent removeScopeProduct (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.removeScopeProduct(null as any, ''); }).not.toThrow();
  });
});
