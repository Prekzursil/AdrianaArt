...
/** Golden WU admin-coupons-reset-segment-state -- resetSegmentState. */
describe('AdminCouponsComponent resetSegmentState (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.resetSegmentState(); }).not.toThrow();
  });
});
