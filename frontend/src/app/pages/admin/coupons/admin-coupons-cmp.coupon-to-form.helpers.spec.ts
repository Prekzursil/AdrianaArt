...
/** Golden WU admin-coupons-cmp-coupon-to-form -- couponToForm. */
describe('AdminCouponsComponent couponToForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).couponToForm(undefined as any); }).not.toThrow();
  });
});
