...
/** Golden WU admin-coupons-promotion-calendar-end-date -- promotionCalendarEndDate. */
describe('AdminCouponsComponent promotionCalendarEndDate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).promotionCalendarEndDate()).not.toThrow();
  });
});
