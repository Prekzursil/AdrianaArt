...
/** Golden WU admin-coupons-retry-segment-job -- retrySegmentJob. */
describe('AdminCouponsComponent retrySegmentJob (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.retrySegmentJob(null as any); }).not.toThrow();
  });
});
