...
/** Golden WU admin-coupons-select-promotion -- selectPromotion. */
describe('AdminCouponsComponent selectPromotion (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).selectPromotion({ id: 1 } as any)).not.toThrow();
  });
});
