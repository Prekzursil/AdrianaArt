...
/** Golden WU admin-coupons-promotion-calendar-start-date -- promotionCalendarStartDate. */
describe('AdminCouponsComponent promotionCalendarStartDate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).promotionCalendarStartDate()).not.toThrow();
  });
});
