...
/** Golden WU admin-coupons-promotion-payload-from-form -- promotionPayloadFromForm. */
describe('AdminCouponsComponent promotionPayloadFromForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.promotionPayloadFromForm(); }).not.toThrow();
  });
});
