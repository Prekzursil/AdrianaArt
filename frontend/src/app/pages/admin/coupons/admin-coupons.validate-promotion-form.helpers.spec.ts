...
/** Golden WU admin-coupons-validate-promotion-form -- validatePromotionForm. */
describe('AdminCouponsComponent validatePromotionForm (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.validatePromotionForm(); }).not.toThrow();
  });
});
