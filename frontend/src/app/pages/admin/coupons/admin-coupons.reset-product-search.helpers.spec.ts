...
/** Golden WU admin-coupons-reset-product-search -- resetProductSearch. */
describe('AdminCouponsComponent resetProductSearch (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).resetProductSearch()).not.toThrow();
  });
});
