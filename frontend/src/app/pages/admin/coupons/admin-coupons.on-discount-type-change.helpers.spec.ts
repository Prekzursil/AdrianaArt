...
/** Golden WU admin-coupons-on-discount-type-change -- onDiscountTypeChange. */
describe('AdminCouponsComponent onDiscountTypeChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onDiscountTypeChange()).not.toThrow();
  });
});
