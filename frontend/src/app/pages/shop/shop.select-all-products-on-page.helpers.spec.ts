...
/** Golden WU shop-select-all-products-on-page -- selectAllProductsOnPage. */
describe('ShopComponent selectAllProductsOnPage (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).selectAllProductsOnPage()).not.toThrow();
  });
});
