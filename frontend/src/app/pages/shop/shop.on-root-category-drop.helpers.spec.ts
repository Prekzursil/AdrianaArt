...
/** Golden WU shop-on-root-category-drop -- onRootCategoryDrop. */
describe('ShopComponent onRootCategoryDrop (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onRootCategoryDrop({} as any, '')).not.toThrow();
  });
});
