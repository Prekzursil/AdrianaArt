...
/** Golden WU shop-toggle-create-subcategory -- toggleCreateSubcategory. */
describe('ShopComponent toggleCreateSubcategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.toggleCreateSubcategory({} as any, null as any); }).not.toThrow();
  });
});
