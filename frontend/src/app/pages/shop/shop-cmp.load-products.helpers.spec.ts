...
/** Golden WU shop-cmp-load-products -- loadProducts. */
describe('ShopComponent loadProducts (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).loadProducts(undefined as any, undefined as any); }).not.toThrow();
  });
});
