...
/** Golden WU shop-on-product-drag-over -- onProductDragOver. */
describe('ShopComponent onProductDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onProductDragOver(null as any, '')).not.toThrow();
  });
});
