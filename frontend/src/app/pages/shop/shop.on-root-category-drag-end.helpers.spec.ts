...
/** Golden WU shop-on-root-category-drag-end -- onRootCategoryDragEnd. */
describe('ShopComponent onRootCategoryDragEnd (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onRootCategoryDragEnd()).not.toThrow();
  });
});
