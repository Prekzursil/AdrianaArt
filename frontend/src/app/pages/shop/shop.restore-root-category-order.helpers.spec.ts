...
/** Golden WU shop-restore-root-category-order -- restoreRootCategoryOrder. */
describe('ShopComponent restoreRootCategoryOrder (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.restoreRootCategoryOrder([] as any); }).not.toThrow();
  });
});
