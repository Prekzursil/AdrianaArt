...
/** Golden WU shop-on-merge-target-change -- onMergeTargetChange. */
describe('ShopComponent onMergeTargetChange (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onMergeTargetChange()).not.toThrow();
  });
});
