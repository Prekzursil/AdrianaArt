...
/** Golden WU shop-on-price-text-change -- onPriceTextChange. */
describe('ShopComponent onPriceTextChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onPriceTextChange(null as any, '')).not.toThrow();
  });
});
