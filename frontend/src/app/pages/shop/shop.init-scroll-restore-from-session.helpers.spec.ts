...
/** Golden WU shop-init-scroll-restore-from-session -- initScrollRestoreFromSession. */
describe('ShopComponent initScrollRestoreFromSession (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).initScrollRestoreFromSession()).not.toThrow();
  });
});
