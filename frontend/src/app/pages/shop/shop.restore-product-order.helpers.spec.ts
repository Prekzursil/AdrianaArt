...
/** Golden WU shop-restore-product-order -- restoreProductOrder. */
describe('ShopComponent restoreProductOrder (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.restoreProductOrder([] as any); }).not.toThrow();
  });
});
