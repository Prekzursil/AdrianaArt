...
/** Golden WU shop-on-category-image-selected -- onCategoryImageSelected. */
describe('ShopComponent onCategoryImageSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onCategoryImageSelected(null as any, '', null as any)).not.toThrow();
  });
});
