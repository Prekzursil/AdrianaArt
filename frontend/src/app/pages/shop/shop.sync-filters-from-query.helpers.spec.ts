...
/** Golden WU shop-sync-filters-from-query -- syncFiltersFromQuery. */
describe('ShopComponent syncFiltersFromQuery (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.syncFiltersFromQuery(null as any); }).not.toThrow();
  });
});
