...
/** Golden WU shop-schedule-filter-apply -- scheduleFilterApply. */
describe('ShopComponent scheduleFilterApply (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).scheduleFilterApply()).not.toThrow();
  });
});
