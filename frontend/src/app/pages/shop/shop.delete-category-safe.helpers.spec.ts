...
/** Golden WU shop-delete-category-safe -- deleteCategorySafe. */
describe('ShopComponent deleteCategorySafe (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).deleteCategorySafe(null as any)).not.toThrow();
  });
});
