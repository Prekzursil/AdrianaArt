...
/** Golden WU shop-on-category-selected -- onCategorySelected. */
describe('ShopComponent onCategorySelected (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).onCategorySelected()).not.toThrow();
  });
});
