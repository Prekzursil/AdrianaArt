...
/** Golden WU shop-undo-root-category-order -- undoRootCategoryOrder. */
describe('ShopComponent undoRootCategoryOrder (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.undoRootCategoryOrder('', ''); }).not.toThrow();
  });
});
