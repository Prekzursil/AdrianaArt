...
/** Golden WU shop-toggle-category-visibility -- toggleCategoryVisibility. */
describe('ShopComponent toggleCategoryVisibility (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { cmp.toggleCategoryVisibility({} as any, null as any); }).not.toThrow();
  });
});
