...
/** Golden WU shop-on-product-drag-start -- onProductDragStart. */
describe('ShopComponent onProductDragStart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onProductDragStart(null as any, '')).not.toThrow();
  });
});
