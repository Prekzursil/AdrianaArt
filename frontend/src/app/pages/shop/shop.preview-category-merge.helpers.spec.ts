...
/** Golden WU shop-preview-category-merge -- previewCategoryMerge. */
describe('ShopComponent previewCategoryMerge (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).previewCategoryMerge(null as any)).not.toThrow();
  });
});
