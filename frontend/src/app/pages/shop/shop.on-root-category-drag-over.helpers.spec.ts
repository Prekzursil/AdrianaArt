...
/** Golden WU shop-on-root-category-drag-over -- onRootCategoryDragOver. */
describe('ShopComponent onRootCategoryDragOver (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onRootCategoryDragOver({} as any, '')).not.toThrow();
  });
});
