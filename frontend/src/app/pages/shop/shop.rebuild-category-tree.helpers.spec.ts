...
/** Golden WU shop-rebuild-category-tree -- rebuildCategoryTree. */
describe('ShopComponent rebuildCategoryTree (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).rebuildCategoryTree()).not.toThrow();
  });
});
