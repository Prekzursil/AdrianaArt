...
/** Golden WU shop-toggle-create-root-category -- toggleCreateRootCategory. */
describe('ShopComponent toggleCreateRootCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).toggleCreateRootCategory()).not.toThrow();
  });
});
