...
/** Golden WU shop-clear-shop-return-context -- clearShopReturnContext. */
describe('ShopComponent clearShopReturnContext (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).clearShopReturnContext()).not.toThrow();
  });
});
