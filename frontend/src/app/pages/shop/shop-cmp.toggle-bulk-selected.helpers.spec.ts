...
/** Golden WU shop-cmp-toggle-bulk-selected -- toggleBulkSelected. */
describe('ShopComponent toggleBulkSelected (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).toggleBulkSelected({} as any, ''); }).not.toThrow();
  });
});
