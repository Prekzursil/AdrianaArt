...
/** Golden WU shop-cmp-sync-state-from-url -- syncStateFromUrl. */
describe('ShopComponent syncStateFromUrl (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).syncStateFromUrl(undefined as any, undefined as any); }).not.toThrow();
  });
});
