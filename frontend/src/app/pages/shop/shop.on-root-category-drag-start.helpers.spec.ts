...
/** Golden WU shop-on-root-category-drag-start -- onRootCategoryDragStart. */
describe('ShopComponent onRootCategoryDragStart (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onRootCategoryDragStart({} as any, '')).not.toThrow();
  });
});
