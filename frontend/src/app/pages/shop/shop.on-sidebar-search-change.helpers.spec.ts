...
/** Golden WU shop-on-sidebar-search-change -- onSidebarSearchChange. */
describe('ShopComponent onSidebarSearchChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).onSidebarSearchChange('')).not.toThrow();
  });
});
