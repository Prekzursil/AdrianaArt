...
/** Golden WU shop-save-create-category -- saveCreateCategory. */
describe('ShopComponent saveCreateCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).saveCreateCategory()).not.toThrow();
  });
});
