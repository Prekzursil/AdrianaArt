...
/** Golden WU shop-remember-shop-return-context -- rememberShopReturnContext. */
describe('ShopComponent rememberShopReturnContext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).rememberShopReturnContext()).not.toThrow();
  });
});
