...
/** Golden WU shop-save-rename-category -- saveRenameCategory. */
describe('ShopComponent saveRenameCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).saveRenameCategory()).not.toThrow();
  });
});
