...
/** Golden WU shop-active-leaf-category-slug -- activeLeafCategorySlug. */
describe('ShopComponent activeLeafCategorySlug (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).activeLeafCategorySlug()).not.toThrow();
  });
});
