...
/** Golden WU shop-quick-select-category -- quickSelectCategory. */
describe('ShopComponent quickSelectCategory (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).quickSelectCategory('')).not.toThrow();
  });
});
