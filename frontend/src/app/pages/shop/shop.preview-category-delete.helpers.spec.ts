...
/** Golden WU shop-preview-category-delete -- previewCategoryDelete. */
describe('ShopComponent previewCategoryDelete (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).previewCategoryDelete(null as any)).not.toThrow();
  });
});
