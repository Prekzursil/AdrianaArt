...
/** Golden WU shop-normalize-price-range -- normalizePriceRange. */
describe('ShopComponent normalizePriceRange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => (cmp as any).normalizePriceRange(null as any)).not.toThrow();
  });
});
