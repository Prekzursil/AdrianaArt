...
/** Golden WU shop-apply-bulk-product-edits -- applyBulkProductEdits. */
describe('ShopComponent applyBulkProductEdits (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).applyBulkProductEdits()).not.toThrow();
  });
});
