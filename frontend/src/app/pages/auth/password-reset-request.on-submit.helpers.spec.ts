...
/** Golden WU password-reset-request-on-submit -- onSubmit. */
describe('PasswordResetRequestComponent onSubmit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(PasswordResetRequestComponent.prototype) as PasswordResetRequestComponent;
    ...
    expect(() => { (cmp as any).onSubmit(undefined as any); }).not.toThrow();
  });
});
