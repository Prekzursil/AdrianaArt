...
/** Golden WU password-reset-on-submit -- onSubmit. */
describe('PasswordResetComponent onSubmit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(PasswordResetComponent.prototype) as PasswordResetComponent;
