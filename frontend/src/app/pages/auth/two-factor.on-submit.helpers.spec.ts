...
/** Golden WU two-factor-on-submit -- onSubmit. */
describe('TwoFactorComponent onSubmit (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(TwoFactorComponent.prototype) as TwoFactorComponent;
