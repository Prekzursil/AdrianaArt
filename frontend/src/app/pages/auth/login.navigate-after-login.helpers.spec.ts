...
/** Golden WU login-navigate-after-login -- navigateAfterLogin. */
describe('LoginComponent navigateAfterLogin (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).navigateAfterLogin(); }).not.toThrow();
  });
});
