...
/** Golden WU register-confirm-consent-modal -- confirmConsentModal. */
describe('RegisterComponent confirmConsentModal (golden WU)', () => {
  it('returns early on guard', () => {
    ...
    expect(() => (cmp as any).confirmConsentModal()).not.toThrow();
  });
});
