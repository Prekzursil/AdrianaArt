...
/** Golden WU verify-email-safe-navigate-next -- safeNavigateNext. */
describe('VerifyEmailComponent safeNavigateNext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).safeNavigateNext('', ''); }).not.toThrow();
  });
});
