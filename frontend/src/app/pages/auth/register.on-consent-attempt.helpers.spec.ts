...
/** Golden WU register-on-consent-attempt -- onConsentAttempt. */
describe('RegisterComponent onConsentAttempt (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onConsentAttempt({} as any, undefined as any); }).not.toThrow();
  });
});
