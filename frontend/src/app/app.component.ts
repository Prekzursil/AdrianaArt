...
@Component({
  ...
  template: `
    ...
    >
    <div
      class="min-h-screen flex flex-col bg-gradient-to-b from-background to-background text-text-heading dark:from-slate-950 dark:to-slate-900 dark:text-slate-50 transition-colors"
    >
      <app-header
