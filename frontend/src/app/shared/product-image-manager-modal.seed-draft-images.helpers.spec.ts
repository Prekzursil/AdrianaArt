...
/** Golden WU product-image-manager-modal-seed-draft-images -- seedDraftImages. */
describe('ProductImageManagerModalComponent seedDraftImages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).seedDraftImages(); }).not.toThrow();
  });
});
