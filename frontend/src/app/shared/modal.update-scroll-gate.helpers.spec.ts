...
/** Golden WU modal-update-scroll-gate -- updateScrollGate. */
describe('ModalComponent updateScrollGate (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).updateScrollGate({} as any); }).not.toThrow();
  });
});
