...
/** Golden WU product-quick-view-modal-selected-variant -- selectedVariant. */
describe('ProductQuickViewModalComponent selectedVariant (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).selectedVariant(undefined as any); }).not.toThrow();
  });
});
