...
/** Golden WU address-form-on-autocomplete-query-change -- onAutocompleteQueryChange. */
describe('AddressFormComponent onAutocompleteQueryChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onAutocompleteQueryChange(''); }).not.toThrow();
  });
});
