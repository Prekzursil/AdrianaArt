...
/** Golden WU theme-segmented-control-cmp-set-preference -- setPreference. */
describe('ThemeSegmentedControlComponent setPreference (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).setPreference(undefined as any); }).not.toThrow();
  });
});
