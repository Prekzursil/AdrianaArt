...
/** Golden WU rich-editor-apply-aria-label -- applyAriaLabel. */
describe('RichEditorComponent applyAriaLabel (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).applyAriaLabel(); }).not.toThrow();
  });
});
