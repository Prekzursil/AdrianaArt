...
/** Golden WU cms-form-block-submit-contact -- submitContact. */
describe('CmsFormBlockComponent submitContact (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).submitContact(); }).not.toThrow();
  });
});
