...
/** Golden WU product-image-manager-modal-make-primary -- makePrimary. */
describe('ProductImageManagerModalComponent makePrimary (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).makePrimary(''); }).not.toThrow();
  });
});
