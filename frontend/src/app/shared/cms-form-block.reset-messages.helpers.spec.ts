...
/** Golden WU cms-form-block-reset-messages -- resetMessages. */
describe('CmsFormBlockComponent resetMessages (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).resetMessages(); }).not.toThrow();
  });
});
