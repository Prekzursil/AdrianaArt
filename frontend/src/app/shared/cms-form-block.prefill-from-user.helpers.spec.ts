...
/** Golden WU cms-form-block-prefill-from-user -- prefillFromUser. */
describe('CmsFormBlockComponent prefillFromUser (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).prefillFromUser(); }).not.toThrow();
  });
});
