...
/** Golden WU locker-picker-on-search-query-change -- onSearchQueryChange. */
describe('LockerPickerComponent onSearchQueryChange (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onSearchQueryChange(''); }).not.toThrow();
  });
});
