...
/** Golden WU product-card-remember-shop-return-context -- rememberShopReturnContext. */
describe('ProductCardComponent rememberShopReturnContext (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).rememberShopReturnContext({} as any); }).not.toThrow();
  });
});
