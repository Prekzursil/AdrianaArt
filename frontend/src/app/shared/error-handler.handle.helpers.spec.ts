...
/** Golden WU error-handler-handle -- handle. */
describe('ErrorHandlerService handle (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ErrorHandlerService.prototype) as ErrorHandlerService;
