...
/** Golden WU address-form-fetch-autocomplete -- fetchAutocomplete. */
describe('AddressFormComponent fetchAutocomplete (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).fetchAutocomplete(''); }).not.toThrow();
  });
});
