...
/** Golden WU locker-picker-search-this-area -- searchThisArea. */
describe('LockerPickerComponent searchThisArea (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).searchThisArea(); }).not.toThrow();
  });
});
