...
/** Golden WU legal-consent-modal-on-body-scroll -- onBodyScroll. */
describe('LegalConsentModalComponent onBodyScroll (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onBodyScroll({} as any); }).not.toThrow();
  });
});
