...
/** Golden WU theme-segmented-control-cmp-on-key-down -- onKeyDown. */
describe('ThemeSegmentedControlComponent onKeyDown (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).onKeyDown({} as any, 0); }).not.toThrow();
  });
});
