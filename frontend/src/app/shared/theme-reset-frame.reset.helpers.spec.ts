import { ThemeResetFrameComponent } from './theme-reset-frame.component';

/** Golden WU theme-reset-frame-reset -- reset. */
describe('ThemeResetFrameComponent reset (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(ThemeResetFrameComponent.prototype) as ThemeResetFrameComponent;
