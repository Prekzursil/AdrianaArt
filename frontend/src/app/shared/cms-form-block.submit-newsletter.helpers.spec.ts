...
/** Golden WU cms-form-block-submit-newsletter -- submitNewsletter. */
describe('CmsFormBlockComponent submitNewsletter (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    const cmp = Object.create(CmsFormBlockComponent.prototype) as CmsFormBlockComponent;
    ...
    expect(() => { (cmp as any).submitNewsletter(); }).not.toThrow();
  });
});
