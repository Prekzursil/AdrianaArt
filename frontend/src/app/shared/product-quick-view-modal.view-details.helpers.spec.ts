...
/** Golden WU product-quick-view-modal-view-details -- viewDetails. */
describe('ProductQuickViewModalComponent viewDetails (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).viewDetails(); }).not.toThrow();
  });
});
