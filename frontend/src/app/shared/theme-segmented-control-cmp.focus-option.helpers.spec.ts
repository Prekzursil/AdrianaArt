...
/** Golden WU theme-segmented-control-cmp-focus-option -- focusOption. */
describe('ThemeSegmentedControlComponent focusOption (golden WU)', () => {
  it('invokes without throwing when dependencies are stubbed', () => {
    ...
    expect(() => { (cmp as any).focusOption(0, {} as any); }).not.toThrow();
  });
});
